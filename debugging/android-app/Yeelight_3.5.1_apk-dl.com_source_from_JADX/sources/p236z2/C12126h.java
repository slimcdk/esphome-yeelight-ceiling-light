...
class C12126h {
    ...
    private static final class C12127a {
        ...
        C12127a() {
            this.f22285a = new C12127a[256];
            this.f22286b = 0;
            this.f22287c = 0;
        }

        C12127a(int i, int i2) {
            this.f22285a = null;
            this.f22286b = i;
            int i3 = i2 & 7;
            this.f22287c = i3 == 0 ? 8 : i3;
        }
    }
    ...
    /* renamed from: a */
    private void m31456a(int i, int i2, byte b) {
        C12127a aVar = new C12127a(i, b);
        C12127a aVar2 = this.f22284a;
        while (b > 8) {
            b = (byte) (b - 8);
            int i3 = (i2 >>> b) & 255;
            if (aVar2.f22285a != null) {
                if (aVar2.f22285a[i3] == null) {
                    aVar2.f22285a[i3] = new C12127a();
                }
                aVar2 = aVar2.f22285a[i3];
            } else {
        ...
        for (int i7 = i5; i7 < i5 + i6; i7++) {
            aVar2.f22285a[i7] = aVar;
        }
    }

    /* renamed from: b */
    private void m31457b() {
        int i = 0;
        while (true) {
            byte[] bArr = f22282c;
            if (i < bArr.length) {
                m31456a(i, f22281b[i], bArr[i]);
                i++;
            } else {
                return;
            }
    ...
    /* renamed from: d */
    public static C12126h m31458d() {
        return f22283d;
    }

    /* access modifiers changed from: package-private */
    /* renamed from: c */
    public byte[] mo42888c(byte[] bArr) {
        ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
        C12127a aVar = this.f22284a;
        byte b = 0;
        int i = 0;
        for (byte b2 : bArr) {
            b = (b << 8) | (b2 & 255);
            i += 8;
            while (i >= 8) {
                aVar = aVar.f22285a[(b >>> (i - 8)) & 255];
                if (aVar.f22285a == null) {
                    byteArrayOutputStream.write(aVar.f22286b);
                    i -= aVar.f22287c;
                    aVar = this.f22284a;
                } else {
                    i -= 8;
        ...
        while (i > 0) {
            C12127a aVar2 = aVar.f22285a[(b << (8 - i)) & 255];
            if (aVar2.f22285a != null || aVar2.f22287c > i) {
                break;
            }
            byteArrayOutputStream.write(aVar2.f22286b);
            i -= aVar2.f22287c;
            aVar = this.f22284a;
        }
