...
public final class CallbackToFutureAdapter {
    ...
    private static final class SafeFuture<T> implements C3711a<T> {
        final WeakReference<Completer<T>> completerWeakReference;
        private final AbstractResolvableFuture<T> delegate = new AbstractResolvableFuture<Object>() {
            /* access modifiers changed from: protected */
    ...
    @NonNull
    public static <T> C3711a<T> getFuture(@NonNull Resolver<T> resolver) {
