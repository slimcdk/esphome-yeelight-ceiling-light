...
public class ChangeImageTransform extends Transition {
    ...
    static /* synthetic */ class C05243 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.transition.ChangeImageTransform.C05243.<clinit>():void");
        }
    }
    ...
    private static Matrix copyImageMatrix(ImageView imageView) {
        int i = C05243.$SwitchMap$android$widget$ImageView$ScaleType[imageView.getScaleType().ordinal()];
