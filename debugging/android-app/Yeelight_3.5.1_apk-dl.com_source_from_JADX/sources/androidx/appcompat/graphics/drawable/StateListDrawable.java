...
class StateListDrawable extends DrawableContainer {
        ...
        while (true) {
            ...
            if (next2 != 1) {
                ...
                if (next2 == 2 && depth2 <= depth && xmlPullParser.getName().equals("item")) {
                    TypedArray obtainAttributes = TypedArrayUtils.obtainAttributes(resources, theme, attributeSet, C0083R.styleable.StateListDrawableItem);
                    Drawable drawable = null;
                    int resourceId = obtainAttributes.getResourceId(C0083R.styleable.StateListDrawableItem_android_drawable, -1);
                    if (resourceId > 0) {
    ...
    private void updateStateFromTypedArray(TypedArray typedArray) {
        ...
        stateListState.mVariablePadding = typedArray.getBoolean(C0083R.styleable.StateListDrawable_android_variablePadding, stateListState.mVariablePadding);
        stateListState.mConstantSize = typedArray.getBoolean(C0083R.styleable.StateListDrawable_android_constantSize, stateListState.mConstantSize);
        stateListState.mEnterFadeDuration = typedArray.getInt(C0083R.styleable.StateListDrawable_android_enterFadeDuration, stateListState.mEnterFadeDuration);
        stateListState.mExitFadeDuration = typedArray.getInt(C0083R.styleable.StateListDrawable_android_exitFadeDuration, stateListState.mExitFadeDuration);
        stateListState.mDither = typedArray.getBoolean(C0083R.styleable.StateListDrawable_android_dither, stateListState.mDither);
    }
    ...
    public void inflate(@NonNull Context context, @NonNull Resources resources, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) {
        TypedArray obtainAttributes = TypedArrayUtils.obtainAttributes(resources, theme, attributeSet, C0083R.styleable.StateListDrawable);
        setVisible(obtainAttributes.getBoolean(C0083R.styleable.StateListDrawable_android_visible, true), true);
