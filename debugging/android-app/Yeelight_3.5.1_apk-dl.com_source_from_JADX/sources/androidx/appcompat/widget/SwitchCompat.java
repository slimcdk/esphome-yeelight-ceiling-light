...
public class SwitchCompat extends CompoundButton {
    ...
    public SwitchCompat(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C0050R.attr.switchStyle);
    }
    ...
    public SwitchCompat(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        int[] iArr = C0050R.styleable.SwitchCompat;
        ...
        Drawable drawable = obtainStyledAttributes.getDrawable(C0050R.styleable.SwitchCompat_android_thumb);
        this.mThumbDrawable = drawable;
        if (drawable != null) {
            drawable.setCallback(this);
        }
        Drawable drawable2 = obtainStyledAttributes.getDrawable(C0050R.styleable.SwitchCompat_track);
        this.mTrackDrawable = drawable2;
        if (drawable2 != null) {
            drawable2.setCallback(this);
        }
        this.mTextOn = obtainStyledAttributes.getText(C0050R.styleable.SwitchCompat_android_textOn);
        this.mTextOff = obtainStyledAttributes.getText(C0050R.styleable.SwitchCompat_android_textOff);
        this.mShowText = obtainStyledAttributes.getBoolean(C0050R.styleable.SwitchCompat_showText, true);
        this.mThumbTextPadding = obtainStyledAttributes.getDimensionPixelSize(C0050R.styleable.SwitchCompat_thumbTextPadding, 0);
        this.mSwitchMinWidth = obtainStyledAttributes.getDimensionPixelSize(C0050R.styleable.SwitchCompat_switchMinWidth, 0);
        this.mSwitchPadding = obtainStyledAttributes.getDimensionPixelSize(C0050R.styleable.SwitchCompat_switchPadding, 0);
        this.mSplitTrack = obtainStyledAttributes.getBoolean(C0050R.styleable.SwitchCompat_splitTrack, false);
        ColorStateList colorStateList = obtainStyledAttributes.getColorStateList(C0050R.styleable.SwitchCompat_thumbTint);
        if (colorStateList != null) {
            this.mThumbTintList = colorStateList;
            this.mHasThumbTint = true;
        }
        PorterDuff.Mode parseTintMode = DrawableUtils.parseTintMode(obtainStyledAttributes.getInt(C0050R.styleable.SwitchCompat_thumbTintMode, -1), (PorterDuff.Mode) null);
        ...
        ColorStateList colorStateList2 = obtainStyledAttributes.getColorStateList(C0050R.styleable.SwitchCompat_trackTint);
        if (colorStateList2 != null) {
            this.mTrackTintList = colorStateList2;
            this.mHasTrackTint = true;
        }
        PorterDuff.Mode parseTintMode2 = DrawableUtils.parseTintMode(obtainStyledAttributes.getInt(C0050R.styleable.SwitchCompat_trackTintMode, -1), (PorterDuff.Mode) null);
        ...
        int resourceId = obtainStyledAttributes.getResourceId(C0050R.styleable.SwitchCompat_switchTextAppearance, 0);
        if (resourceId != 0) {
    ...
    public void setSwitchTextAppearance(Context context, int i) {
        ...
        ColorStateList colorStateList = obtainStyledAttributes.getColorStateList(C0050R.styleable.TextAppearance_android_textColor);
        if (colorStateList == null) {
        ...
        setSwitchTypefaceByIndex(obtainStyledAttributes.getInt(C0050R.styleable.TextAppearance_android_typeface, -1), obtainStyledAttributes.getInt(C0050R.styleable.TextAppearance_android_textStyle, -1));
        this.mSwitchTransformationMethod = obtainStyledAttributes.getBoolean(C0050R.styleable.TextAppearance_textAllCaps, false) ? new AllCapsTransformationMethod(getContext()) : null;
        obtainStyledAttributes.recycle();
    }
