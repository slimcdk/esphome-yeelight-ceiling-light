...
class AppCompatTextHelper {
    ...
    private void updateTypefaceAndStyle(Context context, TintTypedArray tintTypedArray) {
        ...
        Typeface typeface;
        Typeface typeface2;
        this.mStyle = tintTypedArray.getInt(C0050R.styleable.TextAppearance_android_textStyle, this.mStyle);
        int i = Build.VERSION.SDK_INT;
        boolean z = false;
        if (i >= 28) {
            int i2 = tintTypedArray.getInt(C0050R.styleable.TextAppearance_android_textFontWeight, -1);
            this.mFontWeight = i2;
            if (i2 != -1) {
                this.mStyle = (this.mStyle & 2) | 0;
            }
        }
        int i3 = C0050R.styleable.TextAppearance_android_fontFamily;
        if (tintTypedArray.hasValue(i3) || tintTypedArray.hasValue(C0050R.styleable.TextAppearance_fontFamily)) {
            this.mFontTypeface = null;
            int i4 = C0050R.styleable.TextAppearance_fontFamily;
        ...
        int i8 = C0050R.styleable.TextAppearance_android_typeface;
    ...
    public void loadFromAttributes(@androidx.annotation.Nullable android.util.AttributeSet r24, int r25) {
        /*
            ...
            int[] r2 = androidx.appcompat.C0050R.styleable.AppCompatTextHelper
            r12 = 0
            ...
            int r0 = androidx.appcompat.C0050R.styleable.AppCompatTextHelper_android_textAppearance
            r14 = -1
            int r0 = r13.getResourceId(r0, r14)
            int r1 = androidx.appcompat.C0050R.styleable.AppCompatTextHelper_android_drawableLeft
        ...
        L_0x0042:
            int r1 = androidx.appcompat.C0050R.styleable.AppCompatTextHelper_android_drawableTop
            boolean r2 = r13.hasValue(r1)
        ...
        L_0x0054:
            int r1 = androidx.appcompat.C0050R.styleable.AppCompatTextHelper_android_drawableRight
            boolean r2 = r13.hasValue(r1)
        ...
        L_0x0066:
            int r1 = androidx.appcompat.C0050R.styleable.AppCompatTextHelper_android_drawableBottom
            boolean r2 = r13.hasValue(r1)
        ...
        L_0x0078:
            ...
            int r2 = androidx.appcompat.C0050R.styleable.AppCompatTextHelper_android_drawableStart
        ...
        L_0x0090:
            int r2 = androidx.appcompat.C0050R.styleable.AppCompatTextHelper_android_drawableEnd
            boolean r3 = r13.hasValue(r2)
        ...
        L_0x00a2:
            ...
            int[] r6 = androidx.appcompat.C0050R.styleable.TextAppearance
            ...
            int r6 = androidx.appcompat.C0050R.styleable.TextAppearance_textAllCaps
        ...
        L_0x00cb:
            ...
            int r4 = androidx.appcompat.C0050R.styleable.TextAppearance_android_textColor
        ...
        L_0x00dd:
            r4 = 0
        L_0x00de:
            int r13 = androidx.appcompat.C0050R.styleable.TextAppearance_android_textColorHint
        ...
        L_0x00eb:
            r13 = 0
        L_0x00ec:
            int r14 = androidx.appcompat.C0050R.styleable.TextAppearance_android_textColorLink
        ...
        L_0x00fb:
            r14 = 0
        L_0x00fc:
            int r5 = androidx.appcompat.C0050R.styleable.TextAppearance_textLocale
        ...
        L_0x010a:
            ...
            int r3 = androidx.appcompat.C0050R.styleable.TextAppearance_fontVariationSettings
        ...
        L_0x011e:
            ...
            r15 = 0
        L_0x0125:
            int[] r0 = androidx.appcompat.C0050R.styleable.TextAppearance
            ...
            int r12 = androidx.appcompat.C0050R.styleable.TextAppearance_textAllCaps
        ...
        L_0x0144:
            ...
            int r3 = androidx.appcompat.C0050R.styleable.TextAppearance_android_textColor
            boolean r12 = r0.hasValue(r3)
            if (r12 == 0) goto L_0x0152
            android.content.res.ColorStateList r4 = r0.getColorStateList(r3)
        L_0x0152:
            int r3 = androidx.appcompat.C0050R.styleable.TextAppearance_android_textColorHint
            boolean r12 = r0.hasValue(r3)
            if (r12 == 0) goto L_0x015e
            android.content.res.ColorStateList r13 = r0.getColorStateList(r3)
        L_0x015e:
            int r3 = androidx.appcompat.C0050R.styleable.TextAppearance_android_textColorLink
            boolean r12 = r0.hasValue(r3)
            if (r12 == 0) goto L_0x016a
            android.content.res.ColorStateList r14 = r0.getColorStateList(r3)
        L_0x016a:
            int r3 = androidx.appcompat.C0050R.styleable.TextAppearance_textLocale
            boolean r12 = r0.hasValue(r3)
        ...
        L_0x0189:
            ...
            int r12 = androidx.appcompat.C0050R.styleable.TextAppearance_android_textSize
        ...
        L_0x0257:
            int[] r0 = androidx.appcompat.C0050R.styleable.AppCompatTextView
            ...
            int r0 = androidx.appcompat.C0050R.styleable.AppCompatTextView_drawableLeftCompat
            r1 = -1
        ...
        L_0x026e:
            r3 = 0
        L_0x026f:
            int r0 = androidx.appcompat.C0050R.styleable.AppCompatTextView_drawableTopCompat
            int r0 = r8.getResourceId(r0, r1)
        ...
        L_0x027d:
            r4 = 0
        L_0x027e:
            int r0 = androidx.appcompat.C0050R.styleable.AppCompatTextView_drawableRightCompat
            int r0 = r8.getResourceId(r0, r1)
        ...
        L_0x028c:
            r5 = 0
        L_0x028d:
            int r0 = androidx.appcompat.C0050R.styleable.AppCompatTextView_drawableBottomCompat
            int r0 = r8.getResourceId(r0, r1)
        ...
        L_0x029b:
            r6 = 0
        L_0x029c:
            int r0 = androidx.appcompat.C0050R.styleable.AppCompatTextView_drawableStartCompat
            int r0 = r8.getResourceId(r0, r1)
        ...
        L_0x02aa:
            r9 = 0
        L_0x02ab:
            int r0 = androidx.appcompat.C0050R.styleable.AppCompatTextView_drawableEndCompat
            int r0 = r8.getResourceId(r0, r1)
        ...
        L_0x02ba:
            ...
            int r0 = androidx.appcompat.C0050R.styleable.AppCompatTextView_drawableTint
        ...
        L_0x02d6:
            int r0 = androidx.appcompat.C0050R.styleable.AppCompatTextView_drawableTintMode
            boolean r1 = r8.hasValue(r0)
        ...
        L_0x02ee:
            r1 = -1
        L_0x02ef:
            int r0 = androidx.appcompat.C0050R.styleable.AppCompatTextView_firstBaselineToTopHeight
            int r0 = r8.getDimensionPixelSize(r0, r1)
            int r2 = androidx.appcompat.C0050R.styleable.AppCompatTextView_lastBaselineToBottomHeight
            int r2 = r8.getDimensionPixelSize(r2, r1)
            int r3 = androidx.appcompat.C0050R.styleable.AppCompatTextView_lineHeight
    ...
    public void onSetTextAppearance(Context context, int i) {
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, i, C0050R.styleable.TextAppearance);
        int i2 = C0050R.styleable.TextAppearance_textAllCaps;
        if (obtainStyledAttributes.hasValue(i2)) {
            setAllCaps(obtainStyledAttributes.getBoolean(i2, false));
        }
        int i3 = Build.VERSION.SDK_INT;
        if (i3 < 23) {
            int i4 = C0050R.styleable.TextAppearance_android_textColor;
            if (obtainStyledAttributes.hasValue(i4) && (colorStateList = obtainStyledAttributes.getColorStateList(i4)) != null) {
                this.mView.setTextColor(colorStateList);
            }
        }
        int i5 = C0050R.styleable.TextAppearance_android_textSize;
        if (obtainStyledAttributes.hasValue(i5) && obtainStyledAttributes.getDimensionPixelSize(i5, -1) == 0) {
            this.mView.setTextSize(0, 0.0f);
        }
        updateTypefaceAndStyle(context, obtainStyledAttributes);
        if (i3 >= 26) {
            int i6 = C0050R.styleable.TextAppearance_fontVariationSettings;
