...
abstract class AbsActionBarView extends ViewGroup {
    ...
    AbsActionBarView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        if (!context.getTheme().resolveAttribute(C0050R.attr.actionBarPopupTheme, typedValue, true) || typedValue.resourceId == 0) {
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes((AttributeSet) null, C0050R.styleable.ActionBar, C0050R.attr.actionBarStyle, 0);
        setContentHeight(obtainStyledAttributes.getLayoutDimension(C0050R.styleable.ActionBar_height, 0));
