...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    private class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            int itemViewType = getItemViewType(i);
            if (itemViewType == 0) {
                if (view == null || view.getId() != C0050R.C0052id.list_item) {
                    view = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0050R.layout.abc_activity_chooser_view_list_item, viewGroup, false);
                }
                PackageManager packageManager = ActivityChooserView.this.getContext().getPackageManager();
                ResolveInfo resolveInfo = (ResolveInfo) getItem(i);
                ((ImageView) view.findViewById(C0050R.C0052id.icon)).setImageDrawable(resolveInfo.loadIcon(packageManager));
                ((TextView) view.findViewById(C0050R.C0052id.title)).setText(resolveInfo.loadLabel(packageManager));
                ...
                View inflate = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0050R.layout.abc_activity_chooser_view_list_item, viewGroup, false);
                inflate.setId(1);
                ((TextView) inflate.findViewById(C0050R.C0052id.title)).setText(ActivityChooserView.this.getContext().getString(C0050R.string.abc_activity_chooser_view_see_all));
                return inflate;
            }
        }
    ...
    public ActivityChooserView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        int[] iArr = C0050R.styleable.ActivityChooserView;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, iArr, i, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, iArr, attributeSet, obtainStyledAttributes, i, 0);
        this.mInitialActivityCount = obtainStyledAttributes.getInt(C0050R.styleable.ActivityChooserView_initialActivityCount, 4);
        Drawable drawable = obtainStyledAttributes.getDrawable(C0050R.styleable.ActivityChooserView_expandActivityOverflowButtonDrawable);
        obtainStyledAttributes.recycle();
        LayoutInflater.from(getContext()).inflate(C0050R.layout.abc_activity_chooser_view, this, true);
        Callbacks callbacks = new Callbacks();
        this.mCallbacks = callbacks;
        View findViewById = findViewById(C0050R.C0052id.activity_chooser_view_content);
        this.mActivityChooserContent = findViewById;
        this.mActivityChooserContentBackground = findViewById.getBackground();
        FrameLayout frameLayout = (FrameLayout) findViewById(C0050R.C0052id.default_activity_button);
        ...
        int i2 = C0050R.C0052id.image;
        this.mDefaultActivityButtonImage = (ImageView) frameLayout.findViewById(i2);
        FrameLayout frameLayout2 = (FrameLayout) findViewById(C0050R.C0052id.expand_activities_button);
        ...
        this.mListPopupMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(C0050R.dimen.abc_config_prefDialogWidth));
    }
    ...
    public void showPopupUnchecked(int i) {
        ...
        if (this.mAdapter.getDataModel() != null) {
            ...
            if (!listPopupWindow.isShowing()) {
                ...
                listPopupWindow.getListView().setContentDescription(getContext().getString(C0050R.string.abc_activitychooserview_choose_application));
