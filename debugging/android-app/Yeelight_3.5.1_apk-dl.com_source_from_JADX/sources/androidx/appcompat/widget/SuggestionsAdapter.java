...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    private static final class ChildViewCache {
        ...
        public ChildViewCache(View view) {
            ...
            this.mIconRefine = (ImageView) view.findViewById(C0050R.C0052id.edit_query);
        }
    }
    ...
    private CharSequence formatUrl(CharSequence charSequence) {
        if (this.mUrlColor == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0050R.attr.textColorSearchUrl, typedValue, true);
    ...
    private android.graphics.drawable.Drawable getDrawable(android.net.Uri r5) {
        ...
        L_0x002b:
            android.content.Context r2 = r4.mProviderContext     // Catch:{ FileNotFoundException -> 0x0073 }
    ...
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        ...
        ((ImageView) newView.findViewById(C0050R.C0052id.edit_query)).setImageResource(this.mCommitIconResId);
        return newView;
    }
