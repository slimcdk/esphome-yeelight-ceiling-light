...
public final class PointerIconCompat {
    ...
    public static PointerIconCompat create(@NonNull Bitmap bitmap, float f, float f2) {
        return Build.VERSION.SDK_INT >= 24 ? new PointerIconCompat(Api24Impl.create(bitmap, f, f2)) : new PointerIconCompat((PointerIcon) null);
    }

    @NonNull
    public static PointerIconCompat getSystemIcon(@NonNull Context context, int i) {
        return Build.VERSION.SDK_INT >= 24 ? new PointerIconCompat(Api24Impl.getSystemIcon(context, i)) : new PointerIconCompat((PointerIcon) null);
    }

    @NonNull
    public static PointerIconCompat load(@NonNull Resources resources, int i) {
        return Build.VERSION.SDK_INT >= 24 ? new PointerIconCompat(Api24Impl.load(resources, i)) : new PointerIconCompat((PointerIcon) null);
    }
