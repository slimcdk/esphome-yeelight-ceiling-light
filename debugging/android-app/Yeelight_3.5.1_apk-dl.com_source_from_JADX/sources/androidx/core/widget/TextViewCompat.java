...
public final class TextViewCompat {
    ...
    public static void setFirstBaselineToTopHeight(@NonNull TextView textView, @C0048Px @IntRange(from = 0) int i) {
    ...
    public static void setLastBaselineToBottomHeight(@NonNull TextView textView, @C0048Px @IntRange(from = 0) int i) {
        Preconditions.checkArgumentNonnegative(i);
        Paint.FontMetricsInt fontMetricsInt = textView.getPaint().getFontMetricsInt();
    ...
    public static void setLineHeight(@NonNull TextView textView, @C0048Px @IntRange(from = 0) int i) {
        Preconditions.checkArgumentNonnegative(i);
