...
class BlendModeUtils {
    ...
    static /* synthetic */ class C02441 {
        ...
        static {
            ...
            L_0x015c:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.core.graphics.BlendModeUtils.C02441.<clinit>():void");
        }
    }
    ...
    static class Api29Impl {
        ...
        static Object obtainBlendModeFromCompat(@NonNull BlendModeCompat blendModeCompat) {
            switch (C02441.$SwitchMap$androidx$core$graphics$BlendModeCompat[blendModeCompat.ordinal()]) {
                case 1:
