...
public abstract class Lifecycle {
    ...
    static /* synthetic */ class C03781 {
        ...
        static {
            ...
            L_0x008d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.lifecycle.Lifecycle.C03781.<clinit>():void");
        }
    }
    ...
    public enum Event {
        ...
        public static Event downFrom(@NonNull State state) {
            int i = C03781.$SwitchMap$androidx$lifecycle$Lifecycle$State[state.ordinal()];
            if (i == 1) {
                return ON_DESTROY;
            }
            if (i == 2) {
        ...
        public State getTargetState() {
            switch (C03781.$SwitchMap$androidx$lifecycle$Lifecycle$Event[ordinal()]) {
                case 1:
                case 2:
