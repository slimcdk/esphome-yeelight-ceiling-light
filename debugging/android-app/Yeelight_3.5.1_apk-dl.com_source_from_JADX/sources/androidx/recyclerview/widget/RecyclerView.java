...
import androidx.recyclerview.C0437R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    static /* synthetic */ class C04817 {
        ...
        static final /* synthetic */ int[] f173x3d106619;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f173x3d106619     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.recyclerview.widget.RecyclerView.C04817.<clinit>():void");
        }
    }
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        public boolean canRestoreState() {
            int i = C04817.f173x3d106619[this.mStateRestorationPolicy.ordinal()];
            if (i != 1) {
    ...
    public static abstract class LayoutManager {
        ...
        public LayoutManager() {
            C04821 r0 = new ViewBoundsCheck.Callback() {
            ...
            C04832 r1 = new ViewBoundsCheck.Callback() {
                public View getChildAt(int i) {
                    return LayoutManager.this.getChildAt(i);
                }
        ...
        public static Properties getProperties(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i2) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0437R.styleable.RecyclerView, i, i2);
            properties.orientation = obtainStyledAttributes.getInt(C0437R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = obtainStyledAttributes.getInt(C0437R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = obtainStyledAttributes.getBoolean(C0437R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = obtainStyledAttributes.getBoolean(C0437R.styleable.RecyclerView_stackFromEnd, false);
        ...
        public void offsetChildrenHorizontal(@C0048Px int i) {
            RecyclerView recyclerView = this.mRecyclerView;
            if (recyclerView != null) {
        ...
        public void offsetChildrenVertical(@C0048Px int i) {
            RecyclerView recyclerView = this.mRecyclerView;
            if (recyclerView != null) {
    ...
    public static abstract class SmoothScroller {
        ...
        public static class Action {
            ...
            public Action(@C0048Px int i, @C0048Px int i2) {
                this(i, i2, Integer.MIN_VALUE, (Interpolator) null);
            }

            public Action(@C0048Px int i, @C0048Px int i2, int i3) {
                this(i, i2, i3, (Interpolator) null);
            }

            public Action(@C0048Px int i, @C0048Px int i2, int i3, @Nullable Interpolator interpolator) {
            ...
            public void setDx(@C0048Px int i) {
                this.mChanged = true;
                this.mDx = i;
            }

            public void setDy(@C0048Px int i) {
                this.mChanged = true;
                this.mDy = i;
            }
            ...
            public void update(@C0048Px int i, @C0048Px int i2, int i3, @Nullable Interpolator interpolator) {
                this.mDx = i;
                this.mDy = i2;
                this.mDuration = i3;
                this.mInterpolator = interpolator;
        ...
        /* access modifiers changed from: protected */
        public abstract void onSeekTargetStep(@C0048Px int i, @C0048Px int i2, @NonNull State state, @NonNull Action action);
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C0437R.attr.recyclerViewStyle);
    }
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        int[] iArr = C0437R.styleable.RecyclerView;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, iArr, i, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, iArr, attributeSet, obtainStyledAttributes, i, 0);
        String string = obtainStyledAttributes.getString(C0437R.styleable.RecyclerView_layoutManager);
        if (obtainStyledAttributes.getInt(C0437R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
            setDescendantFocusability(262144);
        }
        this.mClipToPadding = obtainStyledAttributes.getBoolean(C0437R.styleable.RecyclerView_android_clipToPadding, true);
        boolean z2 = obtainStyledAttributes.getBoolean(C0437R.styleable.RecyclerView_fastScrollEnabled, false);
        this.mEnableFastScroller = z2;
        if (z2) {
            initFastScroller((StateListDrawable) obtainStyledAttributes.getDrawable(C0437R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), obtainStyledAttributes.getDrawable(C0437R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) obtainStyledAttributes.getDrawable(C0437R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), obtainStyledAttributes.getDrawable(C0437R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
        }
        obtainStyledAttributes.recycle();
    ...
    private void saveFocusInfo() {
        ...
        this.mState.mFocusedItemPosition = this.mDataSetHasChangedAfterLayout ? -1 : viewHolder.isRemoved() ? viewHolder.mOldPosition : viewHolder.getAbsoluteAdapterPosition();
    ...
    public void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        ...
        new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C0437R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0437R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0437R.dimen.fastscroll_margin));
    }
    ...
    public void onScrolled(@C0048Px int i, @C0048Px int i2) {
    }
    ...
    public void smoothScrollBy(@C0048Px int i, @C0048Px int i2) {
        smoothScrollBy(i, i2, (Interpolator) null);
    }

    public void smoothScrollBy(@C0048Px int i, @C0048Px int i2, @Nullable Interpolator interpolator) {
        smoothScrollBy(i, i2, interpolator, Integer.MIN_VALUE);
    }

    public void smoothScrollBy(@C0048Px int i, @C0048Px int i2, @Nullable Interpolator interpolator, int i3) {
        smoothScrollBy(i, i2, interpolator, i3, false);
    }

    /* access modifiers changed from: package-private */
    public void smoothScrollBy(@C0048Px int i, @C0048Px int i2, @Nullable Interpolator interpolator, int i3, boolean z) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager != null && !this.mLayoutSuppressed) {
            int i4 = 0;
