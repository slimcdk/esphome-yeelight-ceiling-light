...
public class AsyncListUtil<T> {
    ...
    public AsyncListUtil(@NonNull Class<T> cls, int i, @NonNull DataCallback<T> dataCallback, @NonNull ViewCallback viewCallback) {
        C04431 r0 = new ThreadUtil.MainThreadCallback<Object>() {
        ...
        C04442 r1 = new ThreadUtil.BackgroundCallback<Object>() {
    ...
    public void updateRange() {
        ...
        if (iArr[0] <= iArr[1] && iArr[0] >= 0 && iArr[1] < this.mItemCount) {
            ...
            backgroundCallback2.updateRange(i22, i32, iArr72[0], iArr72[1], this.mScrollHint);
        }
    }
}
