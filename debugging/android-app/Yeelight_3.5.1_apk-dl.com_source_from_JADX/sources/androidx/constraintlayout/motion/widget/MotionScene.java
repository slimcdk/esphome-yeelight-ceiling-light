...
public class MotionScene {
    ...
    public static class Transition {
        ...
        public static class TransitionOnClick implements View.OnClickListener {
            ...
            public TransitionOnClick(Context context, Transition transition, XmlPullParser xmlPullParser) {
                ...
                TypedArray obtainStyledAttributes = context.obtainStyledAttributes(Xml.asAttributeSet(xmlPullParser), C0218R.styleable.OnClick);
                int indexCount = obtainStyledAttributes.getIndexCount();
                for (int i = 0; i < indexCount; i++) {
                    int index = obtainStyledAttributes.getIndex(i);
                    if (index == C0218R.styleable.OnClick_targetId) {
                        this.mTargetId = obtainStyledAttributes.getResourceId(index, this.mTargetId);
                    } else if (index == C0218R.styleable.OnClick_clickAction) {
            ...
            public boolean isTransitionViable(Transition transition, MotionLayout motionLayout) {
                ...
                return access$100 == -1 ? i != access$000 : i == access$100 || i == access$000;
            }
        ...
        private void fill(MotionScene motionScene, Context context, TypedArray typedArray) {
            ...
            SparseArray access$1100;
            int i;
            int indexCount = typedArray.getIndexCount();
            for (int i2 = 0; i2 < indexCount; i2++) {
                int index = typedArray.getIndex(i2);
                if (index == C0218R.styleable.Transition_constraintSetEnd) {
                    ...
                    if ("layout".equals(resourceTypeName)) {
                        ...
                        access$1100 = motionScene.mConstraintSetMap;
                    ...
                    if (index == C0218R.styleable.Transition_constraintSetStart) {
                    ...
                    } else if (index == C0218R.styleable.Transition_motionInterpolator) {
                    ...
                    } else if (index == C0218R.styleable.Transition_duration) {
                        int i4 = typedArray.getInt(index, this.mDuration);
                        this.mDuration = i4;
                        if (i4 < 8) {
                            this.mDuration = 8;
                        }
                    } else if (index == C0218R.styleable.Transition_staggered) {
                        this.mStagger = typedArray.getFloat(index, this.mStagger);
                    } else if (index == C0218R.styleable.Transition_autoTransition) {
                        this.mAutoTransition = typedArray.getInteger(index, this.mAutoTransition);
                    } else if (index == C0218R.styleable.Transition_android_id) {
                        this.mId = typedArray.getResourceId(index, this.mId);
                    } else if (index == C0218R.styleable.Transition_transitionDisable) {
                        this.mDisable = typedArray.getBoolean(index, this.mDisable);
                    } else if (index == C0218R.styleable.Transition_pathMotionArc) {
                        this.mPathMotionArc = typedArray.getInteger(index, -1);
                    } else if (index == C0218R.styleable.Transition_layoutDuringTransition) {
                        this.mLayoutDuringTransition = typedArray.getInteger(index, 0);
                    } else if (index == C0218R.styleable.Transition_transitionFlags) {
                        this.mTransitionFlags = typedArray.getInteger(index, 0);
                    }
                }
                access$1100.append(i, constraintSet);
            }
        ...
        private void fillFromAttributeList(MotionScene motionScene, Context context, AttributeSet attributeSet) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0218R.styleable.Transition);
    ...
    MotionScene(Context context, MotionLayout motionLayout, int i) {
        ...
        int i2 = C0218R.C0220id.motion_base;
    ...
    private int getId(Context context, String str) {
        int i;
        if (str.contains(MiotCloudImpl.COOKIE_PATH)) {
    ...
    private void load(android.content.Context r9, int r10) {
        ...
        L_0x0017:
            ...
            boolean r5 = r8.DEBUG_DESKTOP     // Catch:{ XmlPullParserException -> 0x0169, IOException -> 0x0164 }
        ...
        L_0x00a8:
            goto L_0x015e
        L_0x00aa:
            androidx.constraintlayout.motion.widget.ViewTransition r2 = new androidx.constraintlayout.motion.widget.ViewTransition     // Catch:{ XmlPullParserException -> 0x0169, IOException -> 0x0164 }
            r2.<init>(r9, r0)     // Catch:{ XmlPullParserException -> 0x0169, IOException -> 0x0164 }
            androidx.constraintlayout.motion.widget.ViewTransitionController r3 = r8.mViewTransitionController     // Catch:{ XmlPullParserException -> 0x0169, IOException -> 0x0164 }
            r3.add(r2)     // Catch:{ XmlPullParserException -> 0x0169, IOException -> 0x0164 }
            goto L_0x015e
        L_0x00b6:
            androidx.constraintlayout.motion.widget.KeyFrames r2 = new androidx.constraintlayout.motion.widget.KeyFrames     // Catch:{ XmlPullParserException -> 0x0169, IOException -> 0x0164 }
            r2.<init>(r9, r0)     // Catch:{ XmlPullParserException -> 0x0169, IOException -> 0x0164 }
            if (r1 == 0) goto L_0x015e
            java.util.ArrayList r3 = r1.mKeyFramesList     // Catch:{ XmlPullParserException -> 0x0169, IOException -> 0x0164 }
            r3.add(r2)     // Catch:{ XmlPullParserException -> 0x0169, IOException -> 0x0164 }
            goto L_0x015e
        L_0x00c6:
            r8.parseInclude((android.content.Context) r9, (org.xmlpull.v1.XmlPullParser) r0)     // Catch:{ XmlPullParserException -> 0x0169, IOException -> 0x0164 }
            goto L_0x015e
        L_0x00cb:
            r8.parseConstraintSet(r9, r0)     // Catch:{ XmlPullParserException -> 0x0169, IOException -> 0x0164 }
            goto L_0x015e
        L_0x00d0:
            androidx.constraintlayout.widget.StateSet r2 = new androidx.constraintlayout.widget.StateSet     // Catch:{ XmlPullParserException -> 0x0169, IOException -> 0x0164 }
            r2.<init>(r9, r0)     // Catch:{ XmlPullParserException -> 0x0169, IOException -> 0x0164 }
            r8.mStateSet = r2     // Catch:{ XmlPullParserException -> 0x0169, IOException -> 0x0164 }
            goto L_0x015e
        L_0x00d9:
            if (r1 == 0) goto L_0x015e
            r1.addOnClick((android.content.Context) r9, (org.xmlpull.v1.XmlPullParser) r0)     // Catch:{ XmlPullParserException -> 0x0169, IOException -> 0x0164 }
            goto L_0x015e
        L_0x00e0:
        ...
        L_0x0108:
            if (r1 == 0) goto L_0x015e
            androidx.constraintlayout.motion.widget.TouchResponse r2 = new androidx.constraintlayout.motion.widget.TouchResponse     // Catch:{ XmlPullParserException -> 0x0169, IOException -> 0x0164 }
            androidx.constraintlayout.motion.widget.MotionLayout r3 = r8.mMotionLayout     // Catch:{ XmlPullParserException -> 0x0169, IOException -> 0x0164 }
            r2.<init>(r9, r3, r0)     // Catch:{ XmlPullParserException -> 0x0169, IOException -> 0x0164 }
            androidx.constraintlayout.motion.widget.TouchResponse unused = r1.mTouchResponse = r2     // Catch:{ XmlPullParserException -> 0x0169, IOException -> 0x0164 }
            goto L_0x015e
        L_0x0115:
            java.util.ArrayList<androidx.constraintlayout.motion.widget.MotionScene$Transition> r1 = r8.mTransitionList     // Catch:{ XmlPullParserException -> 0x0169, IOException -> 0x0164 }
            androidx.constraintlayout.motion.widget.MotionScene$Transition r2 = new androidx.constraintlayout.motion.widget.MotionScene$Transition     // Catch:{ XmlPullParserException -> 0x0169, IOException -> 0x0164 }
            ...
            androidx.constraintlayout.motion.widget.MotionScene$Transition r1 = r8.mCurrentTransition     // Catch:{ XmlPullParserException -> 0x0169, IOException -> 0x0164 }
            if (r1 != 0) goto L_0x013c
            boolean r1 = r2.mIsAbstract     // Catch:{ XmlPullParserException -> 0x0169, IOException -> 0x0164 }
            if (r1 != 0) goto L_0x013c
            r8.mCurrentTransition = r2     // Catch:{ XmlPullParserException -> 0x0169, IOException -> 0x0164 }
            androidx.constraintlayout.motion.widget.TouchResponse r1 = r2.mTouchResponse     // Catch:{ XmlPullParserException -> 0x0169, IOException -> 0x0164 }
            if (r1 == 0) goto L_0x013c
            androidx.constraintlayout.motion.widget.MotionScene$Transition r1 = r8.mCurrentTransition     // Catch:{ XmlPullParserException -> 0x0169, IOException -> 0x0164 }
            androidx.constraintlayout.motion.widget.TouchResponse r1 = r1.mTouchResponse     // Catch:{ XmlPullParserException -> 0x0169, IOException -> 0x0164 }
            boolean r3 = r8.mRtl     // Catch:{ XmlPullParserException -> 0x0169, IOException -> 0x0164 }
            r1.setRTL(r3)     // Catch:{ XmlPullParserException -> 0x0169, IOException -> 0x0164 }
        L_0x013c:
            boolean r1 = r2.mIsAbstract     // Catch:{ XmlPullParserException -> 0x0169, IOException -> 0x0164 }
            if (r1 == 0) goto L_0x0155
            int r1 = r2.mConstraintSetEnd     // Catch:{ XmlPullParserException -> 0x0169, IOException -> 0x0164 }
            if (r1 != r6) goto L_0x014b
            r8.mDefaultTransition = r2     // Catch:{ XmlPullParserException -> 0x0169, IOException -> 0x0164 }
            goto L_0x0150
        L_0x014b:
            java.util.ArrayList<androidx.constraintlayout.motion.widget.MotionScene$Transition> r1 = r8.mAbstractTransitionList     // Catch:{ XmlPullParserException -> 0x0169, IOException -> 0x0164 }
            r1.add(r2)     // Catch:{ XmlPullParserException -> 0x0169, IOException -> 0x0164 }
        L_0x0150:
            java.util.ArrayList<androidx.constraintlayout.motion.widget.MotionScene$Transition> r1 = r8.mTransitionList     // Catch:{ XmlPullParserException -> 0x0169, IOException -> 0x0164 }
        ...
        L_0x0155:
            ...
            goto L_0x015e
        L_0x0157:
            r8.parseMotionSceneTags(r9, r0)     // Catch:{ XmlPullParserException -> 0x0169, IOException -> 0x0164 }
            goto L_0x015e
        L_0x015b:
    ...
    private void parseInclude(Context context, XmlPullParser xmlPullParser) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(Xml.asAttributeSet(xmlPullParser), C0218R.styleable.include);
        int indexCount = obtainStyledAttributes.getIndexCount();
        for (int i = 0; i < indexCount; i++) {
            int index = obtainStyledAttributes.getIndex(i);
            if (index == C0218R.styleable.include_constraintSet) {
    ...
    private void parseMotionSceneTags(Context context, XmlPullParser xmlPullParser) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(Xml.asAttributeSet(xmlPullParser), C0218R.styleable.MotionScene);
        int indexCount = obtainStyledAttributes.getIndexCount();
        for (int i = 0; i < indexCount; i++) {
            int index = obtainStyledAttributes.getIndex(i);
            if (index == C0218R.styleable.MotionScene_defaultDuration) {
                int i2 = obtainStyledAttributes.getInt(index, this.mDefaultDuration);
                this.mDefaultDuration = i2;
                if (i2 < 8) {
                    this.mDefaultDuration = 8;
                }
            } else if (index == C0218R.styleable.MotionScene_layoutDuringTransition) {
    ...
    private void readConstraintChain(int i, MotionLayout motionLayout) {
        ...
        if (i2 > 0) {
            ...
            constraintSet.derivedState += MiotCloudImpl.COOKIE_PATH + constraintSet2.derivedState;
    ...
    public ConstraintSet getConstraintSet(int i, int i2, int i3) {
        ...
        if (this.mConstraintSetMap.get(i) == null) {
            ...
            obj = this.mConstraintSetMap.get(i);
        }
