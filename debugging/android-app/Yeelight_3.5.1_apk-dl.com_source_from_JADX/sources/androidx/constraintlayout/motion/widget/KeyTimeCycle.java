...
public class KeyTimeCycle extends Key {
    ...
    private static class Loader {
        ...
        static {
            ...
            sparseIntArray.append(C0218R.styleable.KeyTimeCycle_android_alpha, 1);
            mAttrMap.append(C0218R.styleable.KeyTimeCycle_android_elevation, 2);
            mAttrMap.append(C0218R.styleable.KeyTimeCycle_android_rotation, 4);
            mAttrMap.append(C0218R.styleable.KeyTimeCycle_android_rotationX, 5);
            mAttrMap.append(C0218R.styleable.KeyTimeCycle_android_rotationY, 6);
            mAttrMap.append(C0218R.styleable.KeyTimeCycle_android_scaleX, 7);
            mAttrMap.append(C0218R.styleable.KeyTimeCycle_transitionPathRotate, 8);
            mAttrMap.append(C0218R.styleable.KeyTimeCycle_transitionEasing, 9);
            mAttrMap.append(C0218R.styleable.KeyTimeCycle_motionTarget, 10);
            mAttrMap.append(C0218R.styleable.KeyTimeCycle_framePosition, 12);
            mAttrMap.append(C0218R.styleable.KeyTimeCycle_curveFit, 13);
            mAttrMap.append(C0218R.styleable.KeyTimeCycle_android_scaleY, 14);
            mAttrMap.append(C0218R.styleable.KeyTimeCycle_android_translationX, 15);
            mAttrMap.append(C0218R.styleable.KeyTimeCycle_android_translationY, 16);
            mAttrMap.append(C0218R.styleable.KeyTimeCycle_android_translationZ, 17);
            mAttrMap.append(C0218R.styleable.KeyTimeCycle_motionProgress, 18);
            mAttrMap.append(C0218R.styleable.KeyTimeCycle_wavePeriod, 20);
            mAttrMap.append(C0218R.styleable.KeyTimeCycle_waveOffset, 21);
            mAttrMap.append(C0218R.styleable.KeyTimeCycle_waveShape, 19);
        }
        ...
        public static void read(KeyTimeCycle keyTimeCycle, TypedArray typedArray) {
            ...
            for (int i2 = 0; i2 < indexCount; i2++) {
                ...
                switch (mAttrMap.get(index)) {
                    ...
                    case 19:
                        if (typedArray.peekValue(index).type == 3) {
                            String unused15 = keyTimeCycle.mCustomWaveShape = typedArray.getString(index);
                            i = 7;
                        } else {
                            i = typedArray.getInt(index, keyTimeCycle.mWaveShape);
                        }
                        int unused16 = keyTimeCycle.mWaveShape = i;
                        break;
                    case 20:
                        float unused17 = keyTimeCycle.mWavePeriod = typedArray.getFloat(index, keyTimeCycle.mWavePeriod);
                        break;
                    case 21:
                        float unused18 = keyTimeCycle.mWaveOffset = typedArray.peekValue(index).type == 5 ? typedArray.getDimension(index, keyTimeCycle.mWaveOffset) : typedArray.getFloat(index, keyTimeCycle.mWaveOffset);
                        break;
                    default:
    ...
    public void load(Context context, AttributeSet attributeSet) {
        Loader.read(this, context.obtainStyledAttributes(attributeSet, C0218R.styleable.KeyTimeCycle));
    }
