...
public class Debug {
            ...
            try {
                ...
                if (field.getName().startsWith("layout_constraint")) {
                    if (!(obj2 instanceof Integer) || !obj2.toString().equals("-1")) {
                        if (!(obj2 instanceof Integer) || !obj2.toString().equals(TimerCodec.DISENABLE)) {
    ...
    public static String getState(MotionLayout motionLayout, int i, int i2) {
        ...
        return resourceEntryName.replaceAll(CharBuffer.allocate(length2).toString().replace(0, FilenameUtils.EXTENSION_SEPARATOR) + "_", "_");
    }
    ...
    public static void logStack(String str, String str2, int i) {
        ...
        for (int i2 = 1; i2 <= min; i2++) {
            ...
            sb.append(str2);
            sb.append(str3);
            sb.append(".(" + stackTrace[i2].getFileName() + Constants.COLON_SEPARATOR + stackTrace[i2].getLineNumber() + ") " + stackTrace[i2].getMethodName());
            sb.append(str3);
        }
    }
