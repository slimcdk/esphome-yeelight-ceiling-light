...
public class KeyCycle extends Key {
    ...
    private static class Loader {
        ...
        static {
            ...
            sparseIntArray.append(C0218R.styleable.KeyCycle_motionTarget, 1);
            mAttrMap.append(C0218R.styleable.KeyCycle_framePosition, 2);
            mAttrMap.append(C0218R.styleable.KeyCycle_transitionEasing, 3);
            mAttrMap.append(C0218R.styleable.KeyCycle_curveFit, 4);
            mAttrMap.append(C0218R.styleable.KeyCycle_waveShape, 5);
            mAttrMap.append(C0218R.styleable.KeyCycle_wavePeriod, 6);
            mAttrMap.append(C0218R.styleable.KeyCycle_waveOffset, 7);
            mAttrMap.append(C0218R.styleable.KeyCycle_waveVariesBy, 8);
            mAttrMap.append(C0218R.styleable.KeyCycle_android_alpha, 9);
            mAttrMap.append(C0218R.styleable.KeyCycle_android_elevation, 10);
            mAttrMap.append(C0218R.styleable.KeyCycle_android_rotation, 11);
            mAttrMap.append(C0218R.styleable.KeyCycle_android_rotationX, 12);
            mAttrMap.append(C0218R.styleable.KeyCycle_android_rotationY, 13);
            mAttrMap.append(C0218R.styleable.KeyCycle_transitionPathRotate, 14);
            mAttrMap.append(C0218R.styleable.KeyCycle_android_scaleX, 15);
            mAttrMap.append(C0218R.styleable.KeyCycle_android_scaleY, 16);
            mAttrMap.append(C0218R.styleable.KeyCycle_android_translationX, 17);
            mAttrMap.append(C0218R.styleable.KeyCycle_android_translationY, 18);
            mAttrMap.append(C0218R.styleable.KeyCycle_android_translationZ, 19);
            mAttrMap.append(C0218R.styleable.KeyCycle_motionProgress, 20);
            mAttrMap.append(C0218R.styleable.KeyCycle_wavePhase, 21);
        }
        ...
        public static void read(KeyCycle keyCycle, TypedArray typedArray) {
            ...
            for (int i2 = 0; i2 < indexCount; i2++) {
                ...
                switch (mAttrMap.get(index)) {
                    ...
                    case 5:
                        if (typedArray.peekValue(index).type == 3) {
                            String unused3 = keyCycle.mCustomWaveShape = typedArray.getString(index);
                            i = 7;
                        } else {
                            i = typedArray.getInt(index, keyCycle.mWaveShape);
                        }
                        int unused4 = keyCycle.mWaveShape = i;
                        break;
                    case 6:
                        float unused5 = keyCycle.mWavePeriod = typedArray.getFloat(index, keyCycle.mWavePeriod);
                        break;
                    case 7:
                        float unused6 = keyCycle.mWaveOffset = typedArray.peekValue(index).type == 5 ? typedArray.getDimension(index, keyCycle.mWaveOffset) : typedArray.getFloat(index, keyCycle.mWaveOffset);
                        break;
                    case 8:
                    ...
                    case 20:
                        ...
                        break;
                    case 21:
                        float unused20 = keyCycle.mWavePhase = typedArray.getFloat(index, keyCycle.mWavePhase) / 360.0f;
                        break;
                    default:
    ...
    public void load(Context context, AttributeSet attributeSet) {
        Loader.read(this, context.obtainStyledAttributes(attributeSet, C0218R.styleable.KeyCycle));
    }
