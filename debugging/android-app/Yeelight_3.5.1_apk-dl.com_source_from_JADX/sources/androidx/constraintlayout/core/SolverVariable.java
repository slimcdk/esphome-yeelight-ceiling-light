...
public class SolverVariable implements Comparable<SolverVariable> {
    ...
    static /* synthetic */ class C01611 {
        ...
        static {
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.core.SolverVariable.C01611.<clinit>():void");
        }
    }
    ...
    private static String getUniqueName(Type type, String str) {
        ...
        if (str != null) {
            ...
            int i2 = C01611.$SwitchMap$androidx$constraintlayout$core$SolverVariable$Type[type.ordinal()];
            if (i2 == 1) {
                sb = new StringBuilder();
                sb.append("U");
    ...
    public int compareTo(SolverVariable solverVariable) {
        return this.f17id - solverVariable.f17id;
    }
    ...
    public void setSynonym(LinearSystem linearSystem, SolverVariable solverVariable, float f) {
        this.isSynonym = true;
        this.synonym = solverVariable.f17id;
        this.synonymDelta = f;
        int i = this.mClientEquationsCount;
        this.definitionId = -1;
        for (int i2 = 0; i2 < i; i2++) {
