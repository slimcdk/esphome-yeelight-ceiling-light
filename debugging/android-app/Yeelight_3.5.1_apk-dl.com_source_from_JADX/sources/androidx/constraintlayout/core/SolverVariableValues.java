...
public class SolverVariableValues implements ArrayRow.ArrayRowVariables {
    ...
    private void addToHashMap(SolverVariable solverVariable, int i) {
        int[] iArr;
        int i2 = solverVariable.f17id % this.HASH_SIZE;
        int[] iArr2 = this.keys;
        int i3 = iArr2[i2];
        if (i3 == -1) {
            iArr2[i2] = i;
    ...
    private void addVariable(int i, SolverVariable solverVariable, float f) {
        this.variables[i] = solverVariable.f17id;
        this.values[i] = f;
        this.previous[i] = -1;
        this.next[i] = -1;
    ...
    public String toString() {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            SolverVariable variable = getVariable(i2);
            if (variable != null) {
                String str3 = str2 + variable + " = " + getVariableValue(i2) + " ";
                ...
                if (this.next[indexOf] != -1) {
                    str = str5 + this.mCache.mIndexedVariables[this.variables[this.next[indexOf]]];
                } else {
                    str = str5 + "none";
                }
                str2 = str + "]";
