...
import androidx.constraintlayout.core.motion.utils.C0167a;
...
public class MotionKeyAttributes extends MotionKey {
    ...
    public void printAttributes() {
        ...
        for (int i = 0; i < strArr.length; i++) {
            int a = C0167a.m7a(strArr[i]);
            PrintStream printStream2 = System.out;
            printStream2.println(strArr[i] + Constants.COLON_SEPARATOR + getFloatValue(a));
        }
    }
