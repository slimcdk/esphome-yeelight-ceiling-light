...
public class StopLogicEngine implements StopEngine {
    ...
    public String debug(String str, float f) {
        ...
        sb2.append(str + " ===== " + this.mType + IOUtils.LINE_SEPARATOR_UNIX);
        sb2.append(str);
        ...
        String str3 = sb2.toString() + str + " dur " + this.mStage1Duration + " vel " + this.mStage1Velocity + " pos " + this.mStage1EndPosition + IOUtils.LINE_SEPARATOR_UNIX;
