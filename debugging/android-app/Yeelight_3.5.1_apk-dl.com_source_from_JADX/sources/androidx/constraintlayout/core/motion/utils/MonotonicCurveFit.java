...
public class MonotonicCurveFit extends CurveFit {
    ...
    public double getPos(double d, int i) {
        ...
        if (this.mExtrapolate) {
            if (d <= dArr[0]) {
                return this.f37mY[0][i2] + ((d - dArr[0]) * getSlope(dArr[0], i2));
            }
            int i4 = length - 1;
            if (d >= dArr[i4]) {
                return this.f37mY[i4][i2] + ((d - dArr[i4]) * getSlope(dArr[i4], i2));
            }
        } else if (d <= dArr[0]) {
            return this.f37mY[0][i2];
        } else {
            int i5 = length - 1;
            if (d >= dArr[i5]) {
                return this.f37mY[i5][i2];
            }
        }
        while (i3 < length - 1) {
            double[] dArr2 = this.f36mT;
            if (d == dArr2[i3]) {
                return this.f37mY[i3][i2];
            }
            int i6 = i3 + 1;
            if (d < dArr2[i6]) {
