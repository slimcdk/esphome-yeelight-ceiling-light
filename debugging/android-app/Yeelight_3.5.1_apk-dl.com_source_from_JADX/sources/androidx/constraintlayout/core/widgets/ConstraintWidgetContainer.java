    ...
    public static boolean measure(int i, ConstraintWidget constraintWidget, BasicMeasure.Measurer measurer, BasicMeasure.Measure measure, int i2) {
        ...
        if (z4) {
            if (constraintWidget.mResolvedMatchConstraintDefault[1] == 4) {
                ...
                measure.verticalDimension = constraintWidget.getDimensionRatioSide() == -1 ? (int) (((float) i3) / constraintWidget.getDimensionRatio()) : (int) (constraintWidget.getDimensionRatio() * ((float) i3));
            }
        }
        measurer.measure(constraintWidget, measure);
