...
public abstract class ConstraintHelper extends View {
    ...
    private int findId(String str) {
        ...
        if (i == 0) {
            try {
                i = C0218R.C0220id.class.getField(str).getInt((Object) null);
    ...
    public void init(AttributeSet attributeSet) {
        if (attributeSet != null) {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                if (index == C0218R.styleable.ConstraintLayout_Layout_constraint_referenced_ids) {
                    String string = obtainStyledAttributes.getString(index);
                    this.mReferenceIds = string;
                    setIds(string);
                } else if (index == C0218R.styleable.ConstraintLayout_Layout_constraint_referenced_tags) {
