...
public class PeriodType implements Serializable {
    ...
    public boolean addIndexedField(C10225l lVar, int i, int[] iArr, int i2) {
        if (i2 == 0) {
            return false;
        }
        int i3 = this.iIndices[i];
        if (i3 != -1) {
            iArr[i3] = C10179e.m25388d(iArr[i3], i2);
            return true;
        }
    ...
    /* access modifiers changed from: package-private */
    public int getIndexedField(C10225l lVar, int i) {
        int i2 = this.iIndices[i];
        if (i2 == -1) {
            return 0;
        }
        return lVar.getValue(i2);
    }
    ...
    /* access modifiers changed from: package-private */
    public boolean setIndexedField(C10225l lVar, int i, int[] iArr, int i2) {
        int i3 = this.iIndices[i];
        if (i3 != -1) {
            iArr[i3] = i2;
            return true;
