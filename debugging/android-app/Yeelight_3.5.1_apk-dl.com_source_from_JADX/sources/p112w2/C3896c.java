...
public class C3896c {
    /* renamed from: a */
    private static int m11095a(RecyclerView.LayoutParams layoutParams) {
        try {
    ...
    /* renamed from: b */
    public static boolean m11096b(AbsListView absListView) {
    ...
    /* renamed from: c */
    public static boolean m11097c(AbsListView absListView) {
        if (absListView != null) {
    ...
    /* renamed from: d */
    public static boolean m11098d(RecyclerView recyclerView) {
    ...
    public static boolean m11099e(androidx.recyclerview.widget.RecyclerView r6) {
        /*
            r0 = 0
        ...
        L_0x0081:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p112w2.C3896c.m11099e(androidx.recyclerview.widget.RecyclerView):boolean");
    }

    /* renamed from: f */
    public static boolean m11100f(ViewGroup viewGroup) {
        View childAt = viewGroup.getChildAt(0);
        return childAt != null && childAt.getMeasuredHeight() <= viewGroup.getScrollY() + viewGroup.getHeight();
    }

    /* renamed from: g */
    public static boolean m11101g(View view, int i) {
        if (view instanceof AbsListView) {
            return m11096b((AbsListView) view);
        }
        if (view instanceof RecyclerView) {
            return m11098d((RecyclerView) view);
        }
        if (view instanceof WebView) {
            return m11103i((WebView) view, i);
        }
        if (view instanceof ViewGroup) {
            return m11100f((ViewGroup) view);
        }
        return false;
    }

    /* renamed from: h */
    public static boolean m11102h(View view, int i) {
        return view instanceof AbsListView ? m11097c((AbsListView) view) : view instanceof RecyclerView ? m11099e((RecyclerView) view) : view != null && Math.abs(view.getScrollY()) <= i * 2;
    }

    /* renamed from: i */
    public static boolean m11103i(WebView webView, int i) {
        return webView != null && (((float) webView.getContentHeight()) * webView.getScale()) - ((float) (webView.getHeight() + webView.getScrollY())) <= ((float) (i * 2));
    }

    /* renamed from: j */
    public static void m11104j(View view, int i) {
