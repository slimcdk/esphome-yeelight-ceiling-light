...
public class BluetoothClientImpl implements IBluetoothClient, ProxyInterceptor, Handler.Callback {
    ...
    private void bindServiceSync() {
        ...
        if (this.mContext.bindService(intent, this.mConnection, 1)) {
            BluetoothLog.m7332v(String.format("BluetoothService registered", new Object[0]));
            waitBluetoothManagerReady();
            return;
        }
        BluetoothLog.m7332v(String.format("BluetoothService not registered", new Object[0]));
