...
public class BleConnectRequest extends BleRequest implements ServiceDiscoverListener {
    ...
    private void onServiceDiscoverFailed() {
        BluetoothLog.m7332v(String.format("onServiceDiscoverFailed", new Object[0]));
        refreshDeviceCache();
    ...
    private void processDiscoverService() {
        BluetoothLog.m7332v(String.format("processDiscoverService, status = %s", new Object[]{getStatusText()}));
        int currentStatus = getCurrentStatus();
        if (currentStatus == 0) {
