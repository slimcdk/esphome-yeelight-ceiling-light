...
public interface ICompletedHandler extends IInterface {
    ...
    /* renamed from: com.mi.iot.manager.handler.ICompletedHandler$Default */
    public static class Default implements ICompletedHandler {
    ...
    public static abstract class Stub extends Binder implements ICompletedHandler {
        ...
        private static class Proxy implements ICompletedHandler {
            public static ICompletedHandler sDefaultImpl;
        ...
        public static ICompletedHandler getDefaultImpl() {
            return Proxy.sDefaultImpl;
        }

        public static boolean setDefaultImpl(ICompletedHandler iCompletedHandler) {
            if (Proxy.sDefaultImpl != null || iCompletedHandler == null) {
                return false;
            }
            Proxy.sDefaultImpl = iCompletedHandler;
            return true;
        }
