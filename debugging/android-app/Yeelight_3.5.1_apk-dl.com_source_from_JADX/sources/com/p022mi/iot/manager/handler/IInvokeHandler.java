...
public interface IInvokeHandler extends IInterface {
    ...
    /* renamed from: com.mi.iot.manager.handler.IInvokeHandler$Default */
    public static class Default implements IInvokeHandler {
    ...
    public static abstract class Stub extends Binder implements IInvokeHandler {
        ...
        private static class Proxy implements IInvokeHandler {
            public static IInvokeHandler sDefaultImpl;
            ...
            public void onResult(Action action) {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().onResult(action);
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
                }
        ...
        public static IInvokeHandler getDefaultImpl() {
            return Proxy.sDefaultImpl;
        }

        public static boolean setDefaultImpl(IInvokeHandler iInvokeHandler) {
            if (Proxy.sDefaultImpl != null || iInvokeHandler == null) {
                return false;
            }
            Proxy.sDefaultImpl = iInvokeHandler;
            return true;
        }
        ...
        public boolean onTransact(int r5, android.os.Parcel r6, android.os.Parcel r7, int r8) {
            /*
                ...
                r0 = 0
                r1 = 1
                java.lang.String r2 = "com.mi.iot.manager.handler.IInvokeHandler"
            ...
            L_0x0030:
                ...
                android.os.Parcelable$Creator<com.mi.iot.common.instance.Action> r5 = com.p022mi.iot.common.instance.Action.CREATOR
                java.lang.Object r5 = r5.createFromParcel(r6)
                r0 = r5
            ...
            L_0x0042:
                ...
                goto L_0x002c
            */
            throw new UnsupportedOperationException("Method not decompiled: com.p022mi.iot.manager.handler.IInvokeHandler.Stub.onTransact(int, android.os.Parcel, android.os.Parcel, int):boolean");
        }
    }
