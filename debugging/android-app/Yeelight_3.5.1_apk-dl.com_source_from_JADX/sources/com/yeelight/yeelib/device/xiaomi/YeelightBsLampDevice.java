...
public class YeelightBsLampDevice extends AbstractDevice {
    public static final Parcelable.Creator<YeelightBsLampDevice> CREATOR = new C8162a();
    ...
    class C8162a implements Parcelable.Creator<YeelightBsLampDevice> {
        C8162a() {
        }

        /* renamed from: a */
        public YeelightBsLampDevice createFromParcel(Parcel parcel) {
            return new YeelightBsLampDevice(parcel, (C8162a) null);
        }
    ...
    /* synthetic */ YeelightBsLampDevice(Parcel parcel, C8162a aVar) {
        this(parcel);
    }
