...
public class YeelightLamp2Device extends AbstractDevice {
    public static final Parcelable.Creator<YeelightLamp2Device> CREATOR = new C8183a();
    ...
    class C8183a implements Parcelable.Creator<YeelightLamp2Device> {
        C8183a() {
        }

        /* renamed from: a */
        public YeelightLamp2Device createFromParcel(Parcel parcel) {
            return new YeelightLamp2Device(parcel, (C8183a) null);
        }
    ...
    /* synthetic */ YeelightLamp2Device(Parcel parcel, C8183a aVar) {
        this(parcel);
    }
