...
public class YeelightPanel1Device extends AbstractDevice {
    public static final Parcelable.Creator<YeelightPanel1Device> CREATOR = new C8192a();
    ...
    class C8192a implements Parcelable.Creator<YeelightPanel1Device> {
        C8192a() {
        }

        /* renamed from: a */
        public YeelightPanel1Device createFromParcel(Parcel parcel) {
            return new YeelightPanel1Device(parcel, (C8192a) null);
        }
    ...
    /* synthetic */ YeelightPanel1Device(Parcel parcel, C8192a aVar) {
        this(parcel);
    }
