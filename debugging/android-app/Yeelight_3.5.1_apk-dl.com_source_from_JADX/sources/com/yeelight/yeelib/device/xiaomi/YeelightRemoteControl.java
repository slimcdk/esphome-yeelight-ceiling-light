...
public class YeelightRemoteControl extends AbstractDevice {
    public static final Parcelable.Creator<YeelightRemoteControl> CREATOR = new C8195a();
    ...
    class C8195a implements Parcelable.Creator<YeelightRemoteControl> {
        C8195a() {
        }

        /* renamed from: a */
        public YeelightRemoteControl createFromParcel(Parcel parcel) {
            return new YeelightRemoteControl(parcel, (C8195a) null);
        }
    ...
    /* synthetic */ YeelightRemoteControl(Parcel parcel, C8195a aVar) {
        this(parcel);
    }
