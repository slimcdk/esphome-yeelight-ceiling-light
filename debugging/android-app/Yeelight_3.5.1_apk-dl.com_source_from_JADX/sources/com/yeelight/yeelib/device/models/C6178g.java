...
/* renamed from: com.yeelight.yeelib.device.models.g */
public class C6178g extends ProductModelBase {
    public C6178g(String str) {
        super(str);
        ...
        this.f12701a.add(new ProductModelBase.C6170a(this, ProductModelBase.CapabilityType.MOON_WITH_CT_TAB));
