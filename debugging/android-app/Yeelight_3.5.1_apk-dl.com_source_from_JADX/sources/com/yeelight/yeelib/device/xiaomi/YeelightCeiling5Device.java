...
public class YeelightCeiling5Device extends AbstractDevice {
    public static final Parcelable.Creator<YeelightCeiling5Device> CREATOR = new C8169a();
    ...
    class C8169a implements Parcelable.Creator<YeelightCeiling5Device> {
        C8169a() {
        }

        /* renamed from: a */
        public YeelightCeiling5Device createFromParcel(Parcel parcel) {
            return new YeelightCeiling5Device(parcel, (C8169a) null);
        }
    ...
    /* synthetic */ YeelightCeiling5Device(Parcel parcel, C8169a aVar) {
        this(parcel);
    }
