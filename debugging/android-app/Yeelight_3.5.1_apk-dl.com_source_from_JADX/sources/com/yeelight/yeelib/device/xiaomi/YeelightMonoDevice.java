...
public class YeelightMonoDevice extends AbstractDevice {
    public static final Parcelable.Creator<YeelightMonoDevice> CREATOR = new C8190a();
    ...
    class C8190a implements Parcelable.Creator<YeelightMonoDevice> {
        C8190a() {
        }

        /* renamed from: a */
        public YeelightMonoDevice createFromParcel(Parcel parcel) {
            return new YeelightMonoDevice(parcel, (C8190a) null);
        }
    ...
    /* synthetic */ YeelightMonoDevice(Parcel parcel, C8190a aVar) {
        this(parcel);
    }
