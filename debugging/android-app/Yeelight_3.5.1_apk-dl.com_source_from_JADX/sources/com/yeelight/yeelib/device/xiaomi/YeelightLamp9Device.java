...
public class YeelightLamp9Device extends AbstractDevice {
    public static final Parcelable.Creator<YeelightLamp9Device> CREATOR = new C8186a();
    ...
    class C8186a implements Parcelable.Creator<YeelightLamp9Device> {
        C8186a() {
        }

        /* renamed from: a */
        public YeelightLamp9Device createFromParcel(Parcel parcel) {
            return new YeelightLamp9Device(parcel, (C8186a) null);
        }
    ...
    /* synthetic */ YeelightLamp9Device(Parcel parcel, C8186a aVar) {
        this(parcel);
    }
