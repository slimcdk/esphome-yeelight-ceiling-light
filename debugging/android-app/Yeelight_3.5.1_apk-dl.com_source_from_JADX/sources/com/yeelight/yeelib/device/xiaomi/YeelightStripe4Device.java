...
public class YeelightStripe4Device extends AbstractDevice {
    public static final Parcelable.Creator<YeelightStripe4Device> CREATOR = new C8197a();
    ...
    class C8197a implements Parcelable.Creator<YeelightStripe4Device> {
        C8197a() {
        }

        /* renamed from: a */
        public YeelightStripe4Device createFromParcel(Parcel parcel) {
            return new YeelightStripe4Device(parcel, (C8197a) null);
        }
    ...
    /* synthetic */ YeelightStripe4Device(Parcel parcel, C8197a aVar) {
        this(parcel);
    }
