...
public class YeelightLamp3Device extends AbstractDevice {
    public static final Parcelable.Creator<YeelightLamp3Device> CREATOR = new C8184a();
    ...
    class C8184a implements Parcelable.Creator<YeelightLamp3Device> {
        C8184a() {
        }

        /* renamed from: a */
        public YeelightLamp3Device createFromParcel(Parcel parcel) {
            return new YeelightLamp3Device(parcel, (C8184a) null);
        }
    ...
    /* synthetic */ YeelightLamp3Device(Parcel parcel, C8184a aVar) {
        this(parcel);
    }
