...
public class YeelightLamp15Device extends AbstractDevice {
    public static final Parcelable.Creator<YeelightLamp15Device> CREATOR = new C8182a();
    ...
    class C8182a implements Parcelable.Creator<YeelightLamp15Device> {
        C8182a() {
        }

        /* renamed from: a */
        public YeelightLamp15Device createFromParcel(Parcel parcel) {
            return new YeelightLamp15Device(parcel, (C8182a) null);
        }
    ...
    /* synthetic */ YeelightLamp15Device(Parcel parcel, C8182a aVar) {
        this(parcel);
    }
