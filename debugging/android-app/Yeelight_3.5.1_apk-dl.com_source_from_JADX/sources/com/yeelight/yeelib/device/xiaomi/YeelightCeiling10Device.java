...
public class YeelightCeiling10Device extends AbstractDevice {
    public static final Parcelable.Creator<YeelightCeiling10Device> CREATOR = new C8163a();
    ...
    class C8163a implements Parcelable.Creator<YeelightCeiling10Device> {
        C8163a() {
        }

        /* renamed from: a */
        public YeelightCeiling10Device createFromParcel(Parcel parcel) {
            return new YeelightCeiling10Device(parcel, (C8163a) null);
        }
    ...
    /* synthetic */ YeelightCeiling10Device(Parcel parcel, C8163a aVar) {
        this(parcel);
    }
