...
public class YeelightPanel3Device extends AbstractDevice {
    public static final Parcelable.Creator<YeelightPanel3Device> CREATOR = new C8193a();
    ...
    class C8193a implements Parcelable.Creator<YeelightPanel3Device> {
        C8193a() {
        }

        /* renamed from: a */
        public YeelightPanel3Device createFromParcel(Parcel parcel) {
            return new YeelightPanel3Device(parcel, (C8193a) null);
        }
    ...
    /* synthetic */ YeelightPanel3Device(Parcel parcel, C8193a aVar) {
        this(parcel);
    }
