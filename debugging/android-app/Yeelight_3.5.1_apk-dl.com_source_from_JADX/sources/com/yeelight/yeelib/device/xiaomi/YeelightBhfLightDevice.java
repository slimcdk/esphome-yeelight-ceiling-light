...
public class YeelightBhfLightDevice extends AbstractDevice {
    public static final Parcelable.Creator<YeelightBhfLightDevice> CREATOR = new C8158a();
    ...
    class C8158a implements Parcelable.Creator<YeelightBhfLightDevice> {
        C8158a() {
        }

        /* renamed from: a */
        public YeelightBhfLightDevice createFromParcel(Parcel parcel) {
            return new YeelightBhfLightDevice(parcel, (C8158a) null);
        }
    ...
    /* synthetic */ YeelightBhfLightDevice(Parcel parcel, C8158a aVar) {
        this(parcel);
    }
