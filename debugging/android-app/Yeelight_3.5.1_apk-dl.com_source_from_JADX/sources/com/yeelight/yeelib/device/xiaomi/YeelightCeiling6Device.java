...
public class YeelightCeiling6Device extends AbstractDevice {
    public static final Parcelable.Creator<YeelightCeiling6Device> CREATOR = new C8170a();
    ...
    class C8170a implements Parcelable.Creator<YeelightCeiling6Device> {
        C8170a() {
        }

        /* renamed from: a */
        public YeelightCeiling6Device createFromParcel(Parcel parcel) {
            return new YeelightCeiling6Device(parcel, (C8170a) null);
        }
    ...
    /* synthetic */ YeelightCeiling6Device(Parcel parcel, C8170a aVar) {
        this(parcel);
    }
