...
public class YeelightBsLamp3Device extends AbstractDevice {
    public static final Parcelable.Creator<YeelightBsLamp3Device> CREATOR = new C8161a();
    ...
    class C8161a implements Parcelable.Creator<YeelightBsLamp3Device> {
        C8161a() {
        }

        /* renamed from: a */
        public YeelightBsLamp3Device createFromParcel(Parcel parcel) {
            return new YeelightBsLamp3Device(parcel, (C8161a) null);
        }
    ...
    /* synthetic */ YeelightBsLamp3Device(Parcel parcel, C8161a aVar) {
        this(parcel);
    }
