...
public class YeelightMonobDevice extends AbstractDevice {
    public static final Parcelable.Creator<YeelightMonobDevice> CREATOR = new C8191a();
    ...
    class C8191a implements Parcelable.Creator<YeelightMonobDevice> {
        C8191a() {
        }

        /* renamed from: a */
        public YeelightMonobDevice createFromParcel(Parcel parcel) {
            return new YeelightMonobDevice(parcel, (C8191a) null);
        }
    ...
    /* synthetic */ YeelightMonobDevice(Parcel parcel, C8191a aVar) {
        this(parcel);
    }
