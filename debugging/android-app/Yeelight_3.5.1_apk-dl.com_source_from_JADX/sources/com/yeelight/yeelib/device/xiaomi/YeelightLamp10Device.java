...
public class YeelightLamp10Device extends AbstractDevice {
    public static final Parcelable.Creator<YeelightLamp10Device> CREATOR = new C8181a();
    ...
    class C8181a implements Parcelable.Creator<YeelightLamp10Device> {
        C8181a() {
        }

        /* renamed from: a */
        public YeelightLamp10Device createFromParcel(Parcel parcel) {
            return new YeelightLamp10Device(parcel, (C8181a) null);
        }
    ...
    /* synthetic */ YeelightLamp10Device(Parcel parcel, C8181a aVar) {
        this(parcel);
    }
