...
public class YeelightColor3Device extends AbstractDevice {
    public static final Parcelable.Creator<YeelightColor3Device> CREATOR = new C8175a();
    ...
    class C8175a implements Parcelable.Creator<YeelightColor3Device> {
        C8175a() {
        }

        /* renamed from: a */
        public YeelightColor3Device createFromParcel(Parcel parcel) {
            return new YeelightColor3Device(parcel, (C8175a) null);
        }
    ...
    /* synthetic */ YeelightColor3Device(Parcel parcel, C8175a aVar) {
        this(parcel);
    }
