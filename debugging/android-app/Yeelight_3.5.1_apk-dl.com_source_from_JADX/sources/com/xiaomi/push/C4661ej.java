...
class C4661ej implements C4658eg {
    C4661ej() {
    }

    /* renamed from: a */
    private void m13663a(Service service, Intent intent) {
        String stringExtra = intent.getStringExtra("awake_info");
        if (!TextUtils.isEmpty(stringExtra)) {
            String b = C4649dy.m13608b(stringExtra);
            if (!TextUtils.isEmpty(b)) {
                C4650dz.m13610a(service.getApplicationContext(), b, 1007, "play with service successfully");
                return;
            }
        }
        C4650dz.m13610a(service.getApplicationContext(), "service", 1008, "B get a incorrect message");
    }

    /* renamed from: b */
    private void m13664b(Context context, C4654ec ecVar) {
        ...
        if (context == null || TextUtils.isEmpty(a) || TextUtils.isEmpty(b) || TextUtils.isEmpty(d)) {
        ...
        } else if (!C4969l.m15576a(context, a, b)) {
            ...
            try {
                ...
                if (a2 == 1 && !C4655ed.m13639a(context)) {
                    ...
                    C4650dz.m13610a(context, d, 1008, "A is fail to help B's service");
                }
            } catch (Exception e) {
                C4408b.m12478a((Throwable) e);
                C4650dz.m13610a(context, d, 1008, "A meet a exception when help B's service");
            }
        }
    }
    ...
    public void mo29028a(Context context, Intent intent, String str) {
        if (context == null || !(context instanceof Service)) {
            C4650dz.m13610a(context, "service", 1008, "A receive incorrect message");
        } else {
            m13663a((Service) context, intent);
        }
    }
