...
import com.xiaomi.push.C4836r;
import java.util.ArrayList;
import java.util.Arrays;

/* renamed from: com.xiaomi.push.service.ca */
public class C4937ca {

    /* renamed from: a */
    public static final Object f9649a = new Object();

    /* renamed from: a */
    public static ArrayList<C4764hn> f9650a = new ArrayList<>();
    ...
    /* renamed from: a */
    public static void m15503a(Context context, C4764hn hnVar) {
        if (C4935bz.m15499a(hnVar.mo29310e())) {
            C4516al.m12857a(context).mo28733a((Runnable) new C4938cb(context, hnVar));
        }
    }

    /* renamed from: a */
    public static void m15504a(C4764hn hnVar) {
        if (f9650a.size() > 10) {
            f9650a.remove(0);
        }
        f9650a.add(hnVar);
    ...
    /* renamed from: a */
    public static byte[] m15505a(Context context) {
        String a = C4836r.m15031a(context).mo29899a("mipush", "td_key", "");
        if (TextUtils.isEmpty(a)) {
            a = C4561bp.m13041a(20);
            C4836r.m15031a(context).mo29899a("mipush", "td_key", a);
        }
        return m15506a(a);
    }

    /* renamed from: a */
    private static byte[] m15506a(String str) {
    ...
    public static void m15508c(android.content.Context r7, com.xiaomi.push.C4764hn r8) {
        /*
            byte[] r0 = m15505a((android.content.Context) r7)
            r1 = 0
            byte[] r2 = com.xiaomi.push.C4797it.m14834a(r8)     // Catch:{ IOException -> 0x00ba, Exception -> 0x00a2, all -> 0x009f }
            byte[] r0 = com.xiaomi.push.C4777i.m14413b(r0, r2)     // Catch:{ IOException -> 0x00ba, Exception -> 0x00a2, all -> 0x009f }
        ...
        L_0x0017:
            ...
            java.lang.String r0 = r8.mo29308d()     // Catch:{ IOException -> 0x00ba, Exception -> 0x00a2, all -> 0x009f }
            r7.append(r0)     // Catch:{ IOException -> 0x00ba, Exception -> 0x00a2, all -> 0x009f }
        ...
        L_0x003b:
            com.xiaomi.channel.commonutils.logger.C4408b.m12464a((java.lang.String) r7)     // Catch:{ IOException -> 0x00ba, Exception -> 0x00a2, all -> 0x009f }
        ...
        L_0x0045:
            ...
            byte[] r2 = com.xiaomi.push.C4510af.m12848a((int) r2)     // Catch:{ IOException -> 0x007a, Exception -> 0x0075, all -> 0x0070 }
        ...
        L_0x00a4:
            ...
            java.lang.String r8 = r8.mo29308d()     // Catch:{ all -> 0x00db }
        ...
        L_0x00bc:
            ...
            java.lang.String r8 = r2.toString()     // Catch:{ all -> 0x00db }
        L_0x00d1:
            com.xiaomi.channel.commonutils.logger.C4408b.m12477a((java.lang.String) r8, (java.lang.Throwable) r7)     // Catch:{ all -> 0x00db }
            com.xiaomi.push.C4506ab.m12831a((java.io.Closeable) r1)
        ...
        L_0x00e4:
            goto L_0x00e3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xiaomi.push.service.C4937ca.m15508c(android.content.Context, com.xiaomi.push.hn):void");
    }
}
