...
public final class LeakCanary {
    ...
    public static RefWatcher androidWatcher(Context context, HeapDump.Listener listener, ExcludedRefs excludedRefs) {
        ...
        return new RefWatcher(new AndroidWatchExecutor(context.getResources().getInteger(C4247R.integer.leak_canary_watch_delay_millis)), androidDebuggerControl, GcTrigger.DEFAULT, androidHeapDumper, listener, excludedRefs);
    }
