        ...
        if (!gone(keyedWeakReference) && !this.debuggerControl.isDebuggerAttached()) {
            ...
            if (!gone(keyedWeakReference)) {
                ...
                if (dumpHeap != HeapDumper.NO_DUMP) {
                    this.heapdumpListener.analyze(new HeapDump(dumpHeap, keyedWeakReference2.key, keyedWeakReference2.name, this.excludedRefs, millis, millis2, timeUnit.toMillis(System.nanoTime() - nanoTime2)));
                }
            }
        }
    }
