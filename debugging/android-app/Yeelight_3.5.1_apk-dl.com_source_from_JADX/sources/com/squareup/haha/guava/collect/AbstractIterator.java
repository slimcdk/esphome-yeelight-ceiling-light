...
public abstract class AbstractIterator<T> extends UnmodifiableIterator<T> {
    ...
    static /* synthetic */ class C41881 {
        ...
        static {
            ...
            L_0x0015:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.squareup.haha.guava.collect.AbstractIterator.C41881.<clinit>():void");
        }
    }
    ...
    public final boolean hasNext() {
        int i = this.state$7fb44498;
        int i2 = State.FAILED$7fb44498;
        Ascii.checkState(i != i2);
        int i3 = C41881.$SwitchMap$com$google$common$collect$AbstractIterator$State[this.state$7fb44498 - 1];
        if (i3 == 1) {
            return false;
        }
        if (i3 == 2) {
