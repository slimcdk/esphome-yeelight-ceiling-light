...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    static class C4186Or extends CharMatcher {
        private CharMatcher first;
        private CharMatcher second;

        C4186Or(CharMatcher charMatcher, CharMatcher charMatcher2) {
            this(charMatcher, charMatcher2, "CharMatcher.or(" + charMatcher + ", " + charMatcher2 + ")");
        }

        private C4186Or(CharMatcher charMatcher, CharMatcher charMatcher2, String str) {
            super(str);
        ...
        public final CharMatcher withToString(String str) {
            return new C4186Or(this.first, this.second, str);
        }
    }
    ...
    static {
        ...
        inRange(0, 31).mo27343or(inRange(127, 159)).withToString("CharMatcher.JAVA_ISO_CONTROL");
        ...
        new FastMatcher("CharMatcher.ANY") {
            ...
            /* renamed from: or */
            public final CharMatcher mo27343or(CharMatcher charMatcher) {
    ...
    /* renamed from: or */
    public CharMatcher mo27343or(CharMatcher charMatcher) {
        return new C4186Or(this, (CharMatcher) Ascii.checkNotNull(charMatcher));
    }
