...
public abstract class ImmutableList<E> extends ImmutableCollection<E> implements List<E>, RandomAccess {
    ...
    /* renamed from: of */
    public static <E> ImmutableList<E> m7502of() {
        return EMPTY;
    }

    /* renamed from: of */
    public static <E> ImmutableList<E> m7503of(E e) {
        return new SingletonImmutableList(e);
    }

    /* renamed from: of */
    public static <E> ImmutableList<E> m7504of(E e, E e2) {
    ...
    public ImmutableList<E> subList(int i, int i2) {
        Ascii.checkPositionIndexes(i, i2, size());
        int i3 = i2 - i;
        return i3 != 0 ? i3 != 1 ? subListUnchecked(i, i2) : m7503of(get(i)) : EMPTY;
    }
