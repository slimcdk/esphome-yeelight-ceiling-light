...
public class RenderableManager {
    ...
    public static class Builder {
        ...
        @NonNull
        public Builder blendOrder(@IntRange(from = 0) int i, @IntRange(from = 0, mo660to = 32767) int i2) {
        ...
        @NonNull
        public Builder layerMask(@IntRange(from = 0, mo660to = 255) int i, @IntRange(from = 0, mo660to = 255) int i2) {
        ...
        @NonNull
        public Builder priority(@IntRange(from = 0, mo660to = 7) int i) {
        ...
        @NonNull
        public Builder skinning(@IntRange(from = 0, mo660to = 255) int i) {
            RenderableManager.nBuilderSkinning(this.mNativeBuilder, i);
            return this;
        }

        @NonNull
        public Builder skinning(@IntRange(from = 0, mo660to = 255) int i, @NonNull Buffer buffer) {
    ...
    public void setBlendOrderAt(@EntityInstance int i, @IntRange(from = 0) int i2, @IntRange(from = 0, mo660to = 65535) int i3) {
        nSetBlendOrderAt(this.mNativeObject, i, i2, i3);
    }

    public void setBonesAsMatrices(@EntityInstance int i, @NonNull Buffer buffer, @IntRange(from = 0, mo660to = 255) int i2, @IntRange(from = 0) int i3) {
        if (nSetBonesAsMatrices(this.mNativeObject, i, buffer, buffer.remaining(), i2, i3) < 0) {
            throw new BufferOverflowException();
        }
    }

    public void setBonesAsQuaternions(@EntityInstance int i, @NonNull Buffer buffer, @IntRange(from = 0, mo660to = 255) int i2, @IntRange(from = 0) int i3) {
    ...
    public void setLayerMask(@EntityInstance int i, @IntRange(from = 0, mo660to = 255) int i2, @IntRange(from = 0, mo660to = 255) int i3) {
    ...
    public void setPriority(@EntityInstance int i, @IntRange(from = 0, mo660to = 7) int i2) {
