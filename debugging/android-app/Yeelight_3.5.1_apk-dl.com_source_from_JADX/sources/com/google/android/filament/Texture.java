...
public class Texture {
    ...
    static /* synthetic */ class C07081 {
        ...
        static {
            ...
            L_0x00f1:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.android.filament.Texture.C07081.<clinit>():void");
        }
    }
    ...
    public static class PixelBufferDescriptor {
        ...
        public PixelBufferDescriptor(@NonNull Buffer buffer, @NonNull Format format2, @NonNull Type type2, @IntRange(from = 1, mo660to = 8) int i) {
            this(buffer, format2, type2, i, 0, 0, 0, (Object) null, (Runnable) null);
        }

        public PixelBufferDescriptor(@NonNull Buffer buffer, @NonNull Format format2, @NonNull Type type2, @IntRange(from = 1, mo660to = 8) int i, @IntRange(from = 0) int i2, @IntRange(from = 0) int i3) {
            this(buffer, format2, type2, i, i2, i3, 0, (Object) null, (Runnable) null);
        }

        public PixelBufferDescriptor(@NonNull Buffer buffer, @NonNull Format format2, @NonNull Type type2, @IntRange(from = 1, mo660to = 8) int i, @IntRange(from = 0) int i2, @IntRange(from = 0) int i3, @IntRange(from = 0) int i4, @Nullable Object obj, @Nullable Runnable runnable) {
            this.alignment = 1;
            this.left = 0;
            this.top = 0;
            this.stride = 0;
        ...
        static int computeDataSize(@NonNull Format format2, @NonNull Type type2, int i, int i2, @IntRange(from = 1, mo660to = 8) int i3) {
            int i4 = 0;
            if (type2 == Type.COMPRESSED) {
                return 0;
            }
            int i5 = 4;
            switch (C07081.$SwitchMap$com$google$android$filament$Texture$Format[format2.ordinal()]) {
                case 1:
                case 2:
                case 3:
                case 4:
            ...
            switch (C07081.$SwitchMap$com$google$android$filament$Texture$Type[type2.ordinal()]) {
                case 3:
                case 4:
                case 5:
                    i5 = i4 * 2;
