...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    private final ViewDragHelper.Callback dragCallback = new ViewDragHelper.Callback() {
        ...
        public void onViewReleased(@androidx.annotation.NonNull android.view.View r8, float r9, float r10) {
            ...
            L_0x00de:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.android.material.bottomsheet.BottomSheetBehavior.C19442.onViewReleased(android.view.View, float, float):void");
        }
        ...
        public boolean tryCaptureView(@androidx.annotation.NonNull android.view.View r6, int r7) {
            ...
            L_0x0035:
                return r2
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.android.material.bottomsheet.BottomSheetBehavior.C19442.tryCaptureView(android.view.View, int):boolean");
        }
    };
    ...
    public BottomSheetBehavior(Context context, AttributeSet attributeSet) {
        ...
        int i;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1920R.styleable.BottomSheetBehavior_Layout);
        int i2 = C1920R.styleable.BottomSheetBehavior_Layout_behavior_peekHeight;
        ...
        setHideable(obtainStyledAttributes.getBoolean(C1920R.styleable.BottomSheetBehavior_Layout_behavior_hideable, false));
        setFitToContents(obtainStyledAttributes.getBoolean(C1920R.styleable.BottomSheetBehavior_Layout_behavior_fitToContents, true));
        setSkipCollapsed(obtainStyledAttributes.getBoolean(C1920R.styleable.BottomSheetBehavior_Layout_behavior_skipCollapsed, false));
    ...
    public boolean onLayoutChild(androidx.coordinatorlayout.widget.CoordinatorLayout r5, V r6, int r7) {
        ...
        L_0x0010:
            ...
            int r2 = com.google.android.material.C1920R.dimen.design_bottom_sheet_peek_height_min
