...
public class MaterialButton extends AppCompatButton {
    ...
    public MaterialButton(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1920R.attr.materialButtonStyle);
    }

    public MaterialButton(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C1920R.styleable.MaterialButton, i, C1920R.style.Widget_MaterialComponents_Button, new int[0]);
        this.iconPadding = obtainStyledAttributes.getDimensionPixelSize(C1920R.styleable.MaterialButton_iconPadding, 0);
        this.iconTintMode = ViewUtils.parseTintMode(obtainStyledAttributes.getInt(C1920R.styleable.MaterialButton_iconTintMode, -1), PorterDuff.Mode.SRC_IN);
        this.iconTint = MaterialResources.getColorStateList(getContext(), obtainStyledAttributes, C1920R.styleable.MaterialButton_iconTint);
        this.icon = MaterialResources.getDrawable(getContext(), obtainStyledAttributes, C1920R.styleable.MaterialButton_icon);
        this.iconGravity = obtainStyledAttributes.getInteger(C1920R.styleable.MaterialButton_iconGravity, 1);
        this.iconSize = obtainStyledAttributes.getDimensionPixelSize(C1920R.styleable.MaterialButton_iconSize, 0);
    ...
    public void setCornerRadius(@C0048Px int i) {
        if (isUsingOriginalBackground()) {
    ...
    public void setIconPadding(@C0048Px int i) {
    ...
    public void setIconSize(@C0048Px int i) {
        if (i < 0) {
    ...
    public void setStrokeWidth(@C0048Px int i) {
        if (isUsingOriginalBackground()) {
