...
public class BottomNavigationItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(C1920R.layout.design_bottom_navigation_item, this, true);
        setBackgroundResource(C1920R.C1921drawable.design_bottom_navigation_item_background);
        this.defaultMargin = resources.getDimensionPixelSize(C1920R.dimen.design_bottom_navigation_margin);
        this.icon = (ImageView) findViewById(C1920R.C1922id.icon);
        TextView textView = (TextView) findViewById(C1920R.C1922id.smallLabel);
        this.smallLabel = textView;
        TextView textView2 = (TextView) findViewById(C1920R.C1922id.largeLabel);
