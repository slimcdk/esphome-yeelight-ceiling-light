...
public class AppBarLayout extends LinearLayout {
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1920R.styleable.AppBarLayout_Layout);
            this.scrollFlags = obtainStyledAttributes.getInt(C1920R.styleable.AppBarLayout_Layout_layout_scrollFlags, 0);
            int i = C1920R.styleable.AppBarLayout_Layout_layout_scrollInterpolator;
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        public ScrollingViewBehavior(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1920R.styleable.ScrollingViewBehavior_Layout);
            setOverlayTop(obtainStyledAttributes.getDimensionPixelSize(C1920R.styleable.ScrollingViewBehavior_Layout_behavior_overlapTop, 0));
            obtainStyledAttributes.recycle();
        }
    ...
    public AppBarLayout(Context context, AttributeSet attributeSet) {
        ...
        if (i >= 21) {
            ...
            ViewUtilsLollipop.setStateListAnimatorFromAttrs(this, attributeSet, 0, C1920R.style.Widget_Design_AppBarLayout);
        }
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C1920R.styleable.AppBarLayout, 0, C1920R.style.Widget_Design_AppBarLayout, new int[0]);
        ViewCompat.setBackground(this, obtainStyledAttributes.getDrawable(C1920R.styleable.AppBarLayout_android_background));
        int i2 = C1920R.styleable.AppBarLayout_expanded;
        if (obtainStyledAttributes.hasValue(i2)) {
            setExpanded(obtainStyledAttributes.getBoolean(i2, false), false, false);
        }
        if (i >= 21) {
            int i3 = C1920R.styleable.AppBarLayout_elevation;
        ...
        if (i >= 26) {
            int i4 = C1920R.styleable.AppBarLayout_android_keyboardNavigationCluster;
            if (obtainStyledAttributes.hasValue(i4)) {
                setKeyboardNavigationCluster(obtainStyledAttributes.getBoolean(i4, false));
            }
            int i5 = C1920R.styleable.AppBarLayout_android_touchscreenBlocksFocus;
            if (obtainStyledAttributes.hasValue(i5)) {
                setTouchscreenBlocksFocus(obtainStyledAttributes.getBoolean(i5, false));
            }
        }
        this.liftOnScroll = obtainStyledAttributes.getBoolean(C1920R.styleable.AppBarLayout_liftOnScroll, false);
        obtainStyledAttributes.recycle();
    ...
    public int[] onCreateDrawableState(int i) {
        ...
        int i2 = C1920R.attr.state_liftable;
        if (!z) {
            i2 = -i2;
        }
        iArr[0] = i2;
        iArr[1] = (!z || !this.lifted) ? -C1920R.attr.state_lifted : C1920R.attr.state_lifted;
        int i3 = C1920R.attr.state_collapsible;
        if (!z) {
            i3 = -i3;
        }
        iArr[2] = i3;
        iArr[3] = (!z || !this.lifted) ? -C1920R.attr.state_collapsed : C1920R.attr.state_collapsed;
