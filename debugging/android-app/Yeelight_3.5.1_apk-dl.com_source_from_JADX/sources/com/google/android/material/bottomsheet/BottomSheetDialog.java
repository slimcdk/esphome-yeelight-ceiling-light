...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    private static int getThemeResId(Context context, int i) {
        ...
        return context.getTheme().resolveAttribute(C1920R.attr.bottomSheetDialogTheme, typedValue, true) ? typedValue.resourceId : C1920R.style.Theme_Design_Light_BottomSheetDialog;
    }

    private View wrapInBottomSheet(int i, View view, ViewGroup.LayoutParams layoutParams) {
        FrameLayout frameLayout = (FrameLayout) View.inflate(getContext(), C1920R.layout.design_bottom_sheet_dialog, (ViewGroup) null);
        CoordinatorLayout coordinatorLayout = (CoordinatorLayout) frameLayout.findViewById(C1920R.C1922id.coordinator);
        if (i != 0 && view == null) {
            view = getLayoutInflater().inflate(i, coordinatorLayout, false);
        }
        FrameLayout frameLayout2 = (FrameLayout) coordinatorLayout.findViewById(C1920R.C1922id.design_bottom_sheet);
        ...
        coordinatorLayout.findViewById(C1920R.C1922id.touch_outside).setOnClickListener(new View.OnClickListener() {
