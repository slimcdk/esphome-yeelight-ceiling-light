...
public class NavigationMenuItemView extends ForegroundLinearLayout implements MenuView.ItemView {
    ...
    public NavigationMenuItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        C19621 r4 = new AccessibilityDelegateCompat() {
        ...
        setOrientation(0);
        LayoutInflater.from(context).inflate(C1920R.layout.design_navigation_menu_item, this, true);
        this.iconSize = context.getResources().getDimensionPixelSize(C1920R.dimen.design_navigation_icon_size);
        CheckedTextView checkedTextView = (CheckedTextView) findViewById(C1920R.C1922id.design_menu_item_text);
    ...
    private StateListDrawable createDefaultBackground() {
        ...
        if (!getContext().getTheme().resolveAttribute(C0050R.attr.colorControlHighlight, typedValue, true)) {
            return null;
        }
    ...
    private void setActionView(View view) {
        if (view != null) {
            if (this.actionArea == null) {
                this.actionArea = (FrameLayout) ((ViewStub) findViewById(C1920R.C1922id.design_menu_item_action_area_stub)).inflate();
            }
    ...
    public void setIcon(Drawable drawable) {
        if (drawable != null) {
            ...
            if (this.emptyDrawable == null) {
                Drawable drawable2 = ResourcesCompat.getDrawable(getResources(), C1920R.C1921drawable.navigation_empty_icon, getContext().getTheme());
