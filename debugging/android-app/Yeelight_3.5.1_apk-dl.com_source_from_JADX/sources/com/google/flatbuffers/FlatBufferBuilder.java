...
public class FlatBufferBuilder {
    ...
    static class C2452a extends InputStream {

        /* renamed from: a */
        private ByteBuffer f4158a;

        public C2452a(ByteBuffer byteBuffer) {
            this.f4158a = byteBuffer;
        }

        public final int read() {
            try {
                return this.f4158a.get() & 255;
    ...
    public FlatBufferBuilder(int i, ByteBufferFactory byteBufferFactory, ByteBuffer byteBuffer, Utf8 utf82) {
        ...
        if (byteBuffer != null) {
            ...
            byteBuffer.clear();
            this.f4157bb.order(ByteOrder.LITTLE_ENDIAN);
        } else {
            this.f4157bb = byteBufferFactory.newByteBuffer(i);
        }
        this.utf8 = utf82;
    }
    ...
    public void clear() {
        this.space = this.f4157bb.capacity();
        this.f4157bb.clear();
        this.minalign = 1;
        while (true) {
    ...
    public int createString(CharSequence charSequence) {
        ...
        this.space = i;
        byteBuffer.position(i);
        this.utf8.encodeUtf8(charSequence, this.f4157bb);
        return endVector();
    }
    ...
    public int createString(ByteBuffer byteBuffer) {
        ...
        ByteBuffer byteBuffer2 = this.f4157bb;
        int i = this.space - remaining;
        this.space = i;
        byteBuffer2.position(i);
        this.f4157bb.put(byteBuffer);
        return endVector();
    }
    ...
    public ByteBuffer createUnintializedVector(int i, int i2, int i3) {
        ...
        ByteBuffer order = this.f4157bb.slice().order(ByteOrder.LITTLE_ENDIAN);
        order.limit(i4);
        return order;
    }
    ...
    public int endObject() {
        ...
        while (true) {
            ...
            int capacity = this.f4157bb.capacity() - this.vtables[i4];
            int i5 = this.space;
            short s = this.f4157bb.getShort(capacity);
            if (s == this.f4157bb.getShort(i5)) {
                int i6 = 2;
                while (i6 < s) {
                    if (this.f4157bb.getShort(capacity + i6) == this.f4157bb.getShort(i5 + i6)) {
                        i6 += 2;
                    }
                }
                i = this.vtables[i4];
        ...
        if (i != 0) {
            int capacity2 = this.f4157bb.capacity() - offset;
            this.space = capacity2;
            this.f4157bb.putInt(capacity2, i - offset);
        } else {
    ...
    public void finish(int i, boolean z) {
        ...
        addOffset(i);
        if (z) {
            addInt(this.f4157bb.capacity() - this.space);
        }
        this.f4157bb.position(this.space);
        this.finished = true;
    }
    ...
    public int offset() {
        return this.f4157bb.capacity() - this.space;
    }
    ...
    public void required(int i, int i2) {
        int capacity = this.f4157bb.capacity() - i;
        if (!(this.f4157bb.getShort((capacity - this.f4157bb.getInt(capacity)) + i2) != 0)) {
    ...
    public byte[] sizedByteArray() {
        return sizedByteArray(this.space, this.f4157bb.capacity() - this.space);
    }

    public byte[] sizedByteArray(int i, int i2) {
        finished();
        byte[] bArr = new byte[i2];
        this.f4157bb.position(i);
        this.f4157bb.get(bArr);
        return bArr;
    }

    public InputStream sizedInputStream() {
        finished();
        ByteBuffer duplicate = this.f4157bb.duplicate();
        duplicate.position(this.space);
        duplicate.limit(this.f4157bb.capacity());
        return new C2452a(duplicate);
    }
