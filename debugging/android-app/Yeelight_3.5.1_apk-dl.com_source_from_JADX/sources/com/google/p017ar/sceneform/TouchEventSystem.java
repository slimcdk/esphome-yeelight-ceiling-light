...
public class TouchEventSystem {
    ...
    private TouchTarget addTouchTarget(Node node, int i) {
        ...
        touchTarget.f3256a = node;
        touchTarget.f3257b = i;
        touchTarget.f3258c = this.firstHandlingTouchTarget;
    ...
    private TouchTarget getTouchTargetForNode(Node node) {
        for (TouchTarget touchTarget = this.firstHandlingTouchTarget; touchTarget != null; touchTarget = touchTarget.f3258c) {
            if (touchTarget.f3256a == node) {
                return touchTarget;
            }
        }
        return null;
    ...
    private void removePointersFromTouchTargets(int i) {
        ...
        while (touchTarget != null) {
            TouchTarget touchTarget3 = touchTarget.f3258c;
            int i2 = touchTarget.f3257b;
            if ((i2 & i) != 0) {
                int i3 = i2 & (i ^ -1);
                touchTarget.f3257b = i3;
                if (i3 == 0) {
                    if (touchTarget2 == null) {
                        this.firstHandlingTouchTarget = touchTarget3;
                    } else {
                        touchTarget2.f3258c = touchTarget3;
                    }
    ...
    public void onTouchEvent(com.google.p017ar.sceneform.HitTestResult r13, android.view.MotionEvent r14) {
        /*
            r12 = this;
            java.lang.String r0 = "Parameter \"hitTestResult\" was null."
            com.google.p017ar.sceneform.utilities.Preconditions.checkNotNull(r13, r0)
            java.lang.String r0 = "Parameter \"motionEvent\" was null."
            com.google.p017ar.sceneform.utilities.Preconditions.checkNotNull(r14, r0)
        ...
        L_0x001b:
            ...
            int r4 = r4 + 1
            com.google.ar.sceneform.Scene$OnPeekTouchListener r5 = (com.google.p017ar.sceneform.Scene.OnPeekTouchListener) r5
        ...
        L_0x0075:
            r1 = r5
            com.google.ar.sceneform.TouchEventSystem$TouchTarget r5 = r1.f3258c
        ...
        L_0x0084:
            ...
            com.google.ar.sceneform.TouchEventSystem$TouchTarget r3 = r5.f3258c
            if (r4 == 0) goto L_0x008c
            if (r5 == r1) goto L_0x0097
        L_0x008c:
            com.google.ar.sceneform.Node r9 = r5.f3256a
            int r10 = r5.f3257b
            r11 = 0
            r6 = r12
            r7 = r14
        ...
        L_0x00b3:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.p017ar.sceneform.TouchEventSystem.onTouchEvent(com.google.ar.sceneform.HitTestResult, android.view.MotionEvent):void");
    }
