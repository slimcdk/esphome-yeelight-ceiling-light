...
public class Box extends CollisionShape {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:11:0x0077, code lost:
        if ((r8 + r5.f3277x) >= 0.0f) goto L_0x007b;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:23:0x00c3, code lost:
        if ((r8 + r5.f3278y) >= 0.0f) goto L_0x00c6;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:35:0x0111, code lost:
        if ((r3 + r5.f3279z) >= 0.0f) goto L_0x0114;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public boolean rayIntersection(com.google.p017ar.sceneform.collision.Ray r18, com.google.p017ar.sceneform.collision.RayHit r19) {
        /*
            r17 = this;
            r0 = r17
            r1 = r18
            ...
            com.google.p017ar.sceneform.utilities.Preconditions.checkNotNull(r1, r3)
            java.lang.String r3 = "Parameter \"result\" was null."
            com.google.p017ar.sceneform.utilities.Preconditions.checkNotNull(r2, r3)
            ...
            com.google.ar.sceneform.math.Vector3 r4 = com.google.p017ar.sceneform.math.Vector3.subtract(r7, r4)
            ...
            r13 = r7[r13]
            r8.<init>(r10, r12, r13)
            float r10 = com.google.p017ar.sceneform.math.Vector3.dot(r8, r4)
            float r8 = com.google.p017ar.sceneform.math.Vector3.dot(r3, r8)
            r12 = 0
            boolean r13 = com.google.p017ar.sceneform.math.MathHelper.almostEqualRelativeAndAbs(r8, r12)
        ...
        L_0x007b:
            ...
            float r10 = com.google.p017ar.sceneform.math.Vector3.dot(r8, r4)
            float r8 = com.google.p017ar.sceneform.math.Vector3.dot(r3, r8)
            boolean r11 = com.google.p017ar.sceneform.math.MathHelper.almostEqualRelativeAndAbs(r8, r12)
        ...
        L_0x00c6:
            ...
            r7 = r7[r13]
            r8.<init>(r10, r11, r7)
            float r4 = com.google.p017ar.sceneform.math.Vector3.dot(r8, r4)
            float r3 = com.google.p017ar.sceneform.math.Vector3.dot(r3, r8)
            boolean r7 = com.google.p017ar.sceneform.math.MathHelper.almostEqualRelativeAndAbs(r3, r12)
        ...
        L_0x0124:
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.p017ar.sceneform.collision.Box.rayIntersection(com.google.ar.sceneform.collision.Ray, com.google.ar.sceneform.collision.RayHit):boolean");
    }
    ...
    public boolean sphereIntersection(Sphere sphere) {
        return C2066a.m5180d(sphere, this);
    }
    ...
    public void transform(TransformProvider transformProvider, CollisionShape collisionShape) {
        ...
        if (collisionShape instanceof Box) {
            if (collisionShape != this) {
                ...
                vector32.f3277x = vector33.f3277x * vector3.f3277x;
                vector32.f3278y = vector33.f3278y * vector3.f3278y;
                vector32.f3279z = vector33.f3279z * vector3.f3279z;
