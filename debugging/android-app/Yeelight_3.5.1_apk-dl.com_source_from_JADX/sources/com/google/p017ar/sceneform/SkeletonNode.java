...
import com.google.p017ar.sceneform.rendering.RenderableInstance;
import com.google.p017ar.sceneform.rendering.SkeletonRig;
...
public class SkeletonNode extends Node {
    ...
    class NodeBinding implements Node.TransformChangedListener {
        ...
        public final void m5170a() {
            this.f3250a.removeTransformChangedListener(this);
        }
    ...
    class SkeletonSkinningModifier implements RenderableInstance.SkinningModifier {
        ...
        /* renamed from: a */
        private FloatBuffer f3253a = null;

        /* renamed from: b */
        private final Matrix f3254b = new Matrix();
        ...
        public FloatBuffer modifyMaterialBoneTransformsBuffer(FloatBuffer floatBuffer) {
            ...
            for (int i = 0; i < skeletonRig.getMaterialBoneCount(); i++) {
                ...
                if (nodeBinding != null && nodeBinding.f3250a.isActive() && nodeBinding.f3251b) {
                    if (floatBuffer2 == null) {
                        FloatBuffer floatBuffer3 = this.f3253a;
                        if (floatBuffer3 == null || floatBuffer3.limit() != floatBuffer.limit()) {
                            this.f3253a = ByteBuffer.allocateDirect(floatBuffer.limit() << 2).order(ByteOrder.nativeOrder()).asFloatBuffer();
                        }
                        floatBuffer2 = (FloatBuffer) Preconditions.checkNotNull(this.f3253a);
                        floatBuffer2.put(floatBuffer);
                        floatBuffer.rewind();
                    }
                    Node node = nodeBinding.f3250a;
                    ...
                    if (!(skeletonRig2 == null || (renderableInstance = SkeletonNode.this.getRenderableInstance()) == null)) {
                        skeletonRig2.getInverseBindPoseForBone(materialBoneIndex, this.f3254b);
                        ...
                        Matrix.multiply(matrix, this.f3254b, SkeletonNode.this.boneTransform);
                        int i2 = i << 4;
    ...
    private void updateMappedNodes() {
        ...
        if (modelRenderable != null && getSkeletonRig() != null) {
            for (int i = 0; i < modelRenderable.getBoneCount(); i++) {
                ...
                if (nodeBinding != null && nodeBinding.f3250a.isActive()) {
