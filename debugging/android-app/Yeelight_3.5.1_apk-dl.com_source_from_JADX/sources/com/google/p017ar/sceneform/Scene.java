...
public class Scene extends NodeParent {
    ...
    private void setupLightProbe(SceneView sceneView) {
        ...
        if (rawResourceNameToIdentifier != 0) {
            try {
                LightProbe.builder().setSource(sceneView.getContext(), rawResourceNameToIdentifier).setAssetName(DEFAULT_LIGHTPROBE_ASSET_NAME).build().thenAccept(new C2078n(this)).exceptionally(C2077m.f3272a);
            } catch (Exception e) {
    ...
    public void dispatchUpdate(FrameTime frameTime) {
        ...
        callOnHierarchy(new C2075k(frameTime));
    }
    ...
    public ArrayList<HitTestResult> hitTestAll(Ray ray) {
        ...
        this.collisionSystem.raycastAll(ray, arrayList, C2074j.f3269a, C2073i.f3268a);
        return arrayList;
    }
    ...
    public ArrayList<Node> overlapTestAll(Node node) {
        ...
        this.collisionSystem.intersectsAll(collider, new C2076l(arrayList));
        return arrayList;
    }
