...
public abstract class Renderable {
            ...
            try {
                ...
                if (obj == null || (completableFuture = getRenderableRegistry().get(obj)) == null) {
                    ...
                    if (callable == null) {
                        ...
                        sb.append(valueOf);
                        sb.append("'");
                        C2129e.m5321c(simpleName, completableFuture2, sb.toString());
                    ...
                    if (this.isGltf) {
                        ...
                        completableFuture = new C2156s(makeRenderable, this.sourceUri).mo17746l(callable);
                    }
                    if (obj != null) {
                    ...
                    sb2.append(valueOf2);
                    sb2.append("'");
                    C2129e.m5321c(simpleName2, completableFuture, sb2.toString());
                    g0Var = new C2134g0(this);
                } else {
                    g0Var = new C2136h0(this);
                }
                return completableFuture.thenApply(g0Var);
            } catch (Throwable th) {
                ...
                sb3.append(valueOf3);
                sb3.append("'");
                C2129e.m5321c(simpleName3, completableFuture3, sb3.toString());
    ...
    protected Renderable(Builder<? extends Renderable, ? extends Builder<?, ?>> builder) {
        ...
        this.renderableData = builder.isGltf ? createRenderableInternalGltfData() : new C2140j0();
    ...
    public int getSubmeshCount() {
        return this.renderableData.mo17377u().size();
    }
    ...
    public void setRenderPriority(@IntRange(from = 0, mo660to = 7) int i) {
    ...
    public void updateFromDefinition(RenderableDefinition renderableDefinition) {
        ...
        this.collisionShape = new Box(this.renderableData.mo17376t(), this.renderableData.mo17361e());
    }
}
