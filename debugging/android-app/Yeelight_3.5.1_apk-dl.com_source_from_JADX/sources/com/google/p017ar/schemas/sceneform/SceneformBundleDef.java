...
public final class SceneformBundleDef extends Table {
    ...
    public final AnimationDef animations(AnimationDef animationDef, int i) {
        ...
        if (__offset != 0) {
            return animationDef.__assign(__indirect(__vector(__offset) + (i << 2)), this.f4160bb);
        }
        return null;
    }
    ...
    public final CompiledMaterialDef compiledMaterials(CompiledMaterialDef compiledMaterialDef, int i) {
        ...
        if (__offset != 0) {
            return compiledMaterialDef.__assign(__indirect(__vector(__offset) + (i << 2)), this.f4160bb);
        }
        return null;
    }
    ...
    public final InputDef inputs(InputDef inputDef, int i) {
        ...
        if (__offset != 0) {
            return inputDef.__assign(__indirect(__vector(__offset) + (i << 2)), this.f4160bb);
        }
        return null;
    }
    ...
    public final LightingDef lightingDefs(LightingDef lightingDef, int i) {
        ...
        if (__offset != 0) {
            return lightingDef.__assign(__indirect(__vector(__offset) + (i << 2)), this.f4160bb);
        }
        return null;
    }
    ...
    public final MaterialDef materials(MaterialDef materialDef, int i) {
        ...
        if (__offset != 0) {
            return materialDef.__assign(__indirect(__vector(__offset) + (i << 2)), this.f4160bb);
        }
        return null;
    }
    ...
    public final ModelDef model(ModelDef modelDef) {
        ...
        if (__offset != 0) {
            return modelDef.__assign(__indirect(__offset + this.bb_pos), this.f4160bb);
        }
        return null;
    }
    ...
    public final RuntimeAssetDef runtime(RuntimeAssetDef runtimeAssetDef) {
        ...
        if (__offset != 0) {
            return runtimeAssetDef.__assign(__indirect(__offset + this.bb_pos), this.f4160bb);
        }
        return null;
    }
    ...
    public final SamplerDef samplers(SamplerDef samplerDef, int i) {
        ...
        if (__offset != 0) {
            return samplerDef.__assign(__indirect(__vector(__offset) + (i << 2)), this.f4160bb);
        }
        return null;
    }
    ...
    public final SuggestedCollisionShapeDef suggestedCollisionShape(SuggestedCollisionShapeDef suggestedCollisionShapeDef) {
        ...
        if (__offset != 0) {
            return suggestedCollisionShapeDef.__assign(__indirect(__offset + this.bb_pos), this.f4160bb);
        }
        return null;
    }
    ...
    public final TransformDef transform(TransformDef transformDef) {
        ...
        if (__offset != 0) {
            return transformDef.__assign(__indirect(__offset + this.bb_pos), this.f4160bb);
        }
        return null;
    }
    ...
    public final VersionDef version(VersionDef versionDef) {
        ...
        if (__offset != 0) {
            return versionDef.__assign(__indirect(__offset + this.bb_pos), this.f4160bb);
        }
        return null;
    }
}
