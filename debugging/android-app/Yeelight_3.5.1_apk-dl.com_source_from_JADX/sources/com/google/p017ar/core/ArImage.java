...
public class ArImage extends C0001b {
    ...
    class C2004a extends C0000a {
        ...
        public final ByteBuffer getBuffer() {
            ...
            return arImage.nativeGetBuffer(arImage.session.nativeWrapperHandle, this.f3107a, this.f3108b).asReadOnlyBuffer();
        }

        public final int getPixelStride() {
            ArImage arImage = ArImage.this;
            int access$100 = arImage.nativeGetPixelStride(arImage.session.nativeWrapperHandle, this.f3107a, this.f3108b);
            if (access$100 != -1) {
                return access$100;
            }
        ...
        public final int getRowStride() {
            ArImage arImage = ArImage.this;
            int access$000 = arImage.nativeGetRowStride(arImage.session.nativeWrapperHandle, this.f3107a, this.f3108b);
            if (access$000 != -1) {
                return access$000;
            }
    ...
    public Image.Plane[] getPlanes() {
        ...
        if (nativeGetNumberOfPlanes != -1) {
            C2004a[] aVarArr = new C2004a[nativeGetNumberOfPlanes];
            for (int i = 0; i < nativeGetNumberOfPlanes; i++) {
                aVarArr[i] = new C2004a(this.nativeHandle, i);
            }
            return aVarArr;
        }
