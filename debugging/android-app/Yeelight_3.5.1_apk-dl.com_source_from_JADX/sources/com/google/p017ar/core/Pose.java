...
public class Pose {
    public static final Pose IDENTITY = new Pose(new float[]{0.0f, 0.0f, 0.0f}, Quaternion.f3113a);
    @UsedByNative("session_jni_wrapper.cc")
    ...
    public static Pose makeInterpolated(Pose pose, Pose pose2, float f) {
        ...
        return new Pose(fArr, Quaternion.m5098c(pose.quaternion, pose2.quaternion, f));
    }
    ...
    public Pose compose(Pose pose) {
        float[] fArr = new float[3];
        Quaternion.m5100e(this.quaternion, pose.translation, 0, fArr, 0);
        float f = fArr[0];
        float[] fArr2 = this.translation;
        fArr[0] = f + fArr2[0];
        fArr[1] = fArr[1] + fArr2[1];
        fArr[2] = fArr[2] + fArr2[2];
        return new Pose(fArr, this.quaternion.mo16578b(pose.quaternion));
    }
    ...
    public void getRotationQuaternion(float[] fArr, int i) {
        this.quaternion.mo16579f(fArr, i);
    }
    ...
    public void getTransformedAxis(int i, float f, float[] fArr, int i2) {
        ...
        fArr2[i] = f;
        Quaternion.m5100e(quaternion2, fArr2, 0, fArr, i2);
    }
    ...
    public Pose inverse() {
        float[] fArr = new float[3];
        Quaternion k = this.quaternion.mo16584k();
        Quaternion.m5100e(k, this.translation, 0, fArr, 0);
        fArr[0] = -fArr[0];
        fArr[1] = -fArr[1];
        fArr[2] = -fArr[2];
    ...
    /* renamed from: qw */
    public float mo16564qw() {
        return this.quaternion.mo16583j();
    }

    /* renamed from: qx */
    public float mo16565qx() {
        return this.quaternion.mo16577a();
    }

    /* renamed from: qy */
    public float mo16566qy() {
        return this.quaternion.mo16581h();
    }

    /* renamed from: qz */
    public float mo16567qz() {
        return this.quaternion.mo16582i();
    }

    public void rotateVector(float[] fArr, int i, float[] fArr2, int i2) {
        Quaternion.m5100e(this.quaternion, fArr, i, fArr2, i2);
    }
    ...
    public void toMatrix(float[] fArr, int i) {
        this.quaternion.mo16580g(fArr, i, 4);
        float[] fArr2 = this.translation;
        fArr[i + 12] = fArr2[0];
        fArr[i + 1 + 12] = fArr2[1];
        fArr[i + 2 + 12] = fArr2[2];
    ...
    public String toString() {
        return String.format(Locale.ENGLISH, "t:[x:%.3f, y:%.3f, z:%.3f], q:[x:%.2f, y:%.2f, z:%.2f, w:%.2f]", new Object[]{Float.valueOf(this.translation[0]), Float.valueOf(this.translation[1]), Float.valueOf(this.translation[2]), Float.valueOf(this.quaternion.mo16577a()), Float.valueOf(this.quaternion.mo16581h()), Float.valueOf(this.quaternion.mo16582i()), Float.valueOf(this.quaternion.mo16583j())});
    }
    ...
    /* renamed from: tx */
    public float mo16574tx() {
        return this.translation[0];
    }

    /* renamed from: ty */
    public float mo16575ty() {
        return this.translation[1];
    }

    /* renamed from: tz */
    public float mo16576tz() {
