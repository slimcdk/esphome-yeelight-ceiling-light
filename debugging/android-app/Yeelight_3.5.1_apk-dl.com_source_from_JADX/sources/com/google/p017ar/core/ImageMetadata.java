...
public class ImageMetadata {
    ...
    private final C2005a sketchEntry;

    /* renamed from: com.google.ar.core.ImageMetadata$a */
    static class C2005a {
    ...
    ImageMetadata(long j, Session session2) {
        ...
        this.nativeHandle = j;
        this.sketchEntry = new C2005a();
    }

    private void getMetdataEntry(int i, C2005a aVar) {
        long nativeGetMetadataEntry = nativeGetMetadataEntry(this.session.nativeWrapperHandle, this.nativeHandle, i);
        aVar.f3110a = nativeGetMetadataEntry;
        if (nativeGetMetadataEntry != 0) {
            aVar.f3111b = nativeGetMetadataEntryValueType(this.session.nativeWrapperHandle, nativeGetMetadataEntry);
            aVar.f3112c = nativeGetMetadataEntryValueCount(this.session.nativeWrapperHandle, aVar.f3110a);
            return;
        }
        throw new IllegalArgumentException(String.format("Invalid ImageMetadata key: %1$d", new Object[]{Integer.valueOf(i)}));
    }
    ...
    public byte getByte(int i) {
        ...
        C2005a aVar = this.sketchEntry;
        if (aVar.f3111b == 0 && aVar.f3112c == 1) {
            byte nativeGetByteFromMetadataEntry = nativeGetByteFromMetadataEntry(this.session.nativeWrapperHandle, aVar.f3110a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f3110a);
            return nativeGetByteFromMetadataEntry;
        }
        throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d.", new Object[]{Integer.valueOf(i)}));
    }
    ...
    public byte[] getByteArray(int i) {
        ...
        C2005a aVar = this.sketchEntry;
        if (aVar.f3111b == 0) {
            byte[] nativeGetByteArrayFromMetadataEntry = nativeGetByteArrayFromMetadataEntry(this.session.nativeWrapperHandle, aVar.f3110a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f3110a);
    ...
    public double getDouble(int i) {
        getMetdataEntry(i, this.sketchEntry);
        C2005a aVar = this.sketchEntry;
        if (aVar.f3111b == 4 && aVar.f3112c == 1) {
            double nativeGetDoubleFromMetadataEntry = nativeGetDoubleFromMetadataEntry(this.session.nativeWrapperHandle, aVar.f3110a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f3110a);
    ...
    public double[] getDoubleArray(int i) {
        ...
        C2005a aVar = this.sketchEntry;
        if (aVar.f3111b == 4) {
            double[] nativeGetDoubleArrayFromMetadataEntry = nativeGetDoubleArrayFromMetadataEntry(this.session.nativeWrapperHandle, aVar.f3110a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f3110a);
    ...
    public float getFloat(int i) {
        getMetdataEntry(i, this.sketchEntry);
        C2005a aVar = this.sketchEntry;
        if (aVar.f3111b == 2 && aVar.f3112c == 1) {
            float nativeGetFloatFromMetadataEntry = nativeGetFloatFromMetadataEntry(this.session.nativeWrapperHandle, aVar.f3110a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f3110a);
    ...
    public float[] getFloatArray(int i) {
        ...
        C2005a aVar = this.sketchEntry;
        if (aVar.f3111b == 2) {
            float[] nativeGetFloatArrayFromMetadataEntry = nativeGetFloatArrayFromMetadataEntry(this.session.nativeWrapperHandle, aVar.f3110a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f3110a);
    ...
    public int getInt(int i) {
        getMetdataEntry(i, this.sketchEntry);
        C2005a aVar = this.sketchEntry;
        if (aVar.f3111b == 1 && aVar.f3112c == 1) {
            int nativeGetIntFromMetadataEntry = nativeGetIntFromMetadataEntry(this.session.nativeWrapperHandle, aVar.f3110a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f3110a);
    ...
    public int[] getIntArray(int i) {
        ...
        C2005a aVar = this.sketchEntry;
        if (aVar.f3111b == 1) {
            int[] nativeGetIntArrayFromMetadataEntry = nativeGetIntArrayFromMetadataEntry(this.session.nativeWrapperHandle, aVar.f3110a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f3110a);
    ...
    public long getLong(int i) {
        getMetdataEntry(i, this.sketchEntry);
        C2005a aVar = this.sketchEntry;
        if (aVar.f3111b == 3 && aVar.f3112c == 1) {
            long nativeGetLongFromMetadataEntry = nativeGetLongFromMetadataEntry(this.session.nativeWrapperHandle, aVar.f3110a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f3110a);
            return nativeGetLongFromMetadataEntry;
        }
        throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d, type: %2$d, count: %3$d.", new Object[]{Integer.valueOf(i), Integer.valueOf(this.sketchEntry.f3111b), Integer.valueOf(this.sketchEntry.f3112c)}));
    }
    ...
    public long[] getLongArray(int i) {
        ...
        C2005a aVar = this.sketchEntry;
        if (aVar.f3111b == 3) {
            long[] nativeGetLongArrayFromMetadataEntry = nativeGetLongArrayFromMetadataEntry(this.session.nativeWrapperHandle, aVar.f3110a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f3110a);
    ...
    public Rational getRational(int i) {
        getMetdataEntry(i, this.sketchEntry);
        C2005a aVar = this.sketchEntry;
        if (aVar.f3111b == 5 && aVar.f3112c == 1) {
            Rational nativeGetRationalFromMetadataEntry = nativeGetRationalFromMetadataEntry(this.session.nativeWrapperHandle, aVar.f3110a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f3110a);
    ...
    public Rational[] getRationalArray(int i) {
        ...
        C2005a aVar = this.sketchEntry;
        if (aVar.f3111b == 5) {
            Rational[] nativeGetRationalArrayFromMetadataEntry = nativeGetRationalArrayFromMetadataEntry(this.session.nativeWrapperHandle, aVar.f3110a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f3110a);
