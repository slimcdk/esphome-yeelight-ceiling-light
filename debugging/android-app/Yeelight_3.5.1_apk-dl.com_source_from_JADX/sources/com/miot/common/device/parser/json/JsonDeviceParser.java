...
public class JsonDeviceParser implements DeviceParser {
    ...
    public static void parseProperty(Service service, JSONObject jSONObject) {
        ...
        if (parseType != null) {
            ...
            JSONArray optJSONArray = jSONObject.optJSONArray(com.p022mi.iot.common.parser.DeviceParser.ACCESS);
            int i = 0;
            if (optJSONArray != null) {
    ...
    static Service parseService(JSONObject jSONObject) {
        ...
        if (parseType != null) {
            ...
            JSONArray optJSONArray = jSONObject.optJSONArray(com.p022mi.iot.common.parser.DeviceParser.PROPERTIES);
            for (int i = 0; i < optJSONArray.length(); i++) {
    ...
    public Device parse(InputStream inputStream) {
        ...
        try {
            ...
            if (parseType != null) {
                ...
                JSONArray optJSONArray = jSONObject.optJSONArray(com.p022mi.iot.common.parser.DeviceParser.SERVICES);
                for (int i = 0; i < optJSONArray.length(); i++) {
