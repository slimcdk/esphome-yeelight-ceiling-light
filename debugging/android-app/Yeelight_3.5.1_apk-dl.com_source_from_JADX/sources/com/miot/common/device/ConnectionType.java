...
public enum ConnectionType {
    ...
    static /* synthetic */ class C28331 {
        ...
        static {
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.miot.common.device.ConnectionType.C28331.<clinit>():void");
        }
    }
    ...
    public String toString() {
        int i = C28331.$SwitchMap$com$miot$common$device$ConnectionType[ordinal()];
        if (i == 1) {
            return STR_BLE;
        }
        if (i == 2) {
