...
public class DeviceFactory {
    ...
    private static Device create(Context context, String str) {
        if (str == null) {
            Logger.m7500e(TAG, "createDevice failed, model is null");
            return null;
        }
        ...
        Logger.m7500e(TAG, "create spec device, model: " + str);
        return new Device();
    }
    ...
    public static Device createFrom(Context context, MiotWifiDevice miotWifiDevice) {
        ...
        if (create == null) {
            ...
            sb.append("create device is null, model = ");
            sb.append(miotWifiDevice.getDeviceModel());
            return create;
        }
        ConnectionInfo connectionInfo = new ConnectionInfo();
        ...
        connectionInfo.setScanResult(miotWifiDevice.getScanResult());
        create.setConnectionInfo(connectionInfo);
