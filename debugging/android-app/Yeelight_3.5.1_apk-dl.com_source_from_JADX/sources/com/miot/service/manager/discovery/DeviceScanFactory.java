    ...
    static /* synthetic */ class C41421 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.miot.service.manager.discovery.DeviceScanFactory.C41421.<clinit>():void");
        }
    }

    public static DeviceScan create(Context context, DiscoveryType discoveryType) {
        DeviceScan deviceScan;
        int i = C41421.$SwitchMap$com$miot$common$device$DiscoveryType[discoveryType.ordinal()];
        if (i == 1) {
