...
public class TimerCodec {
    ...
    public static Timer decodeTimer(JSONObject jSONObject) {
        ...
        Logger.m7499d(TAG, "timer: " + jSONObject.toString());
        ...
        if (setting == null) {
            Logger.m7500e(TAG, "parse timer failed, setting is null");
            return null;
        }
    ...
    private static List<Object> jsonArrayToList(JSONArray jSONArray) {
        ...
        for (int i = 0; i < jSONArray.length(); i++) {
            JSONObject optJSONObject = jSONArray.optJSONObject(i);
            if (optJSONObject != null) {
                arrayList.add(new C2469e().mo19225h(optJSONObject.toString(), C2530m.class));
            }
        }
        return arrayList;
    }
