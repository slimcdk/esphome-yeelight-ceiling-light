...
public class AndroidBonjourImpl implements Bonjour {
    ...
    static /* synthetic */ class C41441 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f6864xbdd4ad80     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f6864xbdd4ad80     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f6864xbdd4ad80     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f6864xbdd4ad80     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f6864xbdd4ad80     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.miot.service.manager.discovery.impl.bonjour.impl.AndroidBonjourImpl.C41441.<clinit>():void");
        }
    }
    ...
    private class DiscoverHandler implements NsdManager.DiscoveryListener {
        ...
        /* synthetic */ DiscoverHandler(AndroidBonjourImpl androidBonjourImpl, C41441 r2) {
            this();
        }
    ...
    private class JobHandler implements Runnable {
        ...
        private void doServiceFound(final Job job) {
            AndroidBonjourImpl.this.nsdManager.resolveService(job.getServiceInfo(), new NsdManager.ResolveListener() {
                ...
                public void onServiceResolved(NsdServiceInfo nsdServiceInfo) {
                    ...
                    sb.append(nsdServiceInfo.toString());
        ...
        private void doServiceReg(NsdServiceInfo nsdServiceInfo) {
            ...
            if (!this.registrationHandlers.containsKey(format)) {
                RegistrationHandler registrationHandler = new RegistrationHandler(AndroidBonjourImpl.this, (C41441) null);
        ...
        private void doStartDiscovery(String str) {
            ...
            DiscoverHandler discoverHandler = new DiscoverHandler(AndroidBonjourImpl.this, (C41441) null);
            ...
            while (true) {
                try {
                    ...
                    if (take.getType() != JobType.STOP) {
                        switch (C41441.f6864xbdd4ad80[take.getType().ordinal()]) {
                            case 1:
    ...
    private class RegistrationHandler implements NsdManager.RegistrationListener {
        ...
        /* synthetic */ RegistrationHandler(AndroidBonjourImpl androidBonjourImpl, C41441 r2) {
            this();
        }
