...
public class OwnershipTask extends MiotTask<Void> {
    ...
    static /* synthetic */ class C41482 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.miot.service.manager.ownership.OwnershipTask.C41482.<clinit>():void");
        }
    }
    ...
    public HttpResponse executeRequest() {
        int i = C41482.$SwitchMap$com$miot$service$manager$ownership$OwnershipTask$Type[this.mType.ordinal()];
        if (i == 1) {
            return doTake();
        }
        if (i != 2) {
