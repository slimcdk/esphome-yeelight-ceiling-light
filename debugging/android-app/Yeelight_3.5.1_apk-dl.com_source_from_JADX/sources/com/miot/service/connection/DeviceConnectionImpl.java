...
public class DeviceConnectionImpl extends IDeviceConnection.Stub {
    ...
    public void connectToCloud(People people, Device device, IConfigHandler iConfigHandler) {
        ...
        if (scanResult == null) {
            scanResult = device.getConnectionInfo().getScanResult();
        }
        if (scanResult == null) {
            iConfigHandler.onFailed(1008, "cann't find the wifi device");
            return;
        }
        ...
        intent.putExtra(SmartConfigDataProvider.KEY_HANDLER, new BinderParcel(iConfigHandler.asBinder()));
    ...
    public void getQrCode(String str, String str2, String str3, People people, ICommonHandler iCommonHandler) {
        ...
        C29131 r0 = new ICompletionHandler.Stub() {
