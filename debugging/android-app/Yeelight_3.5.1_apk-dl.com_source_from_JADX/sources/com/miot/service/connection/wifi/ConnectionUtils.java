...
public class ConnectionUtils {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:62:0x010c A[ADDED_TO_REGION] */
    ...
    public static void connectToAP(android.content.Context r13, android.net.ConnectivityManager r14, android.net.wifi.WifiManager r15, java.lang.String r16, java.lang.String r17, java.lang.String r18, java.lang.String r19, com.miot.service.connection.wifi.QConnectCallback r20, boolean r21, boolean r22) {
        /*
            ...
            r2.log(r4, r3)
            r9 = 0
            boolean r2 = isUseQWifiConnectInterface(r13)     // Catch:{ SecurityException -> 0x0106 }
            if (r2 == 0) goto L_0x004e
            boolean r2 = android.provider.Settings.canDrawOverlays(r13)     // Catch:{ SecurityException -> 0x0106 }
            if (r2 != 0) goto L_0x004e
            r0 = r14
            r1 = r15
            r2 = r16
            ...
            r5 = r21
            r6 = r22
            connectToAPAfterQ(r0, r1, r2, r3, r4, r5, r6)     // Catch:{ SecurityException -> 0x0106 }
            return
        L_0x004e:
            boolean r2 = r15.isWifiEnabled()     // Catch:{ SecurityException -> 0x0106 }
            if (r2 != 0) goto L_0x0055
            return
        L_0x0055:
            java.util.List r2 = r15.getConfiguredNetworks()     // Catch:{ SecurityException -> 0x0106 }
            r3 = 0
            boolean r5 = com.inuker.bluetooth.library.utils.ListUtils.isEmpty(r2)     // Catch:{ SecurityException -> 0x0106 }
            if (r5 != 0) goto L_0x0089
            java.util.Iterator r2 = r2.iterator()     // Catch:{ SecurityException -> 0x0106 }
        L_0x0064:
            boolean r5 = r2.hasNext()     // Catch:{ SecurityException -> 0x0106 }
            if (r5 == 0) goto L_0x0089
            java.lang.Object r5 = r2.next()     // Catch:{ SecurityException -> 0x0106 }
            android.net.wifi.WifiConfiguration r5 = (android.net.wifi.WifiConfiguration) r5     // Catch:{ SecurityException -> 0x0106 }
            java.lang.String r6 = r5.SSID     // Catch:{ SecurityException -> 0x0106 }
            if (r6 == 0) goto L_0x0064
            java.lang.String r10 = convertToQuotedString(r16)     // Catch:{ SecurityException -> 0x0106 }
            boolean r6 = r6.equals(r10)     // Catch:{ SecurityException -> 0x0106 }
            if (r6 == 0) goto L_0x0064
            int r6 = getAuthType(r5)     // Catch:{ SecurityException -> 0x0106 }
            int r10 = getSecurity((java.lang.String) r19)     // Catch:{ SecurityException -> 0x0106 }
            if (r6 != r10) goto L_0x0064
            r3 = r5
        L_0x0089:
            java.util.List r2 = r15.getScanResults()     // Catch:{ SecurityException -> 0x0106 }
            java.util.Iterator r2 = r2.iterator()     // Catch:{ SecurityException -> 0x0106 }
        L_0x0091:
            boolean r5 = r2.hasNext()     // Catch:{ SecurityException -> 0x0106 }
            r6 = 1
            ...
            java.lang.Object r5 = r2.next()     // Catch:{ SecurityException -> 0x0106 }
            android.net.wifi.ScanResult r5 = (android.net.wifi.ScanResult) r5     // Catch:{ SecurityException -> 0x0106 }
            java.lang.String r5 = r5.SSID     // Catch:{ SecurityException -> 0x0106 }
            boolean r5 = r5.equalsIgnoreCase(r8)     // Catch:{ SecurityException -> 0x0106 }
        ...
        L_0x00a8:
            r2 = 0
        L_0x00a9:
            com.miot.service.log.MyLogger r5 = com.miot.service.log.MyLogger.getInstance()     // Catch:{ SecurityException -> 0x0106 }
            java.lang.StringBuilder r10 = new java.lang.StringBuilder     // Catch:{ SecurityException -> 0x0106 }
            r10.<init>()     // Catch:{ SecurityException -> 0x0106 }
            java.lang.String r11 = "isContain "
            r10.append(r11)     // Catch:{ SecurityException -> 0x0106 }
            r10.append(r8)     // Catch:{ SecurityException -> 0x0106 }
            java.lang.String r11 = " - "
            r10.append(r11)     // Catch:{ SecurityException -> 0x0106 }
            r10.append(r2)     // Catch:{ SecurityException -> 0x0106 }
            java.lang.String r2 = r10.toString()     // Catch:{ SecurityException -> 0x0106 }
            r5.log(r4, r2)     // Catch:{ SecurityException -> 0x0106 }
            if (r3 == 0) goto L_0x00e3
            boolean r0 = r15.disconnect()     // Catch:{ SecurityException -> 0x0106 }
            int r1 = r3.networkId     // Catch:{ SecurityException -> 0x00e0 }
            boolean r1 = r15.enableNetwork(r1, r6)     // Catch:{ SecurityException -> 0x00e0 }
            boolean r2 = r15.reconnect()     // Catch:{ SecurityException -> 0x00dd }
            r3 = r17
            r9 = r2
            goto L_0x010a
        L_0x00dd:
        ...
        L_0x00e0:
            ...
            goto L_0x0109
        L_0x00e3:
            android.net.wifi.WifiConfiguration r2 = new android.net.wifi.WifiConfiguration     // Catch:{ SecurityException -> 0x0106 }
            r2.<init>()     // Catch:{ SecurityException -> 0x0106 }
            r3 = r17
            setWifiConfig(r2, r8, r3, r1)     // Catch:{ SecurityException -> 0x0108 }
            r2.BSSID = r0     // Catch:{ SecurityException -> 0x0108 }
            int r0 = r15.addNetwork(r2)     // Catch:{ SecurityException -> 0x0108 }
            boolean r1 = r15.disconnect()     // Catch:{ SecurityException -> 0x0108 }
            boolean r0 = r15.enableNetwork(r0, r6)     // Catch:{ SecurityException -> 0x0104 }
            boolean r2 = r15.reconnect()     // Catch:{ SecurityException -> 0x0100 }
            r9 = r2
        L_0x0100:
            r12 = r1
            r1 = r0
    ...
    public static String getSecurityString(Context context, ScanResult scanResult) {
        ...
        if (security == 0) {
            ...
            sb.append("");
            format = context.getString(C2875R.string.kuailian_no_passwd);
        } else if (security == 2) {
            PskType pskType = getPskType(scanResult);
            if (pskType == PskType.WPA) {
                sb2 = new StringBuilder();
                sb2.append("");
                format2 = String.format(context.getString(C2875R.string.kuailian_wifi_security_type), new Object[]{"WPA"});
            } else if (pskType == PskType.WPA2) {
                sb2 = new StringBuilder();
                sb2.append("");
                format2 = String.format(context.getString(C2875R.string.kuailian_wifi_security_type), new Object[]{"WPA2"});
            } else if (pskType != PskType.WPA_WPA2) {
                return "";
            } else {
                sb2 = new StringBuilder();
                sb2.append("");
                format2 = String.format(context.getString(C2875R.string.kuailian_wifi_security_type), new Object[]{"WPA_WPA2"});
            }
            sb2.append(format2);
            return sb2.toString();
        } else if (security == 1) {
            sb = new StringBuilder();
            sb.append("");
            format = String.format(context.getString(C2875R.string.kuailian_wifi_security_type), new Object[]{"WEP"});
        } else if (security == 3) {
            sb = new StringBuilder();
            sb.append("");
            format = String.format(context.getString(C2875R.string.kuailian_wifi_security_type), new Object[]{"802.1X"});
        } else if (security != 4) {
            return "";
        } else {
            sb = new StringBuilder();
            sb.append("");
            format = String.format(context.getString(C2875R.string.kuailian_wifi_security_type), new Object[]{"WAPI"});
        }
        sb.append(format);
        return sb.toString();
    }
    ...
    public static int getSignalLevel(int i) {
        return i > 80 ? C2875R.C2876drawable.wifi_strength_4 : i > 60 ? C2875R.C2876drawable.wifi_strength_3 : i > 40 ? C2875R.C2876drawable.wifi_strength_2 : i > 20 ? C2875R.C2876drawable.wifi_strength_1 : C2875R.C2876drawable.wifi_strength_0;
    }
