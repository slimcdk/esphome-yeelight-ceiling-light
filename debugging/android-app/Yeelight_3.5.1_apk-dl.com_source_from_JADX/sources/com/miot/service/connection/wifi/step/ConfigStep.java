...
public abstract class ConfigStep extends SmartConfigStep {
    ...
    public void initView(View view) {
        this.mProgressContainer = view.findViewById(C2875R.C2877id.base_ui_progress);
        this.mProgressBar = (PieProgressBar) view.findViewById(C2875R.C2877id.base_ui_progress_bar);
        this.mBarText = (TextView) view.findViewById(C2875R.C2877id.base_ui_progress_bar_text);
        this.mMainTitle = (TextView) view.findViewById(C2875R.C2877id.base_ui_progress_bar_title);
        this.mMainSubTitle = (TextView) view.findViewById(C2875R.C2877id.smart_config_common_main_sub_title);
    ...
    public void onCreateStep(Context context) {
        setContentView(context, C2875R.layout.smart_config_start_config_ui);
    ...
    public void setMainTitle(TextView textView) {
        textView.setText(C2875R.string.smart_config_device_connecting);
    }

    public void setSubMainTitle(TextView textView) {
        textView.setText(C2875R.string.smart_config_connecting_sub_title);
    }
