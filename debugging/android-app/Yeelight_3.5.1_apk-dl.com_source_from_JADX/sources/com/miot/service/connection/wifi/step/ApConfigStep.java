...
public class ApConfigStep extends ConfigStep {
    ...
    /* access modifiers changed from: private */
    public boolean mHasSendWificonfig;
    private int mId;
    /* access modifiers changed from: private */
    ...
    static /* synthetic */ class C403410 {
    ...
    public ArrayList<ConfigStep.ConfigTime> getAllConfigStages() {
        ...
        SmartConfigDataProvider instance = SmartConfigDataProvider.getInstance();
        Boolean bool = Boolean.FALSE;
        boolean booleanValue = ((Boolean) instance.get(SmartConfigDataProvider.KEY_GOTO_TO_ERROR_PAGE, bool)).booleanValue();
        this.mGotoErrorPage = booleanValue;
        if (booleanValue) {
            SmartConfigDataProvider.getInstance().set(SmartConfigDataProvider.KEY_GOTO_TO_ERROR_PAGE, bool);
        ...
        if (i == 101) {
            ...
            if (connectionInfo == null || TextUtils.isEmpty(connectionInfo.getSSID()) || connectionInfo.getSSID().contains("<unknown ssid>")) {
                ...
                if (ConnectionUtils.isEqualWifi(connectionInfo.getSSID(), scanResult.SSID) && this.mCurrentIndex == 0 && !this.mIsPaused) {
                    onApConnected();
                } else if (!ConnectionUtils.isEqualWifi(connectionInfo.getSSID(), scanResult.SSID) && this.mCurrentIndex == 1 && this.mHasSendWificonfig && getHandler() != null) {
    ...
    public JSONObject parseRpcResponse(String str) {
        ...
        try {
            ...
            if (C403410.$SwitchMap$com$miot$service$connection$wifi$ErrorCode[ErrorCode.valueof(jSONObject.optInt("code")).ordinal()] != 1) {
                return null;
            }
                            ...
                            public void run() {
                                ...
                                if (parseRpcResponse != null) {
                                    ...
                                    if (!TextUtils.isEmpty(gatewayAddr)) {
                                        ...
                                        boolean unused3 = ApConfigStep.this.mHasSendWificonfig = true;
                                        MiioLocalAPI.async_rpc(gatewayAddr, jSONObject.toString(), ApConfigStep.this.mDid, ApConfigStep.this.mToken, new MiioLocalRpcResponse() {
                                            public void onResponse(String str) {
                                                ...
                                                } else if (ApConfigStep.this.getHandler() != null && ApConfigStep.this.mCurrentIndex == 1) {
                                                    handler = ApConfigStep.this.getHandler();
                                                    i = 114;
                                                } else {
                                                    return;
    ...
    public void startConnectToDeviceAp() {
        ...
        if (TextUtils.isEmpty(connectionInfo.getSSID()) || !ConnectionUtils.isEqualWifi(connectionInfo.getSSID(), this.mScanResult.SSID) || connectionInfo.getSupplicantState() != SupplicantState.COMPLETED) {
            ...
            if (qConnectCallback == null || qConnectCallback.callback == null) {
                C40405 r8 = new QConnectCallback() {
        ...
        this.mNextButton.setText(C2875R.string.cancel);
