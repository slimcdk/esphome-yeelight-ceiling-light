...
public class FindDeviceFailedStep extends SmartConfigStep {
    ...
    public void onCreateStep(Context context) {
        ...
        this.mIcon.setImageResource(C2875R.C2876drawable.config_failed_timeout);
        this.mMainTitle.setText(C2875R.string.smart_config_connect_timeout_first);
        this.mSubMainTitle.setText(C2875R.string.smart_config_find_new_device_error);
