...
public class BleFastConnector implements IBleFastConnector {
    ...
    private final BleSecurityStatusResponse mBleConnectResponse = new BleSecurityStatusResponse() {
        ...
        public void onResponse(int i, Bundle bundle) {
            BluetoothLog.m7332v(String.format("BleFastConnector onResponse, code = %d", new Object[]{Integer.valueOf(i)}));
            if (i == 0) {
    ...
    public void sendAPPWD() {
        BluetoothLog.m7332v(String.format("sendAPPWD %s", new Object[]{new String(this.mPwdBytes)}));
    ...
    public void sendAPSSID() {
        BluetoothLog.m7332v(String.format("sendAPSSID %s", new Object[]{new String(this.mSSIDBytes)}));
    ...
    public void sendTimeZone() {
        ...
        BluetoothLog.m7332v(String.format("sendTimeZone %dms", new Object[]{Integer.valueOf(convert)}));
    ...
    public void sendUserId() {
        ...
        BluetoothLog.m7328d(getClass().getSimpleName() + "sendUserId" + userId);
        try {
        ...
        if (j > 0) {
            BluetoothLog.m7332v(String.format("sendUserId %s", new Object[]{userId}));
    ...
    public void sendZoneCode() {
        ...
        if (locale == null || locale == AppConfiguration.Locale.cn) {
            BluetoothLog.m7332v(String.format("local server", new Object[0]));
            str = "";
        } else {
            str = locale.toString();
            BluetoothLog.m7332v(String.format("international server: %s", new Object[]{str}));
        }
        if (!TextUtils.isEmpty(str)) {
            ByteUtils.copy(bArr, str.getBytes(), 0, 0);
        }
        BluetoothLog.m7332v(String.format("sendZoneCode %s", new Object[]{str}));
    ...
    public void sendRestoreCommand(BLEBytesWriter.BLEBytesWriteResponse bLEBytesWriteResponse) {
        ...
        BluetoothLog.m7332v(String.format("sendRestoreCommand %s", new Object[]{ByteUtils.byteToString(bArr)}));
    ...
    public void sendRetryCommand(BLEBytesWriter.BLEBytesWriteResponse bLEBytesWriteResponse) {
        ...
        BluetoothLog.m7332v(String.format("sendRetryCommand %s", new Object[]{ByteUtils.byteToString(bArr)}));
