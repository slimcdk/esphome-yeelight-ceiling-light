...
public class NotificationManager {
    ...
    public IBinder.DeathRecipient mDeathRecipient = new IBinder.DeathRecipient() {
        public void binderDied() {
            Logger.m7500e(NotificationManager.TAG, "client dead");
    ...
    private MiotpnMessageProcessor mNotificationProcessor = new MiotpnMessageProcessor() {
        public boolean onProcess(JSONObject jSONObject) {
            String format;
            String str;
            Logger.m7499d(NotificationManager.TAG, "onProcess: " + jSONObject.toString());
            ...
            if (optString == null) {
                ...
                if (optJSONArray == null) {
                    ...
                    for (int i = 0; i < optJSONArray.length(); i++) {
                        ...
                        Logger.m7500e(NotificationManager.TAG, format);
                    }
                    return z;
                }
            }
            Logger.m7500e(NotificationManager.TAG, str);
            return false;
        }
    };
    /* access modifiers changed from: private */
