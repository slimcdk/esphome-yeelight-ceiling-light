...
public class QrCodeParser {
    ...
    /* renamed from: qr */
    private final String f6868qr;

    /* renamed from: sn */
    private ValueSetter f6869sn;
    ...
    public QrCodeParser(String str, String str2) {
        ...
        this.f6869sn = new ValueSetter("$S:");
    ...
    private void parse(String str) {
        ...
        if (str != null && str.startsWith("G") && str.length() > 2) {
            ...
            if (split.length == 2) {
                setValue(split[0], this.pid, this.did, this.f6869sn);
                ...
                if (split2.length == 2) {
                    setValue(split2[0], this.pid, this.did, this.f6869sn);
                    ...
                    if (split3.length == 2) {
                        setValue(split3[0], this.pid, this.did, this.f6869sn);
