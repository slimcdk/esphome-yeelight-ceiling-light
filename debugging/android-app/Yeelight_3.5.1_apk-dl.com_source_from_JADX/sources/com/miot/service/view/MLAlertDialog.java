...
public class MLAlertDialog extends Dialog {
    ...
    public static class Builder {
        ...
        /* renamed from: P */
        private final MLAlertController.AlertParams f6871P;
        private Context mContext;

        public Builder(Context context) {
            this.mContext = context;
            this.f6871P = new MLAlertController.AlertParams(context);
        }

        public MLAlertDialog create() {
            MLAlertDialog mLAlertDialog = new MLAlertDialog(this.f6871P.mContext);
            MLAlertController.AlertParams alertParams = this.f6871P;
            mLAlertDialog.mItemTexts = alertParams.mItems;
            alertParams.apply(mLAlertDialog.mAlert);
            mLAlertDialog.setCancelable(this.f6871P.mCancelable);
            if (this.f6871P.mCancelable) {
                mLAlertDialog.setCanceledOnTouchOutside(true);
            }
            mLAlertDialog.setOnCancelListener(this.f6871P.mOnCancelListener);
            DialogInterface.OnKeyListener onKeyListener = this.f6871P.mOnKeyListener;
            if (onKeyListener != null) {
                mLAlertDialog.setOnKeyListener(onKeyListener);
            }
            mLAlertDialog.setDismissCallBack(this.f6871P.mDismissCallBack);
            return mLAlertDialog;
        }

        public MLAlertDialog createCenter() {
            MLAlertDialog mLAlertDialog = new MLAlertDialog(this.f6871P.mContext, true, (DialogInterface.OnCancelListener) null, 17, 0);
            MLAlertController.AlertParams alertParams = this.f6871P;
            mLAlertDialog.mItemTexts = alertParams.mItems;
            alertParams.apply(mLAlertDialog.mAlert);
            mLAlertDialog.setCancelable(this.f6871P.mCancelable);
        ...
        public EditText getInputView() {
            return (EditText) this.f6871P.mView;
        }
        ...
        public Builder setAudoDismiss(boolean z) {
            this.f6871P.mAutoDismiss = z;
            return this;
        }

        public Builder setBtnTextColor(int i, int i2) {
            if (i2 == -3) {
                this.f6871P.mButtonNeutralTextColor = i;
            } else if (i2 == -2) {
                this.f6871P.mButtonNegativeTextColor = i;
            } else if (i2 == -1) {
                this.f6871P.mButtonPositiveTextColor = i;
            } else {
        ...
        public Builder setCustomTitle(View view) {
            this.f6871P.mCustomTitleView = view;
            return this;
        }

        public void setCustomTitle(CharSequence charSequence) {
            this.f6871P.mCustomTitle = charSequence;
        }

        public Builder setDismissCallBack(DismissCallBack dismissCallBack) {
            this.f6871P.mDismissCallBack = dismissCallBack;
            return this;
        }

        public Builder setIcon(int i) {
            this.f6871P.mIconId = i;
            return this;
        }

        public Builder setIcon(Drawable drawable) {
            this.f6871P.mIcon = drawable;
            return this;
        }
        ...
        public Builder setInputView(String str, boolean z) {
            ...
            if (context != null) {
                View inflate = View.inflate(context, C2875R.layout.ml_alert_dialog_input_view, (ViewGroup) null);
                Resources resources = context.getResources();
                int i = C2875R.dimen.alertdialog_button_panel_padding_horizontal;
                setView(inflate, resources.getDimensionPixelSize(i), 0, context.getResources().getDimensionPixelSize(i), context.getResources().getDimensionPixelSize(C2875R.dimen.alertdialog_custom_panel_padding_bottom));
                EditText editText = (EditText) inflate.findViewById(C2875R.C2877id.input_text);
        ...
        public Builder setInverseBackgroundForced(boolean z) {
            this.f6871P.mForceInverseBackground = z;
            return this;
        }
        ...
        public Builder setItems(int i, DialogInterface.OnClickListener onClickListener) {
            ...
            this.f6871P.mOnClickListener = onClickListener;
            return this;
        }
        ...
        public Builder setMessage(SpannableStringBuilder spannableStringBuilder) {
            this.f6871P.mMesageBuilder = spannableStringBuilder;
            return this;
        }

        public Builder setMessage(CharSequence charSequence) {
            this.f6871P.mMessage = charSequence;
            return this;
        }
        ...
        public Builder setMultiChoiceItems(int i, boolean[] zArr, DialogInterface.OnMultiChoiceClickListener onMultiChoiceClickListener) {
            MLAlertController.AlertParams alertParams = this.f6871P;
            alertParams.mItems = alertParams.mContext.getResources().getTextArray(i);
            MLAlertController.AlertParams alertParams2 = this.f6871P;
        ...
        public Builder setNegativeButton(int i, DialogInterface.OnClickListener onClickListener) {
            ...
            this.f6871P.mNegativeButtonListener = onClickListener;
            return this;
        }
        ...
        public Builder setNeutralButton(int i, DialogInterface.OnClickListener onClickListener) {
            ...
            this.f6871P.mNeutralButtonListener = onClickListener;
            return this;
        }
        ...
        public Builder setOnCancelListener(DialogInterface.OnCancelListener onCancelListener) {
            this.f6871P.mOnCancelListener = onCancelListener;
            return this;
        }

        public Builder setOnItemSelectedListener(AdapterView.OnItemSelectedListener onItemSelectedListener) {
            this.f6871P.mOnItemSelectedListener = onItemSelectedListener;
            return this;
        }

        public Builder setOnKeyListener(DialogInterface.OnKeyListener onKeyListener) {
            this.f6871P.mOnKeyListener = onKeyListener;
            return this;
        }
        ...
        public Builder setPositiveButton(int i, DialogInterface.OnClickListener onClickListener) {
            ...
            this.f6871P.mPositiveButtonListener = onClickListener;
            return this;
        }
        ...
        public Builder setRecycleOnMeasureEnabled(boolean z) {
            this.f6871P.mRecycleOnMeasure = z;
            return this;
        }
        ...
        public Builder setTitle(CharSequence charSequence) {
            this.f6871P.mTitle = charSequence;
            return this;
        }
    ...
    protected MLAlertDialog(Context context) {
        this(context, C2875R.style.V5_AlertDialog);
    }
    ...
    protected MLAlertDialog(Context context, boolean z, DialogInterface.OnCancelListener onCancelListener) {
        super(context, C2875R.style.V5_AlertDialog);
        this.mStartY = 0;
        setCancelable(z);
    ...
    public void setContentPanelHeight(int i) {
        View findViewById = getWindow().findViewById(C2875R.C2877id.contentPanel);
