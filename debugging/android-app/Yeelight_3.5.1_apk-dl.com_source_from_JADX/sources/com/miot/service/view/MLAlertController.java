...
public class MLAlertController {
    ...
    public static class AlertParams {
        ...
        private void createCenterListView(final com.miot.service.view.MLAlertController r12) {
            /*
                ...
                int r1 = com.miot.service.C2875R.C2877id.select_dialog_listview
                ...
                int r4 = com.miot.service.C2875R.layout.ml_center_item
            ...
            L_0x0021:
                ...
                int r5 = com.miot.service.C2875R.C2877id.text1
            ...
            L_0x002d:
                ...
                r6[r7] = r2
                int[] r10 = new int[r8]
                int r2 = com.miot.service.C2875R.C2877id.text1
                r10[r7] = r2
                r2 = r9
                r7 = r10
            ...
            L_0x0045:
                ...
                int r3 = com.miot.service.C2875R.C2877id.title
        ...
        private void createListView(final com.miot.service.view.MLAlertController r11) {
            ...
            L_0x004f:
                ...
                int r3 = com.miot.service.C2875R.C2877id.text1
            ...
            L_0x005c:
                ...
                r6[r2] = r1
                int[] r7 = new int[r8]
                int r1 = com.miot.service.C2875R.C2877id.text1
                r7[r2] = r1
                r2 = r9
                r2.<init>(r3, r4, r5, r6, r7)
            L_0x0073:
    ...
    public MLAlertController(Context context, DialogInterface dialogInterface, Window window, int i) {
        ...
        this.mButtonHandler = new View.OnClickListener() {
            ...
            public void onClick(android.view.View r3) {
                ...
                L_0x006b:
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: com.miot.service.view.MLAlertController.C41651.onClick(android.view.View):void");
            }
        };
        this.mContext = context;
        ...
        this.mAlertDialogLayout = C2875R.layout.ml_alert_dialog_layout;
        this.mListLayout = C2875R.layout.ml_select_dialog;
        this.mListLayoutWithTitle = C2875R.layout.ml_select_dialog_center;
        this.mMultiChoiceItemLayout = C2875R.layout.ml_select_dialog_multichoice;
        this.mSingleChoiceItemLayout = C2875R.layout.ml_select_dialog_singlechoice;
        this.mListItemLayout = C2875R.layout.ml_select_dialog_item;
        this.mGravity = i;
    }
    ...
    private void centerButton(TextView textView) {
        ...
        textView.setBackgroundResource(C2875R.C2876drawable.dialog_btn_selector);
    }
    ...
    private boolean setupButtons() {
        int i;
        Button button;
        Button button2 = (Button) this.mWindow.findViewById(C2875R.C2877id.button1);
        ...
        Button button3 = (Button) this.mWindow.findViewById(C2875R.C2877id.button2);
        ...
        Button button4 = (Button) this.mWindow.findViewById(C2875R.C2877id.button3);
    ...
    private void setupContent(LinearLayout linearLayout) {
        ...
        int i = C2875R.C2877id.scrollView;
        ScrollView scrollView = (ScrollView) window.findViewById(i);
        this.mScrollView = scrollView;
        scrollView.setFocusable(false);
        TextView textView = (TextView) this.mWindow.findViewById(C2875R.C2877id.message);
        ...
        if (textView != null) {
            ...
            if (this.mListView != null) {
                linearLayout.removeView(this.mWindow.findViewById(i));
    ...
    private boolean setupTitle(LinearLayout linearLayout) {
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C2875R.C2877id.title_template).setVisibility(8);
        } else {
            boolean z = !TextUtils.isEmpty(this.mTitle);
            this.mIconView = (ImageView) this.mWindow.findViewById(C2875R.C2877id.icon);
            if (z) {
                TextView textView = (TextView) this.mWindow.findViewById(C2875R.C2877id.alertTitle);
    ...
    private void setupView() {
        LinearLayout linearLayout = (LinearLayout) this.mWindow.findViewById(C2875R.C2877id.contentPanel);
        setupContent(linearLayout);
        boolean z = setupButtons();
        LinearLayout linearLayout2 = (LinearLayout) this.mWindow.findViewById(C2875R.C2877id.topPanel);
        boolean z2 = setupTitle(linearLayout2);
        View findViewById = this.mWindow.findViewById(C2875R.C2877id.buttonPanel);
        if (!z) {
            findViewById.setVisibility(8);
        }
        FrameLayout frameLayout = (FrameLayout) this.mWindow.findViewById(C2875R.C2877id.customPanel);
        if (this.mView != null) {
            FrameLayout frameLayout2 = (FrameLayout) this.mWindow.findViewById(C2875R.C2877id.custom);
        ...
        if (this.mTransplantBg) {
            this.mWindow.findViewById(C2875R.C2877id.parentPanel).setBackgroundColor(this.mContext.getResources().getColor(17170445));
        }
        if (this.mListView != null) {
            this.mWindow.findViewById(C2875R.C2877id.title_divider_line).setVisibility(0);
        } else {
            this.mWindow.findViewById(C2875R.C2877id.title_divider_line).setVisibility(8);
            this.mWindow.findViewById(C2875R.C2877id.title_divider_line_bottom).setVisibility(8);
        }
        ...
        if (TextUtils.isEmpty(this.mTitle) && TextUtils.isEmpty(this.mMessage) && this.mMessageBuilder == null) {
            this.mWindow.findViewById(C2875R.C2877id.empty_view).setVisibility(8);
        }
