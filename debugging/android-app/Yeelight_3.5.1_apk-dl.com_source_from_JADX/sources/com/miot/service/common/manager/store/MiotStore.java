...
public class MiotStore {
    ...
    private C2469e mGson = new C2469e();
    ...
    public AppConfiguration loadAppConfig() {
        ...
        if (string != null) {
            return (AppConfiguration) this.mGson.mo19225h(string, AppConfiguration.class);
        }
        return null;
    }
    ...
    public List<MiotWanDevice> loadDeviceList() {
        ...
        for (String next : stringSet) {
            ...
            arrayList.add((MiotWanDevice) this.mGson.mo19225h(next, MiotWanDevice.class));
        }
        return arrayList;
    }
    ...
    public List<DeviceModel> loadDeviceModels() {
        ...
        ArrayList arrayList = new ArrayList();
        if (stringSet != null) {
            for (String h : stringSet) {
                arrayList.add((DeviceModel) this.mGson.mo19225h(h, DeviceModel.class));
            }
        }
        return arrayList;
    }
    ...
    public People loadPeople() {
        ...
        People people = (People) this.mGson.mo19225h(string, People.class);
    ...
    public void saveAppConfig(AppConfiguration appConfiguration) {
        String r = this.mGson.mo19234r(appConfiguration);
        SharedPreferences.Editor edit = this.mPreferences.edit();
    ...
    public void saveDeviceList(List<MiotWanDevice> list) {
        if (list != null && !list.isEmpty()) {
            ...
            for (MiotWanDevice r : list) {
                String r2 = this.mGson.mo19234r(r);
                hashSet.add(r2);
                MyLogger instance = MyLogger.getInstance();
    ...
    public void saveDeviceModels(List<DeviceModel> list) {
        ...
        for (DeviceModel r : list) {
            hashSet.add(this.mGson.mo19234r(r));
        }
        SharedPreferences.Editor edit = this.mPreferences.edit();
    ...
    public void savePeople(People people) {
        String r = this.mGson.mo19234r(people);
        MyLogger instance = MyLogger.getInstance();
