...
public class CustomPullDownRefreshLinearLayout extends LinearLayout {
    ...
    public CustomPullDownRefreshLinearLayout(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2875R.styleable.CustomPullDownRefreshLinearLayout);
        this.mScrollViewID = obtainStyledAttributes.getResourceId(C2875R.styleable.CustomPullDownRefreshLinearLayout_scroll_bar_id, 0);
    ...
    public void doAnimation() {
        ...
        if (i2 >= 0) {
            ...
            int i3 = (int) (((float) i2) - (f * 16.0f));
            this.mCurOffsetY = i3;
            if (z && i3 <= (i = this.mTriggerRefreshThreshold)) {
                this.mCurOffsetY = i;
    ...
    private void init() {
        ...
        if (!isInEditMode()) {
            ...
            this.mPullDownToRefreshText = getContext().getString(C2875R.string.pull_down_refresh);
            this.mReleaseText = getContext().getString(C2875R.string.release_to_refresh);
            this.mTriggerRefreshThreshold = getResources().getDimensionPixelSize(C2875R.dimen.pull_down_refresh_threshold);
            View inflate = LayoutInflater.from(getContext()).inflate(C2875R.layout.pull_header, (ViewGroup) null);
            this.mHeader = inflate;
            this.mContainer = inflate.findViewById(C2875R.C2877id.pull_header);
            this.mBkgImgView = (ImageView) this.mHeader.findViewById(C2875R.C2877id.img_bkg);
    ...
    private void preRefresh() {
        ...
        ((TextView) findViewById(C2875R.C2877id.pull_header_txt)).setText(C2875R.string.refreshing);
        if (this.mShowRefreshProgress) {
            findViewById(C2875R.C2877id.pull_header_prog).setVisibility(0);
        }
        View findViewById = findViewById(C2875R.C2877id.pull_header_indc);
        findViewById.clearAnimation();
        findViewById.setVisibility(8);
        ViewGroup.LayoutParams layoutParams = this.mContainer.getLayoutParams();
        if (this.mCurOffsetY == 0) {
            this.mCurOffsetY = getContext().getResources().getDimensionPixelSize(C2875R.dimen.pull_down_header_height);
        }
        ...
        if (action != 0) {
            if (action != 1) {
                if (action == 2) {
                    ...
                    if (z) {
                        TextView textView = (TextView) findViewById(C2875R.C2877id.pull_header_txt);
                        ImageView imageView = (ImageView) findViewById(C2875R.C2877id.pull_header_indc);
                                ...
                                if (this.mCurOffsetY >= this.mTriggerRefreshThreshold) {
                                    if (!this.mCanRefresh) {
                                        ...
                                        if (this.mAnimRotate == null) {
                                            Animation loadAnimation = AnimationUtils.loadAnimation(getContext(), C2875R.anim.rotate_180);
                                    ...
                                    if (this.mAnimRotateBack == null) {
                                        Animation loadAnimation2 = AnimationUtils.loadAnimation(getContext(), C2875R.anim.rotate_back_180);
    ...
    public void postRefresh() {
        ...
        ((TextView) findViewById(C2875R.C2877id.pull_header_txt)).setText(this.mPullDownToRefreshText);
        findViewById(C2875R.C2877id.pull_header_prog).setVisibility(8);
        View findViewById = findViewById(C2875R.C2877id.pull_header_indc);
        findViewById.clearAnimation();
    ...
    public void setIndicatorDrawable(Drawable drawable) {
        ((ImageView) findViewById(C2875R.C2877id.pull_header_indc)).setImageDrawable(drawable);
    }
    ...
    public void setOriHeight(int i) {
        this.mOriHeight = i;
        findViewById(C2875R.C2877id.pull_header).getLayoutParams().height = this.mOriHeight;
        this.mHeader.findViewById(C2875R.C2877id.empty_view).getLayoutParams().height = this.mOriHeight;
    }
    ...
    public void setPullDownHeaderVisibility(int i) {
        findViewById(C2875R.C2877id.pull_header_container).setVisibility(i);
    }

    public void setPullDownLine2Text(CharSequence charSequence) {
        TextView textView = (TextView) findViewById(C2875R.C2877id.pull_header_txt_line2);
    ...
    public void setPullDownTextColor(int i) {
        ((TextView) findViewById(C2875R.C2877id.pull_header_txt)).setTextColor(i);
    }

    public void setPullDownTextColorLine2(int i) {
        ((TextView) findViewById(C2875R.C2877id.pull_header_txt_line2)).setTextColor(i);
    }

    public void setPullDownTextSize(int i) {
        ((TextView) findViewById(C2875R.C2877id.pull_header_txt)).setTextSize((float) i);
    }
