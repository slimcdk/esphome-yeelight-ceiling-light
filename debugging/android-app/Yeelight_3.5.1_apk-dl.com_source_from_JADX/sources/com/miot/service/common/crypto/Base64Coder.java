...
public class Base64Coder {
    ...
    public static class OutputStream extends FilterOutputStream {
        ...
        public void flushBase64() {
            ...
            if (this.encode) {
                this.out.write(Base64Coder.encode3to4(this.f4695b4, this.buffer, i, this.options));
                this.position = 0;
                return;
            }
        ...
        public void write(int i) {
            ...
            if (this.encode) {
                ...
                if (i3 >= i4) {
                    this.out.write(Base64Coder.encode3to4(this.f4695b4, bArr, i4, this.options));
                ...
                if (bArr2[i6] > -5) {
                    ...
                    if (i8 >= this.bufferLength) {
                        this.out.write(this.f4695b4, 0, Base64Coder.decode4to3(bArr3, 0, this.f4695b4, 0, this.options));
                    } else {
                        return;
                    }
                } else if (bArr2[i6] != -5) {
