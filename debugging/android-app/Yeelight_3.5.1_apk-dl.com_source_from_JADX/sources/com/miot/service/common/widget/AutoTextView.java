...
public class AutoTextView extends TextSwitcher implements ViewSwitcher.ViewFactory {
    ...
    public AutoTextView(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2875R.styleable.AutoTextView);
        this.mTextSize = (float) obtainStyledAttributes.getInt(C2875R.styleable.AutoTextView_autoTextSize, 13);
        StringBuilder sb = new StringBuilder();
        sb.append("mTextSize: ");
        sb.append(this.mTextSize);
        this.mTextColor = obtainStyledAttributes.getColor(C2875R.styleable.AutoTextView_autoTextColor, -6710887);
