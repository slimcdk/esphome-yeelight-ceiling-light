...
public abstract class Packet {
    ...
    private static Packet getDataPacket(Header header) {
        return new DataPacket(header.f4683sn, new Bytes(header.value, 2));
    }
    ...
    public static Packet getPacket(byte[] bArr) {
        ...
        return header != null ? header.f4683sn != 0 ? getDataPacket(header) : getFlowPacket(header) : new InvalidPacket();
    }
