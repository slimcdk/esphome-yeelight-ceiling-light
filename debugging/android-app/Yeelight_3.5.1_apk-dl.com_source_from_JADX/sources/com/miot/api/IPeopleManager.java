...
public interface IPeopleManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IPeopleManager {
            ...
            public int deletePeople() {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(3, obtain, obtain2, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().deletePeople();
                    }
            ...
            public People getPeople() {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(1, obtain, obtain2, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().getPeople();
                    }
                    obtain2.readException();
                    People createFromParcel = obtain2.readInt() != 0 ? People.CREATOR.createFromParcel(obtain2) : null;
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public int savePeople(People people) {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(2, obtain, obtain2, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().savePeople(people);
                    }
                    obtain2.readException();
                    int readInt = obtain2.readInt();
                    obtain2.recycle();
        ...
        public static boolean setDefaultImpl(IPeopleManager iPeopleManager) {
            if (Proxy.sDefaultImpl != null || iPeopleManager == null) {
                return false;
            }
            Proxy.sDefaultImpl = iPeopleManager;
            return true;
        }
