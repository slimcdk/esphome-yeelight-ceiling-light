...
public class DeviceManager {
    ...
    private static class DeviceListener extends IDeviceHandler.Stub {
        ...
        public void onFailed(int i, String str) {
            Logger.m7500e(DeviceManager.TAG, String.format("getRemoteDeviceList onFailed: %d %s", new Object[]{Integer.valueOf(i), str}));
            try {
        ...
        public void onSucceed(Device device, int i, int i2) {
            if (device != null) {
                Logger.m7499d(DeviceManager.TAG, String.format("getRemoteDeviceList model=%s address=%s", new Object[]{device.getDeviceModel(), device.getAddress()}));
            ...
            if (people != null) {
                try {
                    this.mIDeviceManager.addTimer(people, timer, new IAddTimerCompletionHandler.Stub() {
                        public void onFailed(int i, String str) {
                            Logger.m7500e(DeviceManager.TAG, String.format("addTimer onFailed: %d %s", new Object[]{Integer.valueOf(i), str}));
                            try {
                        ...
                        public void onSucceed(long j) {
                            Logger.m7499d(DeviceManager.TAG, "addTimer onSucceed");
                            try {
            ...
            if (people != null) {
                try {
                    this.mIDeviceManager.cancelShare(people, abstractDevice.getDevice(), str, new ICompletionHandler.Stub() {
                        public void onFailed(int i, String str) {
                            Logger.m7500e(DeviceManager.TAG, String.format("cancelShare onFailed: %d %s", new Object[]{Integer.valueOf(i), str}));
                            try {
                        ...
                        public void onSucceed() {
                            Logger.m7499d(DeviceManager.TAG, "cancelShare onSucceed");
                            try {
                        ...
                        try {
                            ...
                            if (jSONObject == null) {
                                ...
                                if (commonHandler2 != null) {
                                    commonHandler2.onFailed(-1, "result null");
                                    return;
                                }
                                return;
                            }
                            ...
                            if (commonHandler3 != null) {
                                commonHandler3.onSucceed(jSONObject);
                            }
                        } catch (JSONException e) {
                            CommonHandler commonHandler4 = commonHandler;
                            if (commonHandler4 != null) {
                                commonHandler4.onFailed(-1, e.toString());
                            }
                        }
                    }
                });
                ...
                this.mIDeviceManager.checkPinCode(people, str, device, new ICommonHandler.Stub() {
                    ...
                    public void onSucceed(String str) {
                        try {
                            ...
                            CommonHandler commonHandler2 = commonHandler;
                            if (commonHandler2 != null) {
                                commonHandler2.onSucceed(Integer.valueOf(optInt));
                            }
                        } catch (JSONException e) {
                            CommonHandler commonHandler3 = commonHandler;
                            if (commonHandler3 != null) {
                                commonHandler3.onFailed(-1, e.toString());
                            }
                        }
                    }
                });
            ...
            if (people != null) {
                try {
                    this.mIDeviceManager.enableScene(people, i, false, new ICompletionHandler.Stub() {
                        public void onFailed(int i, String str) {
                            Logger.m7500e(DeviceManager.TAG, String.format("enableScene onFailed: %d %s", new Object[]{Integer.valueOf(i), str}));
                            try {
                                completionHandler.onFailed(i, str);
                            } catch (Exception e) {
                                e.printStackTrace();
                        ...
                        public void onSucceed() {
                            Logger.m7499d(DeviceManager.TAG, "enableScene onSucceed");
                            try {
                                completionHandler.onSucceed();
                            } catch (Exception e) {
                                e.printStackTrace();
            ...
            if (people != null) {
                try {
                    this.mIDeviceManager.disclaimOwnership(people, abstractDevice.getDevice(), new ICompletionHandler.Stub() {
                        public void onFailed(int i, String str) {
                            Logger.m7500e(DeviceManager.TAG, String.format("disclaimOwnership onFailed: %d %s", new Object[]{Integer.valueOf(i), str}));
                            try {
                                completionHandler.onFailed(i, str);
                            } catch (Exception e) {
                                e.printStackTrace();
                        ...
                        public void onSucceed() {
                            Logger.m7499d(DeviceManager.TAG, "disclaimOwnership onSucceed");
                            try {
                                completionHandler.onSucceed();
                            } catch (Exception e) {
                                e.printStackTrace();
            ...
            if (people != null) {
                try {
                    this.mIDeviceManager.editScene(people, sceneBean, new ICompletionHandler.Stub() {
                        public void onFailed(int i, String str) {
                            Logger.m7500e(DeviceManager.TAG, String.format("editScene onFailed: %d %s", new Object[]{Integer.valueOf(i), str}));
                            try {
                                completionHandler.onFailed(i, str);
                            } catch (Exception e) {
                                e.printStackTrace();
                        ...
                        public void onSucceed() {
                            Logger.m7499d(DeviceManager.TAG, "editScene onSucceed");
                            try {
                                completionHandler.onSucceed();
                            } catch (Exception e) {
                                e.printStackTrace();
            ...
            if (people != null) {
                try {
                    this.mIDeviceManager.editTimer(people, timer, new ICompletionHandler.Stub() {
                        public void onFailed(int i, String str) {
                            Logger.m7500e(DeviceManager.TAG, String.format("editTimer onFailed: %d %s", new Object[]{Integer.valueOf(i), str}));
                            try {
                                completionHandler.onFailed(i, str);
                            } catch (Exception e) {
                                e.printStackTrace();
                        ...
                        public void onSucceed() {
                            Logger.m7499d(DeviceManager.TAG, "editTimer onSucceed");
                            try {
                                completionHandler.onSucceed();
                            } catch (Exception e) {
                                e.printStackTrace();
                    ...
                    public void onSucceed(String str) {
                        try {
                            ...
                            if (jSONObject == null) {
                                CommonHandler commonHandler2 = commonHandler;
                                if (commonHandler2 != null) {
                                    commonHandler2.onFailed(-1, "value null");
                                    return;
                                }
                                return;
                            }
                            ...
                            CommonHandler commonHandler3 = commonHandler;
                            if (commonHandler3 != null) {
                                commonHandler3.onSucceed(optString);
                            }
                        } catch (JSONException e) {
                            CommonHandler commonHandler4 = commonHandler;
                            if (commonHandler4 != null) {
            ...
            if (people != null) {
                try {
                    this.mIDeviceManager.renameDevice(people, abstractDevice.getDevice(), (String) fieldList.getValue(DeviceDefinition.Name), new ICompletionHandler.Stub() {
                        public void onFailed(int i, String str) {
                            Logger.m7500e(DeviceManager.TAG, String.format("modifyDevice onFailed: %d %s", new Object[]{Integer.valueOf(i), str}));
                            try {
                                completionHandler.onFailed(i, str);
                            } catch (Exception e) {
                                e.printStackTrace();
                        ...
                        public void onSucceed() {
                            Logger.m7499d(DeviceManager.TAG, "modifyDevice onSucceed");
                            try {
                                completionHandler.onSucceed();
                            } catch (Exception e) {
                                e.printStackTrace();
            ...
            if (people != null) {
                try {
                    this.mIDeviceManager.queryDeviceLog(people, deviceLogQueryParams, new IDeviceLogHandler.Stub() {
                        public void onFailed(int i, String str) {
                            Logger.m7500e(DeviceManager.TAG, String.format("getPowerConsumption onFailed: %d %s", new Object[]{Integer.valueOf(i), str}));
                            try {
                                commonHandler.onFailed(i, str);
                            } catch (Exception e) {
                                e.printStackTrace();
                        ...
                        public void onSucceed(List<DeviceLog> list) {
                            Logger.m7499d(DeviceManager.TAG, "getPowerConsumption onSucceed");
                            try {
            ...
            if (people != null) {
                try {
                    this.mIDeviceManager.queryFirmwareInfo(people, abstractDevice.getDevice(), new IQueryFirmwareHandler.Stub() {
                        public void onFailed(int i, String str) {
                            Logger.m7500e(DeviceManager.TAG, String.format("queryFirmwareInfo onFailed: %d %s", new Object[]{Integer.valueOf(i), str}));
                            try {
                        ...
                        public void onSucceed(MiotFirmware miotFirmware) {
                            Logger.m7499d(DeviceManager.TAG, "queryFirmwareInfo onSucceed");
        ...
        if (this.mIDeviceManager != null) {
            ...
            if (people != null) {
                try {
                    this.mIDeviceManager.queryFirmwareInfo(people, abstractDevice.getDevice(), new IQueryFirmwareHandler.Stub() {
                        public void onFailed(int i, String str) {
                            Logger.m7500e(DeviceManager.TAG, String.format("queryFirmwareUpgradeInfo onFailed: %d %s", new Object[]{Integer.valueOf(i), str}));
                            try {
                                queryFirmwareHandler.onFailed(i, str);
                            } catch (Exception e) {
                                e.printStackTrace();
                        ...
                        public void onSucceed(MiotFirmware miotFirmware) {
                            Logger.m7499d(DeviceManager.TAG, "queryFirmwareUpgradeInfo onSucceed");
                            try {
                                queryFirmwareHandler.onSucceed(miotFirmware);
                            } catch (Exception e) {
                                e.printStackTrace();
            ...
            if (people != null) {
                try {
                    this.mIDeviceManager.queryScene(people, i, new ISceneHandler.Stub() {
                        public void onFailed(int i, String str) {
                            Logger.m7500e(DeviceManager.TAG, String.format("queryScene onFailed: %d %s", new Object[]{Integer.valueOf(i), str}));
                            try {
                                commonHandler.onFailed(i, str);
                            } catch (Exception e) {
                                e.printStackTrace();
                        ...
                        public void onSucceed(SceneBean sceneBean) {
                            Logger.m7499d(DeviceManager.TAG, "queryScene onSucceed");
                            try {
            ...
            if (people != null) {
                try {
                    this.mIDeviceManager.querySceneList(people, new IScenesHandler.Stub() {
                        public void onFailed(int i, String str) {
                            Logger.m7500e(DeviceManager.TAG, String.format("queryTimerList onFailed: %d %s", new Object[]{Integer.valueOf(i), str}));
                            try {
                                commonHandler.onFailed(i, str);
                            } catch (Exception e) {
                                e.printStackTrace();
                        ...
                        public void onSucceed(List<SceneBean> list) {
                            Logger.m7499d(DeviceManager.TAG, "queryTimerList onSucceed");
                            try {
                                commonHandler.onSucceed(list);
                            } catch (Exception e) {
                                e.printStackTrace();
            ...
            if (people != null) {
                try {
                    this.mIDeviceManager.querySharedRequests(people, new ISharedRequestsHandler.Stub() {
                        public void onFailed(int i, String str) {
                            Logger.m7500e(DeviceManager.TAG, String.format("querySharedRequests onFailed: %d %s", new Object[]{Integer.valueOf(i), str}));
                            try {
                                commonHandler.onFailed(i, str);
                            } catch (Exception e) {
                                e.printStackTrace();
                        ...
                        public void onSucceed(List<SharedRequest> list) {
                            Logger.m7499d(DeviceManager.TAG, "querySharedRequests onSucceed");
                            try {
                                commonHandler.onSucceed(list);
                            } catch (Exception e) {
                                e.printStackTrace();
            ...
            if (people != null) {
                try {
                    this.mIDeviceManager.querySharedUsers(people, abstractDevice.getDevice(), new ISharedUsersHandler.Stub() {
                        public void onFailed(int i, String str) {
                            Logger.m7500e(DeviceManager.TAG, String.format("queryShareUsers onFailed: %d %s", new Object[]{Integer.valueOf(i), str}));
                            try {
                                commonHandler.onFailed(i, str);
                            } catch (Exception e) {
                                e.printStackTrace();
                        ...
                        public void onSucceed(List<SharedUser> list) {
                            Logger.m7499d(DeviceManager.TAG, "queryShareUsers onSucceed");
                            try {
                                commonHandler.onSucceed(list);
                            } catch (Exception e) {
                                e.printStackTrace();
            ...
            if (people != null) {
                try {
                    this.mIDeviceManager.removeTimer(people, j, new ICompletionHandler.Stub() {
                        public void onFailed(int i, String str) {
                            Logger.m7500e(DeviceManager.TAG, String.format("removeTimer onFailed: %d %s", new Object[]{Integer.valueOf(i), str}));
                            try {
                                completionHandler.onFailed(i, str);
                            } catch (Exception e) {
                                e.printStackTrace();
                        ...
                        public void onSucceed() {
                            Logger.m7499d(DeviceManager.TAG, "removeTimer onSucceed");
                            try {
                                completionHandler.onSucceed();
                            } catch (Exception e) {
                                e.printStackTrace();
            ...
            if (people != null) {
                try {
                    this.mIDeviceManager.renameDevice(people, abstractDevice.getDevice(), str, new ICompletionHandler.Stub() {
                        public void onFailed(int i, String str) {
                            Logger.m7500e(DeviceManager.TAG, String.format("renameDevice onFailed: %d %s", new Object[]{Integer.valueOf(i), str}));
                            try {
                                completionHandler.onFailed(i, str);
                            } catch (Exception e) {
                                e.printStackTrace();
                        ...
                        public void onSucceed() {
                            Logger.m7499d(DeviceManager.TAG, "renameDevice onSucceed");
                            try {
                                completionHandler.onSucceed();
                            } catch (Exception e) {
                                e.printStackTrace();
            ...
            if (people != null) {
                try {
                    this.mIDeviceManager.replySharedRequest(people, sharedRequest, new ICompletionHandler.Stub() {
                        public void onFailed(int i, String str) {
                            Logger.m7500e(DeviceManager.TAG, String.format("replySharedRequest onFailed: %d %s", new Object[]{Integer.valueOf(i), str}));
                            try {
                                completionHandler.onFailed(i, str);
                            } catch (Exception e) {
                                e.printStackTrace();
                        ...
                        public void onSucceed() {
                            Logger.m7499d(DeviceManager.TAG, "replySharedRequest onSucceed");
                            try {
                                completionHandler.onSucceed();
                            } catch (Exception e) {
                                e.printStackTrace();
            ...
            if (people != null) {
                try {
                    this.mIDeviceManager.runScene(people, i, new ICompletionHandler.Stub() {
                        public void onFailed(int i, String str) {
                            Logger.m7500e(DeviceManager.TAG, String.format("runScene onFailed: %d %s", new Object[]{Integer.valueOf(i), str}));
                            try {
                                completionHandler.onFailed(i, str);
                            } catch (Exception e) {
                                e.printStackTrace();
                        ...
                        public void onSucceed() {
                            Logger.m7499d(DeviceManager.TAG, "runScene onSucceed");
                            try {
                                completionHandler.onSucceed();
                            } catch (Exception e) {
                                e.printStackTrace();
                ...
                this.mIDeviceManager.setPinCode(people, str, str2, device, new ICommonHandler.Stub() {
                    ...
                    public void onSucceed(String str) {
                        try {
                            ...
                            CommonHandler commonHandler3 = commonHandler;
                            if (commonHandler3 != null) {
                                commonHandler3.onSucceed(Integer.valueOf(optInt));
                            }
                        } catch (JSONException e) {
                            CommonHandler commonHandler4 = commonHandler;
                            if (commonHandler4 != null) {
    ...
    public void shareBatchDevice(List<AbstractDevice> list, List<String> list2, final CompletionHandler completionHandler) {
        if (this.mIDeviceManager != null) {
            People people = MiotManager.getPeople();
            if (people != null) {
                ...
                try {
                    this.mIDeviceManager.shareBatchDevice(people, arrayList, list2, new ICompletionHandler.Stub() {
                        public void onFailed(int i, String str) {
                            Logger.m7500e(DeviceManager.TAG, String.format("shareBatchDevice onFailed: %d %s", new Object[]{Integer.valueOf(i), str}));
                            try {
                                completionHandler.onFailed(i, str);
                            } catch (Exception e) {
                                e.printStackTrace();
                        ...
                        public void onSucceed() {
                            Logger.m7499d(DeviceManager.TAG, "shareBatchDevice onSucceed");
                            try {
                                completionHandler.onSucceed();
                            } catch (Exception e) {
                                e.printStackTrace();
            ...
            if (people != null) {
                try {
                    this.mIDeviceManager.shareDevice(people, abstractDevice.getDevice(), str, new ICompletionHandler.Stub() {
                        public void onFailed(int i, String str) {
                            Logger.m7500e(DeviceManager.TAG, String.format("shareDevice onFailed: %d %s", new Object[]{Integer.valueOf(i), str}));
                            try {
                                completionHandler.onFailed(i, str);
                            } catch (Exception e) {
                                e.printStackTrace();
                        ...
                        public void onSucceed() {
                            Logger.m7499d(DeviceManager.TAG, "shareDevice onSucceed");
                            try {
                                completionHandler.onSucceed();
                            } catch (Exception e) {
                                e.printStackTrace();
            ...
            if (people != null) {
                try {
                    this.mIDeviceManager.startUpgradeFirmware(people, abstractDevice.getDevice(), new ICompletionHandler.Stub() {
                        public void onFailed(int i, String str) {
                            Logger.m7500e(DeviceManager.TAG, String.format("upgradeFirmware onFailed: %d %s", new Object[]{Integer.valueOf(i), str}));
                            try {
                                completionHandler.onFailed(i, str);
                            } catch (Exception e) {
                                e.printStackTrace();
                        ...
                        public void onSucceed() {
                            Logger.m7499d(DeviceManager.TAG, "upgradeFirmware onSucceed");
            ...
            if (people != null) {
                try {
                    this.mIDeviceManager.takeOwnership(people, abstractDevice.getDevice(), new ICompletionHandler.Stub() {
                        public void onFailed(int i, String str) {
                            Logger.m7500e(DeviceManager.TAG, String.format("takeOwnership onFailed: %d %s", new Object[]{Integer.valueOf(i), str}));
                            try {
                                completionHandler.onFailed(i, str);
                            } catch (Exception e) {
                                e.printStackTrace();
                        ...
                        public void onSucceed() {
                            Logger.m7499d(DeviceManager.TAG, "takeOwnership onSucceed");
                            try {
                                completionHandler.onSucceed();
                            } catch (Exception e) {
                                e.printStackTrace();
