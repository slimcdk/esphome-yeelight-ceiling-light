...
public interface IResponse extends IInterface {
    ...
    public static class Default implements IResponse {
    ...
    public static abstract class Stub extends Binder implements IResponse {
        private static final String DESCRIPTOR = "com.miot.api.IResponse";
        static final int TRANSACTION_onResponse = 1;

        private static class Proxy implements IResponse {
            public static IResponse sDefaultImpl;
        ...
        public static IResponse getDefaultImpl() {
            return Proxy.sDefaultImpl;
        }

        public static boolean setDefaultImpl(IResponse iResponse) {
            if (Proxy.sDefaultImpl != null || iResponse == null) {
                return false;
            }
            Proxy.sDefaultImpl = iResponse;
            return true;
        }
