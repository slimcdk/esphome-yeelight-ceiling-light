...
public class DeviceConnector {
    ...
    public void connectToCloud(final AbstractDevice abstractDevice, final IConfigHandler iConfigHandler) {
        if (this.mIDeviceConnection != null) {
            People people = MiotManager.getPeople();
            if (people != null) {
                try {
                    this.mIDeviceConnection.connectToCloud(people, abstractDevice.getDevice(), new IConfigHandler.Stub() {
                        public void onFailed(int i, String str) {
                            Logger.m7500e(DeviceConnector.TAG, String.format("%s connectToCloud onFailed: %d %s", new Object[]{abstractDevice.getDeviceModel(), Integer.valueOf(i), str}));
                            try {
                                iConfigHandler.onFailed(i, str);
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
                        }
                        ...
                        public void onSucceed(String str) {
                            Logger.m7499d(DeviceConnector.TAG, String.format("%s connectToCloud onSucceed", new Object[]{abstractDevice.getDeviceModel()}));
                            try {
                                iConfigHandler.onSucceed(str);
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
                        }
