...
public interface IDiscoveryListener extends IInterface {
    ...
    public static class Default implements IDiscoveryListener {
    ...
    public static abstract class Stub extends Binder implements IDiscoveryListener {
        ...
        private static class Proxy implements IDiscoveryListener {
            public static IDiscoveryListener sDefaultImpl;
            ...
            public void onDeviceFound(Device device, int i, int i2) {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().onDeviceFound(device, i, i2);
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
                }
            ...
            public void onDeviceLost(Device device, int i, int i2) {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().onDeviceLost(device, i, i2);
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
                }
            ...
            public void onDeviceUpdate(Device device, int i, int i2) {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().onDeviceUpdate(device, i, i2);
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
                }
        ...
        public static IDiscoveryListener getDefaultImpl() {
            return Proxy.sDefaultImpl;
        }

        public static boolean setDefaultImpl(IDiscoveryListener iDiscoveryListener) {
            if (Proxy.sDefaultImpl != null || iDiscoveryListener == null) {
                return false;
            }
            Proxy.sDefaultImpl = iDiscoveryListener;
            return true;
        }
