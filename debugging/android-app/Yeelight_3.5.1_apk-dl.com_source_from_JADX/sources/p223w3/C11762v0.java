...
/* renamed from: w3.v0 */
public class C11762v0 extends C6094f {

    /* renamed from: w3.v0$a */
    class C11763a implements CompletedHandler {
        ...
        public void onFailed(IotError iotError) {
            String str = C11762v0.this.f4758v;
        }
        ...
        public void onSucceed() {
            ...
            C11762v0.this.mo23221d0().mo31547K0(this.f21568a);
            boolean unused = C11762v0.this.f12526y = true;
        }
    }

    /* renamed from: w3.v0$b */
    class C11764b implements CompletedHandler {
        ...
        public void onSucceed() {
            ...
            C11762v0.this.mo23221d0().mo31555O0(this.f21570a);
            boolean unused = C11762v0.this.f12526y = true;
        }
    }

    /* renamed from: w3.v0$c */
    class C11765c implements CompletedHandler {
        C11765c() {
        }
    ...
    public C11762v0(String str) {
        super((String) null, "yeelink.light.ml2", "", 2342, "");
        mo23194L0(str);
        mo23187H0(str);
    }

    public C11762v0(String str, String str2, String str3, String str4) {
    ...
    public boolean mo31726Y1(int i) {
        mo31729b2(3, 11, Integer.valueOf(C9201q.m22191c((byte) i, mo23221d0().mo31586e0() ? (byte) 1 : 0, (byte) 0)), new C11763a(i));
        return true;
    }
    ...
    public boolean mo31730c2(boolean z) {
        mo31729b2(3, 11, Integer.valueOf(C9201q.m22191c((byte) mo23221d0().mo31542I(), z ? (byte) 1 : 0, (byte) 0)), new C11764b(z));
        return true;
    }
    ...
    public boolean mo23160t1() {
        mo31729b2(3, 11, Integer.valueOf(C9201q.m22191c((byte) mo23221d0().mo31542I(), mo23221d0().mo31586e0() ? (byte) 1 : 0, (byte) 1)), new C11765c());
        return true;
    }
