...
final class C3249a {
    ...
    /* renamed from: a */
    public byte[] mo23794a() {
        byte[] bArr = new byte[BluetoothConstants.MSG_READ_RSSI];
        int g = this.f5232a.mo19497g();
        int j = this.f5232a.mo19501j();
        for (int i = 0; i < g; i++) {
            int[] iArr = f5231b[i];
            for (int i2 = 0; i2 < j; i2++) {
                int i3 = iArr[i2];
                if (i3 >= 0 && this.f5232a.mo19493d(i2, i)) {
                    int i4 = i3 / 6;
