...
public final class C3136i {
    ...
    /* renamed from: b */
    private static final boolean f5035b;

    static {
        String name = Charset.defaultCharset().name();
        f5034a = name;
        f5035b = "SJIS".equalsIgnoreCase(name) || "EUC_JP".equalsIgnoreCase(name);
    }

    /* renamed from: a */
    public static String m8386a(byte[] bArr, Map<DecodeHintType, ?> map) {
        byte[] bArr2 = bArr;
        ...
        return (!z4 || (!z2 && (i6 + i7) + i8 <= 0)) ? (!z3 || (!f5035b && i9 < 3 && i < 3)) ? (!z || !z3) ? z ? "ISO8859_1" : z3 ? "SJIS" : z4 ? "UTF8" : f5034a : (!(i9 == 2 && i2 == 2) && i10 * 10 < length) ? "ISO8859_1" : "SJIS" : "SJIS" : "UTF8";
    }
}
