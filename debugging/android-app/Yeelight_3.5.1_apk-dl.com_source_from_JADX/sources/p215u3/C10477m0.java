...
import com.yeelight.yeelib.p142ui.activity.KidLockActivity;
import com.yeelight.yeelib.p142ui.view.RedSpotTipTextView;

/* renamed from: u3.m0 */
public class C10477m0 extends C6093d {

    /* renamed from: h */
    private TextView f19607h;

    /* renamed from: u3.m0$a */
    class C10478a implements View.OnClickListener {

        /* renamed from: a */
        final /* synthetic */ Activity f19608a;

        /* renamed from: b */
        final /* synthetic */ C3010c f19609b;

        C10478a(Activity activity, C3010c cVar) {
            this.f19608a = activity;
            this.f19609b = cVar;
        }

        public void onClick(View view) {
            C10477m0.this.mo31695o(this.f19608a, this.f19609b.mo23185G());
        }
    }

    public C10477m0(int i, String str, int i2, String str2, boolean z) {
        super(i, str, i2, str2, z);
    }

    /* renamed from: q */
    private void m26598q() {
    }
    ...
    public View mo31681a(Activity activity, C3010c cVar) {
        ...
        relativeLayout.setOnClickListener(new C10478a(activity, cVar));
        m26598q();
    ...
    public void mo31682b() {
        TextView textView = this.f19607h;
        if (textView != null) {
