...
import com.yeelight.yeelib.p142ui.activity.GeekModeNewActivity;
import com.yeelight.yeelib.p142ui.view.RedSpotTipTextView;

/* renamed from: u3.b0 */
public class C10425b0 extends C6093d {

    /* renamed from: h */
    private TextView f19526h;

    /* renamed from: u3.b0$a */
    class C10426a implements View.OnClickListener {

        /* renamed from: a */
        final /* synthetic */ Activity f19527a;

        /* renamed from: b */
        final /* synthetic */ C3010c f19528b;

        C10426a(Activity activity, C3010c cVar) {
            this.f19527a = activity;
            this.f19528b = cVar;
        }

        public void onClick(View view) {
            C10425b0.this.mo31695o(this.f19527a, this.f19528b.mo23185G());
        }
    }

    public C10425b0(int i, String str, int i2, String str2) {
        super(i, str, i2, str2);
    }

    public C10425b0(int i, String str, int i2, String str2, boolean z) {
        super(i, str, i2, str2, z);
    }

    /* renamed from: q */
    private void m26460q() {
    }
    ...
    public View mo31681a(Activity activity, C3010c cVar) {
        ...
        relativeLayout.setOnClickListener(new C10426a(activity, cVar));
        m26460q();
    ...
    public void mo31682b() {
        TextView textView = this.f19526h;
        if (textView != null) {
