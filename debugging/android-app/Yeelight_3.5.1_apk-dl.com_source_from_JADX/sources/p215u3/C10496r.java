...
import com.yeelight.yeelib.p142ui.activity.DeviceInfoActivity;
import com.yeelight.yeelib.p142ui.view.RedSpotTipTextView;

/* renamed from: u3.r */
public class C10496r extends C6093d {

    /* renamed from: u3.r$a */
    class C10497a implements View.OnClickListener {

        /* renamed from: a */
        final /* synthetic */ Activity f19641a;

        C10497a(Activity activity) {
            this.f19641a = activity;
        }

        public void onClick(View view) {
            C10496r rVar = C10496r.this;
            rVar.mo31695o(this.f19641a, rVar.f12510f);
        }
    }

    public C10496r(int i, String str, int i2, String str2) {
        super(i, str, i2, str2);
    }
    ...
    public View mo31681a(Activity activity, C3010c cVar) {
        ...
        relativeLayout.setOnClickListener(new C10497a(activity));
