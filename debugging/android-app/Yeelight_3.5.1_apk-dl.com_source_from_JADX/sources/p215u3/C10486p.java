...
/* renamed from: u3.p */
public class C10486p extends C6093d {
    public C10486p(int i, String str, int i2, String str2) {
        super(i, str, i2, str2);
    }

    /* access modifiers changed from: private */
    /* renamed from: r */
    public /* synthetic */ void m26623r(Activity activity, C3010c cVar, View view) {
    ...
    public View mo31681a(Activity activity, C3010c cVar) {
        ...
        relativeLayout.setOnClickListener(new C10484o(this, activity, cVar));
        return inflate;
    }
