...
import com.yeelight.yeelib.p142ui.activity.AddShortcutActivity;
import com.yeelight.yeelib.p142ui.view.RedSpotTipTextView;

/* renamed from: u3.g1 */
public class C10454g1 extends C6093d {

    /* renamed from: u3.g1$a */
    class C10455a implements View.OnClickListener {

        /* renamed from: a */
        final /* synthetic */ Activity f19574a;

        /* renamed from: b */
        final /* synthetic */ C3010c f19575b;

        C10455a(Activity activity, C3010c cVar) {
            this.f19574a = activity;
            this.f19575b = cVar;
        }

        public void onClick(View view) {
            C10454g1.this.mo31695o(this.f19574a, this.f19575b.mo23185G());
        }
    }

    public C10454g1(int i, String str, int i2, String str2) {
        super(i, str, i2, str2);
    }
    ...
    public View mo31681a(Activity activity, C3010c cVar) {
        ...
        relativeLayout.setOnClickListener(new C10455a(activity, cVar));
