...
import com.yeelight.yeelib.p142ui.activity.BundleSceneDemoActivity;
import com.yeelight.yeelib.p142ui.view.RedSpotTipTextView;

/* renamed from: u3.e */
public class C10441e extends C6093d {

    /* renamed from: h */
    private TextView f19548h;

    /* renamed from: u3.e$a */
    class C10442a implements View.OnClickListener {

        /* renamed from: a */
        final /* synthetic */ Activity f19549a;

        /* renamed from: b */
        final /* synthetic */ C3010c f19550b;

        C10442a(Activity activity, C3010c cVar) {
            this.f19549a = activity;
            this.f19550b = cVar;
        }

        public void onClick(View view) {
            C10441e.this.mo31695o(this.f19549a, this.f19550b.mo23185G());
        }
    }

    public C10441e(int i, String str, int i2, String str2) {
        super(i, str, i2, str2);
    }

    /* renamed from: q */
    private void m26497q() {
    }
    ...
    public View mo31681a(Activity activity, C3010c cVar) {
        ...
        relativeLayout.setOnClickListener(new C10442a(activity, cVar));
        m26497q();
