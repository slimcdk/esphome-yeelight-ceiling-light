...
import com.yeelight.yeelib.p142ui.activity.DefaultScheduleActivity;
...
/* renamed from: u3.f0 */
public class C10449f0 extends C6093d {
    public C10449f0(int i, String str, int i2, String str2) {
        super(i, str, i2, str2);
    }

    /* access modifiers changed from: private */
    /* renamed from: r */
    public /* synthetic */ void m26516r(Activity activity, C3010c cVar, View view) {
    ...
    public View mo31681a(Activity activity, C3010c cVar) {
        ...
        relativeLayout.setOnClickListener(new C10443e0(this, activity, cVar));
        return inflate;
    }
