...
import com.yeelight.yeelib.p142ui.activity.LightGradientFeatureActivity;
import com.yeelight.yeelib.p142ui.view.RedSpotTipTextView;

/* renamed from: u3.s0 */
public class C10503s0 extends C6093d {
    public C10503s0(int i, String str, int i2, String str2) {
        super(i, str, i2, str2);
    }

    /* access modifiers changed from: private */
    /* renamed from: r */
    public /* synthetic */ void m26662r(Activity activity, C3010c cVar, View view) {
    ...
    public View mo31681a(Activity activity, C3010c cVar) {
        ...
        ((RelativeLayout) inflate.findViewById(R$id.feature_item_root)).setOnClickListener(new C10498r0(this, activity, cVar));
        return inflate;
    }
