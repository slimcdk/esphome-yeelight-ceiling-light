...
import com.yeelight.cherry.p141ui.activity.CurtainGuideActivity;
...
/* renamed from: u3.h */
public class C10456h extends C6093d {
    public C10456h(int i, String str, int i2, String str2) {
        super(i, str, i2, str2);
    }

    /* access modifiers changed from: private */
    /* renamed from: r */
    public /* synthetic */ void m26534r(Activity activity, C3010c cVar, View view) {
    ...
    public View mo31681a(Activity activity, C3010c cVar) {
        ...
        relativeLayout.setOnClickListener(new C10452g(this, activity, cVar));
        return inflate;
    }
    ...
    public Class mo31688h() {
        Class<CurtainGuideActivity> cls = CurtainGuideActivity.class;
        try {
            int i = CurtainGuideActivity.f10217f;
            return cls;
