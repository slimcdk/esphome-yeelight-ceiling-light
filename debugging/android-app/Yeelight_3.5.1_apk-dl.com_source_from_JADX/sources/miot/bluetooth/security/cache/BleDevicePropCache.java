...
public class BleDevicePropCache implements IBlePropCacher {
    ...
    public void reloadPropCache() {
        ...
        BluetoothLog.m7332v(String.format("BleDevicePropCache.reloadPropCache, tag = %s", new Object[]{prefsTag}));
        if (TextUtils.isEmpty(prefsTag)) {
            ...
            BluetoothLog.m7333w(String.format("BleDevicePropCache load takes %dms", new Object[]{Long.valueOf(System.currentTimeMillis() - currentTimeMillis)}));
        }
    }
