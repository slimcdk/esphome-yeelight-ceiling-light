...
public abstract class BleSecurityConnector implements ISecurityConnect {
    private final BleConnectResponse mBleConnectResponse = new BleConnectResponse() {
        public void onResponse(int i, Bundle bundle) {
            BluetoothLog.m7328d("connect onResponse: " + Code.toString(i));
            if (i == 0) {
                if (bundle != null) {
    ...
    private class ConnectReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent != null) {
                ...
                BluetoothLog.m7328d("onReceive: " + action);
    ...
    public void disconnect() {
        BluetoothLog.m7328d(getClass().getSimpleName() + ".disconnect");
        MiotBleClient.getInstance().disconnect(this.mLauncher.getDeviceMac());
    }

    /* access modifiers changed from: protected */
    public void dispatchResult(int i) {
        BluetoothLog.m7332v(String.format("%s.dispatchResult code = %s", new Object[]{getClass().getSimpleName(), Code.toString(i)}));
