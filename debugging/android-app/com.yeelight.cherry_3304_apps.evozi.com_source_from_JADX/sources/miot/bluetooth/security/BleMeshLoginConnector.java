...
public class BleMeshLoginConnector extends BleSecurityChipConnector {
    ...
    public void processStep2() {
        ...
        BluetoothLog.m10338v("BleMeshLoginConnector Process Step 2 ...");
        openAuthNotify(new BleNotifyResponse() {
            public void onNotify(UUID uuid, UUID uuid2, byte[] bArr) {
            }

            public void onResponse(int i) {
                BluetoothLog.m10338v("BleMeshLoginConnector Step 2 onResponse: " + Code.toString(i));
                if (i == 0) {
    ...
    public void processStep3() {
        ...
        BluetoothLog.m10338v("BleMeshLoginConnector Process Step 3 ...");
        MiotBleClient.getInstance().writeNoRsp(getMac(), BluetoothConstants.MISERVICE, BluetoothConstants.CHARACTER_AUTH, MESH_ADMIN_LOGIN_START, new BleWriteResponse() {
            public void onResponse(int i) {
                BluetoothLog.m10338v("BleMeshLoginConnector Step 3 onResponse: " + Code.toString(i));
                if (i == 0) {
    ...
    public void processStep4() {
        ...
        BluetoothLog.m10338v("BleMeshLoginConnector Process Step 4 ...");
        ...
        if (!writeChannel(SecurityChipUtil.getRawPublicKey(generateEcc256KeyPair.getPublic()), 3, new IResponse() {
            ...
            public void onResponse(int i, Bundle bundle) {
                BluetoothLog.m10338v("BleMeshLoginConnector Step 4 onResponse: " + Code.toString(i));
                if (i == 0) {
    ...
    private void processStep5(byte[] bArr) {
        ...
        BluetoothLog.m10338v("BleMeshLoginConnector Process Step 5 ...");
    ...
    private void processStep6(byte[] bArr) {
        ...
        BluetoothLog.m10338v("BleMeshLoginConnector Process Step 6 ...");
        if (bArr != null) {
            this.mHandler.removeMessages(4099);
            ...
            BluetoothLog.m10338v("BleMeshLoginConnector Process Step 6 encryptData is null ... ");
            i = -21;
        }
        dispatchResult(i);
    }
    ...
    private void processStep7(byte[] bArr) {
        ...
        BluetoothLog.m10338v("BleMeshLoginConnector Process Step 7 ..., value = " + ByteUtils.byteToString(bArr));
    ...
    public void processHandlerMessage(Message message) {
        if (message.what == 4099) {
            BluetoothLog.m10339w("BleMeshLoginConnector notify timeout");
            dispatchResult(-7);
        }
    }
    ...
    public void processStep1() {
        ...
        BluetoothLog.m10338v("BleMeshLoginConnector Process Step 1 ...");
        ...
        openSecureAuthNotify(new BleNotifyResponse() {
            ...
            public void onResponse(int i) {
                BluetoothLog.m10338v("BleMeshLoginConnector Step 1 onResponse: " + Code.toString(i));
                if (i == 0) {
