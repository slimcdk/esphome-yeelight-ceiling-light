...
import miot.bluetooth.security.encryption.Pack;
import miot.bluetooth.security.encryption.params.CipherParameters;
import miot.bluetooth.security.encryption.params.ParametersWithIV;
import miot.bluetooth.security.utils.Arrays;

public class SICBlockCipher extends StreamBlockCipher implements SkippingStreamCipher {

    /* renamed from: IV */
    private byte[] f23038IV;
    ...
    public SICBlockCipher(BlockCipher blockCipher) {
        ...
        this.f23038IV = new byte[blockSize2];
    ...
    private void checkCounter() {
        if (this.f23038IV.length < this.blockSize) {
            int i = 0;
            while (true) {
                byte[] bArr = this.f23038IV;
                if (i == bArr.length) {
                    return;
                }
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        if (cipherParameters instanceof ParametersWithIV) {
            ...
            if (i >= clone.length) {
                ...
                if (this.blockSize - this.f23038IV.length <= i2) {
