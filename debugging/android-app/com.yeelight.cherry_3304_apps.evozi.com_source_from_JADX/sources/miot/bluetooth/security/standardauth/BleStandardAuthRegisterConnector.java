...
public class BleStandardAuthRegisterConnector extends BleStandardAuthConnector {
        ...
        public void onResponse(int i, byte[] bArr) {
            if (i != 0) {
                ...
                if (!ByteUtils.isEmpty(BleStandardAuthRegisterConnector.this.mTempDeviceId) && !ByteUtils.byteEquals(BleStandardAuthRegisterConnector.this.mTempDeviceId, bArr)) {
                    BluetoothLog.m10335e("BleStandardAuthRegisterConnector device did don't match server did, device did = " + ByteUtils.byteToString(BleStandardAuthRegisterConnector.this.mTempDeviceId) + ", server did = " + ByteUtils.byteToString(bArr));
                }
                ...
                BluetoothLog.m10339w("BleStandardAuthRegisterConnector write Did to Device: " + ByteUtils.byteToString(fillBeforeBytes));
    ...
    private void applyDid(final BleReadResponse bleReadResponse) {
        BluetoothLog.m10338v("BleStandardAuthRegisterConnector applyDid");
        MiotBleClient.getInstance().getDeviceSN(getDidText(), getMac(), MiotBleClient.getInstance().getConfig().getModel(), getTokenText(), new ResponseHandler() {
            public void onFailure(int i, String str) {
                BluetoothLog.m10339w("BleStandardAuthRegisterConnector >>> getDeviceSN failed, code = " + i + ", description: " + str);
            ...
            public void onSuccess(org.json.JSONObject r3) {
                ...
                L_0x003a:
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: miot.bluetooth.security.standardauth.BleStandardAuthRegisterConnector.C117139.onSuccess(org.json.JSONObject):void");
            }
        });
    }
    ...
    public void bindDidToServer(final BleWriteResponse bleWriteResponse) {
        ...
        BluetoothLog.m10338v("BleStandardAuthRegisterConnector bindDidToServer start");
        MiotBleClient.getInstance().bindDeviceSN(getDidText(), getBeaconKeyText(), getTokenText(), new ResponseHandler() {
            public void onFailure(int i, String str) {
                BluetoothLog.m10338v("BleStandardAuthRegisterConnector bindDidToServer return failed: code=" + i + Constants.ACCEPT_TIME_SEPARATOR_SP + str);
            ...
            public void onSuccess(JSONObject jSONObject) {
                ...
                BluetoothLog.m10338v("BleStandardAuthRegisterConnector bindDidToServer return " + optBoolean);
    ...
    public void processStep1Plus() {
        ...
        BluetoothLog.m10338v("BleStandardAuthRegisterConnector Process Step 1 plus ...");
        openAuthNotify(new BleNotifyResponse() {
            public void onNotify(UUID uuid, UUID uuid2, byte[] bArr) {
            }

            public void onResponse(int i) {
                BluetoothLog.m10338v("BleStandardAuthRegisterConnector Step 1 plus onResponse: " + Code.toString(i));
                if (i == 0) {
    ...
    private void receiveDeviceResult(byte[] bArr) {
        ...
        BluetoothLog.m10338v("BleStandardAuthRegisterConnector receiveDeviceResult ..., value = " + ByteUtils.byteToString(bArr));
    ...
    private void recvDevConfirmation(byte[] bArr) {
        BluetoothLog.m10338v("BleStandardAuthRegisterConnector recvDevConfirmation ...");
    ...
    private void recvDevRandom(final byte[] bArr) {
        BluetoothLog.m10338v("BleStandardAuthRegisterConnector recvDevRandom ...");
        this.mHandler.removeMessages(MSG_NOTIFY_TIMEOUT);
        if (!writeChannel(this.mAppRandom, 11, new IResponse() {
            ...
            public void onResponse(int i, Bundle bundle) {
                BleStandardAuthRegisterConnector bleStandardAuthRegisterConnector;
                BleWriteResponse r0;
                BluetoothLog.m10338v("BleStandardAuthRegisterConnector recvDevRandom onResponse: " + Code.toString(i));
                if (i == 0) {
                    if (ByteUtils.isEmpty(BleStandardAuthRegisterConnector.this.mOOB)) {
                        BluetoothLog.m10338v("BleStandardAuthRegisterConnector recvDevRandom mOOB is empty");
                        bleStandardAuthRegisterConnector = BleStandardAuthRegisterConnector.this;
    ...
    private void recvDeviceInfo(byte[] bArr) {
        BluetoothLog.m10338v("BleStandardAuthRegisterConnector recvDeviceInfo ...");
        if (bArr.length >= 4) {
        ...
        BluetoothLog.m10335e("BleStandardAuthRegisterConnector recvDeviceInfo data format error");
        dispatchResult(-47);
    }

    private void recvDevicePubKey(byte[] bArr) {
        BluetoothLog.m10338v("BleStandardAuthRegisterConnector recvDevicePubKey ...");
        this.mHandler.removeMessages(MSG_NOTIFY_TIMEOUT);
    ...
    public void requestDeviceInfo() {
        ...
        BluetoothLog.m10338v("BleStandardAuthRegisterConnector requestDeviceInfo ...");
        MiotBleClient.getInstance().writeNoRsp(getMac(), BluetoothConstants.MISERVICE, BluetoothConstants.CHARACTER_AUTH, REQ_DEV_INFO, new BleWriteResponse() {
            public void onResponse(int i) {
                BluetoothLog.m10338v("BleStandardAuthRegisterConnector requestDeviceInfo onResponse: " + Code.toString(i));
                if (i == 0) {
                    BleStandardAuthRegisterConnector.this.mHandler.removeMessages(BleStandardAuthRegisterConnector.MSG_NOTIFY_TIMEOUT);
                    BleStandardAuthRegisterConnector.this.mHandler.sendEmptyMessageDelayed(BleStandardAuthRegisterConnector.MSG_NOTIFY_TIMEOUT, 10000);
                    return;
    ...
    private void sendAppConfirmation() {
        int i;
        BluetoothLog.m10338v("BleStandardAuthRegisterConnector sendAppConfirmation ...");
        if (isCanceled()) {
            i = -2;
        } else if (ByteUtils.isEmpty(this.mAppConfirmation)) {
            BluetoothLog.m10338v("BleStandardAuthRegisterConnector mAppConfirmation is null ...");
            i = -51;
            ...
            public void onResponse(int i, Bundle bundle) {
                BluetoothLog.m10338v("BleStandardAuthRegisterConnector sendAppConfirmation onResponse: " + Code.toString(i));
                if (i == 0) {
                    BleStandardAuthRegisterConnector.this.mHandler.removeMessages(BleStandardAuthRegisterConnector.MSG_NOTIFY_TIMEOUT);
                    BleStandardAuthRegisterConnector.this.mHandler.sendEmptyMessageDelayed(BleStandardAuthRegisterConnector.MSG_NOTIFY_TIMEOUT, 10000);
                    return;
    ...
    public void sendAppPublicKey() {
        ...
        BluetoothLog.m10338v("BleStandardAuthRegisterConnector sendAppPublicKey ...");
        ...
        if (!writeChannel(SecurityChipUtil.getRawPublicKey(generateEcc256KeyPair.getPublic()), 3, new IResponse() {
            ...
            public void onResponse(int i, Bundle bundle) {
                BluetoothLog.m10338v("BleStandardAuthRegisterConnector sendAppPublicKey onResponse: " + Code.toString(i));
                if (i == 0) {
                    BleStandardAuthRegisterConnector.this.mHandler.removeMessages(BleStandardAuthRegisterConnector.MSG_NOTIFY_TIMEOUT);
                    BleStandardAuthRegisterConnector.this.mHandler.sendEmptyMessageDelayed(BleStandardAuthRegisterConnector.MSG_NOTIFY_TIMEOUT, 10000);
                    return;
    ...
    private void sendRegStart(byte[] bArr) {
        ...
        bArr2[1] = bArr[0];
        bArr2[2] = bArr[1];
        BluetoothLog.m10338v("BleStandardAuthRegisterConnector sendRegStart ...");
        MiotBleClient.getInstance().writeNoRsp(getMac(), BluetoothConstants.MISERVICE, BluetoothConstants.CHARACTER_AUTH, bArr2, new BleWriteResponse() {
            public void onResponse(int i) {
                BluetoothLog.m10338v("BleStandardAuthRegisterConnector sendRegStart onResponse: " + Code.toString(i));
                if (i == 0) {
    ...
    public void startBindAfterAuthSuccess() {
        BluetoothLog.m10338v("BleStandardAuthRegisterConnector startBindAfterAuthSuccess");
    ...
    private void verifyDeviceParams() {
        ...
        int i;
        String str;
        BluetoothLog.m10338v("BleStandardAuthRegisterConnector verifyDeviceParams ...");
            ...
            if (secret == null) {
                ...
                if (this.mInputCapability != 0) {
                    ...
                    if (i2 == 0) {
                        ...
                        BluetoothLog.m10338v("BleStandardAuthRegisterConnector  get qrcode oob failed");
                        dispatchResult(-50);
                        return;
                    } else {
                        this.mOOB = new byte[16];
    ...
    public void writeBindResultToDevice(boolean z, BleWriteResponse bleWriteResponse) {
        ...
        BluetoothLog.m10339w(String.format("BleStandardAuthRegisterConnector writeBindResultToDevice : %s", new Object[]{ByteUtils.byteToString(bArr)}));
    ...
    public void writeDidToDevice(byte[] bArr, final BleWriteResponse bleWriteResponse) {
        ...
        if (isCanceled()) {
            ...
            if (bArr2 == null) {
                BluetoothLog.m10335e("BleStandardAuthRegisterConnector encrypt did failed");
                i = -51;
            } else {
                BluetoothLog.m10338v("BleStandardAuthRegisterConnector start writeDidToDevice");
                if (!writeChannel(bArr2, 0, new IResponse() {
                    ...
                    public void onResponse(int i, Bundle bundle) {
                        BluetoothLog.m10338v("BleStandardAuthRegisterConnector writeDidToDevice onResponse: " + Code.toString(i));
                        BleWriteResponse bleWriteResponse = bleWriteResponse;
    ...
    public void processHandlerMessage(Message message) {
        if (message.what == MSG_NOTIFY_TIMEOUT) {
            BluetoothLog.m10339w("BleStandardAuthRegisterConnector notify timeout");
            dispatchResult(-7);
        }
    }
    ...
    public void processStep1() {
        ...
        BluetoothLog.m10338v("BleStandardAuthRegisterConnector Process Step 1 ...");
        ...
        openStandardAuthNotify(new BleNotifyResponse() {
            ...
            public void onResponse(int i) {
                BluetoothLog.m10338v("BleStandardAuthRegisterConnector Step 1 onResponse: " + Code.toString(i));
                if (i == 0) {
