...
public class ECCPointConvert {
    ...
    public static ECPublicKey fromUncompressedPoint(byte[] bArr, ECParameterSpec eCParameterSpec) {
        if (bArr[0] == 4) {
    ...
    public static byte[] privateKeyToBytes(ECPrivateKey eCPrivateKey) {
    ...
    public static byte[] publicKeyToBytes(ECPublicKey eCPublicKey) {
