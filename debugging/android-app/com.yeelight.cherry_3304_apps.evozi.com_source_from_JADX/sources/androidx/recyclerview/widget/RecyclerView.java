...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    public static abstract class LayoutManager {
        ...
        public static Properties getProperties(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i2) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0309R.styleable.RecyclerView, i, i2);
            properties.orientation = obtainStyledAttributes.getInt(C0309R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = obtainStyledAttributes.getInt(C0309R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = obtainStyledAttributes.getBoolean(C0309R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = obtainStyledAttributes.getBoolean(C0309R.styleable.RecyclerView_stackFromEnd, false);
        ...
        public void offsetChildrenHorizontal(@C0034Px int i) {
            RecyclerView recyclerView = this.mRecyclerView;
            if (recyclerView != null) {
        ...
        public void offsetChildrenVertical(@C0034Px int i) {
            RecyclerView recyclerView = this.mRecyclerView;
            if (recyclerView != null) {
    ...
    public static abstract class SmoothScroller {
        ...
        public static class Action {
            ...
            public Action(@C0034Px int i, @C0034Px int i2) {
                this(i, i2, Integer.MIN_VALUE, (Interpolator) null);
            }

            public Action(@C0034Px int i, @C0034Px int i2, int i3) {
                this(i, i2, i3, (Interpolator) null);
            }

            public Action(@C0034Px int i, @C0034Px int i2, int i3, @Nullable Interpolator interpolator) {
                ...
                if (i >= 0) {
                    ...
                    if (interpolator == null) {
                        ...
                        if (i2 == Integer.MIN_VALUE) {
                            ...
                            viewFlinger.smoothScrollBy(this.mDx, this.mDy, i2);
                        }
                    } else {
            ...
            public void setDx(@C0034Px int i) {
                this.mChanged = true;
                this.mDx = i;
            }

            public void setDy(@C0034Px int i) {
                this.mChanged = true;
                this.mDy = i;
            }
            ...
            public void update(@C0034Px int i, @C0034Px int i2, int i3, @Nullable Interpolator interpolator) {
                this.mDx = i;
                this.mDy = i2;
                this.mDuration = i3;
                this.mInterpolator = interpolator;
        ...
        /* access modifiers changed from: protected */
        public abstract void onSeekTargetStep(@C0034Px int i, @C0034Px int i2, @NonNull State state, @NonNull Action action);
    ...
    class ViewFlinger implements Runnable {
        ...
        public void run() {
            ...
            L_0x004f:
                androidx.recyclerview.widget.RecyclerView r3 = androidx.recyclerview.widget.RecyclerView.this
                androidx.recyclerview.widget.RecyclerView$Adapter r5 = r3.mAdapter
            ...
            L_0x0160:
                r22.postOnAnimation()
                androidx.recyclerview.widget.RecyclerView r1 = androidx.recyclerview.widget.RecyclerView.this
                androidx.recyclerview.widget.GapWorker r3 = r1.mGapWorker
                if (r3 == 0) goto L_0x0183
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes2 = context.obtainStyledAttributes(attributeSet, C0309R.styleable.RecyclerView, i, 0);
            String string = obtainStyledAttributes2.getString(C0309R.styleable.RecyclerView_layoutManager);
            if (obtainStyledAttributes2.getInt(C0309R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            boolean z2 = obtainStyledAttributes2.getBoolean(C0309R.styleable.RecyclerView_fastScrollEnabled, false);
            this.mEnableFastScroller = z2;
            if (z2) {
                initFastScroller((StateListDrawable) obtainStyledAttributes2.getDrawable(C0309R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), obtainStyledAttributes2.getDrawable(C0309R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) obtainStyledAttributes2.getDrawable(C0309R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), obtainStyledAttributes2.getDrawable(C0309R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
    ...
    public void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        ...
        new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C0309R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0309R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0309R.dimen.fastscroll_margin));
    }
    ...
    public void onScrolled(@C0034Px int i, @C0034Px int i2) {
    }
    ...
    public void smoothScrollBy(@C0034Px int i, @C0034Px int i2) {
        smoothScrollBy(i, i2, (Interpolator) null);
    }

    public void smoothScrollBy(@C0034Px int i, @C0034Px int i2, @Nullable Interpolator interpolator) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager != null && !this.mLayoutFrozen) {
