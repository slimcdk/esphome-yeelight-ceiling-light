...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements ItemTouchHelper.ViewDropHandler, RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    static class LayoutState {
        ...
        /* access modifiers changed from: package-private */
        public void log() {
            "avail:" + this.mAvailable + ", ind:" + this.mCurrentPosition + ", dir:" + this.mItemDirection + ", offset:" + this.mOffset + ", layoutDir:" + this.mLayoutDirection;
        }
    ...
    private void logChildren() {
        for (int i = 0; i < getChildCount(); i++) {
            ...
            "item " + getPosition(childAt) + ", coord:" + this.mOrientationHelper.getDecoratedStart(childAt);
        }
    }
    ...
    private void recycleByLayoutState(RecyclerView.Recycler recycler, LayoutState layoutState) {
        if (layoutState.mRecycle && !layoutState.mInfinite) {
            ...
            if (i == -1) {
                recycleViewsFromEnd(recycler, i2);
            } else {
                recycleViewsFromStart(recycler, i2);
            }
        }
    }
    ...
    public void validateChildOrder() {
        "validating child count " + getChildCount();
        boolean z = true;
        if (getChildCount() >= 1) {
            int position = getPosition(getChildAt(0));
