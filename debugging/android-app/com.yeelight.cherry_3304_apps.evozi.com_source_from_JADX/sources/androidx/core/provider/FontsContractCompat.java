...
public class FontsContractCompat {
    ...
    private static final Comparator<byte[]> sByteArrayComparator = new Comparator<byte[]>() {
        ...
        public int compare(byte[] r5, byte[] r6) {
            ...
            L_0x001b:
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.core.provider.FontsContractCompat.C01725.compare(byte[], byte[]):int");
        }
    };
    ...
    public static class FontInfo {
        ...
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
        public FontInfo(@NonNull Uri uri, @IntRange(from = 0) int i, @IntRange(from = 1, mo617to = 1000) int i2, boolean z, int i3) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:36:0x0089, code lost:
        sBackgroundThread.postAndReply(r1, new androidx.core.provider.FontsContractCompat.C01613());
     */
    ...
    public static android.graphics.Typeface getFontSync(final android.content.Context r2, final androidx.core.provider.FontRequest r3, @androidx.annotation.Nullable final androidx.core.content.res.ResourcesCompat.FontCallback r4, @androidx.annotation.Nullable final android.os.Handler r5, boolean r6, int r7, final int r8) {
        ...
        L_0x005f:
            ...
            monitor-enter(r4)
            androidx.collection.SimpleArrayMap<java.lang.String, java.util.ArrayList<androidx.core.provider.SelfDestructiveThread$ReplyCallback<androidx.core.provider.FontsContractCompat$TypefaceResult>>> r5 = sPendingReplies     // Catch:{ all -> 0x0094 }
        ...
        L_0x0079:
            ...
            r5.add(r3)     // Catch:{ all -> 0x0094 }
            androidx.collection.SimpleArrayMap<java.lang.String, java.util.ArrayList<androidx.core.provider.SelfDestructiveThread$ReplyCallback<androidx.core.provider.FontsContractCompat$TypefaceResult>>> r3 = sPendingReplies     // Catch:{ all -> 0x0094 }
