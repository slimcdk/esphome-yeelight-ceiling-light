...
final class LocaleListHelper {
    ...
    LocaleListHelper(@NonNull Locale locale, LocaleListHelper localeListHelper) {
        if (locale != null) {
            ...
            if (i == -1) {
                ...
                while (i3 < i) {
                    int i5 = i3 + 1;
                    localeArr[i5] = (Locale) localeListHelper.mList[i3].clone();
                    i3 = i5;
                }
    ...
    private int computeFirstMatchIndex(java.util.Collection<java.lang.String> r5, boolean r6) {
        ...
        L_0x0025:
            ...
            java.util.Locale r1 = androidx.core.p005os.LocaleHelper.forLanguageTag(r1)
        ...
        L_0x0043:
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.core.p005os.LocaleListHelper.computeFirstMatchIndex(java.util.Collection, boolean):int");
    }
