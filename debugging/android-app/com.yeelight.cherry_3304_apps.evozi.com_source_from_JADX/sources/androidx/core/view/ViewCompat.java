...
public class ViewCompat {
    ...
    static class UnhandledKeyEventManager {
        ...
        static UnhandledKeyEventManager m4at(View view) {
            UnhandledKeyEventManager unhandledKeyEventManager = (UnhandledKeyEventManager) view.getTag(C0147R.C0149id.tag_unhandled_key_event_manager);
            if (unhandledKeyEventManager != null) {
                return unhandledKeyEventManager;
            }
            UnhandledKeyEventManager unhandledKeyEventManager2 = new UnhandledKeyEventManager();
            view.setTag(C0147R.C0149id.tag_unhandled_key_event_manager, unhandledKeyEventManager2);
        ...
        private boolean onUnhandledKeyEvent(@NonNull View view, @NonNull KeyEvent keyEvent) {
            ArrayList arrayList = (ArrayList) view.getTag(C0147R.C0149id.tag_unhandled_key_listeners);
            if (arrayList == null) {
                return false;
            }
    ...
    public static void addOnUnhandledKeyEventListener(@NonNull View view, @NonNull OnUnhandledKeyEventListenerCompat onUnhandledKeyEventListenerCompat) {
        if (Build.VERSION.SDK_INT >= 28) {
            Map map = (Map) view.getTag(C0147R.C0149id.tag_unhandled_key_listeners);
            if (map == null) {
                map = new ArrayMap();
                view.setTag(C0147R.C0149id.tag_unhandled_key_listeners, map);
            }
        ...
        if (arrayList == null) {
            ...
            view.setTag(C0147R.C0149id.tag_unhandled_key_listeners, arrayList);
        }
    ...
    @Deprecated
    public static void setAlpha(View view, @FloatRange(from = 0.0d, mo599to = 1.0d) float f) {
        view.setAlpha(f);
    }
    ...
    public static void setPaddingRelative(@NonNull View view, @C0034Px int i, @C0034Px int i2, @C0034Px int i3, @C0034Px int i4) {
        if (Build.VERSION.SDK_INT >= 17) {
