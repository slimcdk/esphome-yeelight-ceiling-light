...
public final class AppCompatDrawableManager {
    private static final int[] COLORFILTER_COLOR_BACKGROUND_MULTIPLY = {C0035R.C0036drawable.abc_popup_background_mtrl_mult, C0035R.C0036drawable.abc_cab_background_internal_bg, C0035R.C0036drawable.abc_menu_hardkey_panel_mtrl_mult};
    private static final int[] COLORFILTER_COLOR_CONTROL_ACTIVATED = {C0035R.C0036drawable.abc_textfield_activated_mtrl_alpha, C0035R.C0036drawable.abc_textfield_search_activated_mtrl_alpha, C0035R.C0036drawable.abc_cab_background_top_mtrl_alpha, C0035R.C0036drawable.abc_text_cursor_material, C0035R.C0036drawable.abc_text_select_handle_left_mtrl_dark, C0035R.C0036drawable.abc_text_select_handle_middle_mtrl_dark, C0035R.C0036drawable.abc_text_select_handle_right_mtrl_dark, C0035R.C0036drawable.abc_text_select_handle_left_mtrl_light, C0035R.C0036drawable.abc_text_select_handle_middle_mtrl_light, C0035R.C0036drawable.abc_text_select_handle_right_mtrl_light};
    private static final int[] COLORFILTER_TINT_COLOR_CONTROL_NORMAL = {C0035R.C0036drawable.abc_textfield_search_default_mtrl_alpha, C0035R.C0036drawable.abc_textfield_default_mtrl_alpha, C0035R.C0036drawable.abc_ab_share_pack_mtrl_alpha};
    ...
    private static final int[] TINT_CHECKABLE_BUTTON_LIST = {C0035R.C0036drawable.abc_btn_check_material, C0035R.C0036drawable.abc_btn_radio_material};
    private static final int[] TINT_COLOR_CONTROL_NORMAL = {C0035R.C0036drawable.abc_ic_commit_search_api_mtrl_alpha, C0035R.C0036drawable.abc_seekbar_tick_mark_material, C0035R.C0036drawable.abc_ic_menu_share_mtrl_alpha, C0035R.C0036drawable.abc_ic_menu_copy_mtrl_am_alpha, C0035R.C0036drawable.abc_ic_menu_cut_mtrl_alpha, C0035R.C0036drawable.abc_ic_menu_selectall_mtrl_alpha, C0035R.C0036drawable.abc_ic_menu_paste_mtrl_am_alpha};
    private static final int[] TINT_COLOR_CONTROL_STATE_LIST = {C0035R.C0036drawable.abc_tab_indicator_material, C0035R.C0036drawable.abc_textfield_search_material};
    ...
    private void checkVectorDrawableSetup(@NonNull Context context) {
        if (!this.mHasCheckedVectorDrawableSetup) {
            ...
            Drawable drawable = getDrawable(context, C0035R.C0036drawable.abc_vector_test);
    ...
    private ColorStateList createButtonColorStateList(@NonNull Context context, @ColorInt int i) {
        int themeAttrColor = ThemeUtils.getThemeAttrColor(context, C0035R.attr.colorControlHighlight);
        int disabledThemeAttrColor = ThemeUtils.getDisabledThemeAttrColor(context, C0035R.attr.colorButtonNormal);
    ...
    private ColorStateList createColoredButtonColorStateList(@NonNull Context context) {
        return createButtonColorStateList(context, ThemeUtils.getThemeAttrColor(context, C0035R.attr.colorAccent));
    }

    private ColorStateList createDefaultButtonColorStateList(@NonNull Context context) {
        return createButtonColorStateList(context, ThemeUtils.getThemeAttrColor(context, C0035R.attr.colorButtonNormal));
    }
    ...
    private Drawable createDrawableIfNeeded(@NonNull Context context, @DrawableRes int i) {
        ...
        if (i == C0035R.C0036drawable.abc_cab_background_top_material) {
            cachedDrawable = new LayerDrawable(new Drawable[]{getDrawable(context, C0035R.C0036drawable.abc_cab_background_internal_bg), getDrawable(context, C0035R.C0036drawable.abc_cab_background_top_mtrl_alpha)});
        }
        if (cachedDrawable != null) {
    ...
    private ColorStateList createSwitchThumbColorStateList(Context context) {
        int[][] iArr = new int[3][];
        int[] iArr2 = new int[3];
        ColorStateList themeAttrColorStateList = ThemeUtils.getThemeAttrColorStateList(context, C0035R.attr.colorSwitchThumbNormal);
        if (themeAttrColorStateList == null || !themeAttrColorStateList.isStateful()) {
            iArr[0] = ThemeUtils.DISABLED_STATE_SET;
            iArr2[0] = ThemeUtils.getDisabledThemeAttrColor(context, C0035R.attr.colorSwitchThumbNormal);
            iArr[1] = ThemeUtils.CHECKED_STATE_SET;
            iArr2[1] = ThemeUtils.getThemeAttrColor(context, C0035R.attr.colorControlActivated);
            iArr[2] = ThemeUtils.EMPTY_STATE_SET;
            iArr2[2] = ThemeUtils.getThemeAttrColor(context, C0035R.attr.colorSwitchThumbNormal);
        } else {
            iArr[0] = ThemeUtils.DISABLED_STATE_SET;
    ...
    static PorterDuff.Mode getTintMode(int i) {
        if (i == C0035R.C0036drawable.abc_switch_thumb_material) {
    ...
    private android.graphics.drawable.Drawable loadDrawableFromDelegates(@androidx.annotation.NonNull android.content.Context r11, @androidx.annotation.DrawableRes int r12) {
        ...
        L_0x0071:
            ...
            androidx.collection.ArrayMap<java.lang.String, androidx.appcompat.widget.AppCompatDrawableManager$InflateDelegate> r8 = r10.mDelegates     // Catch:{ Exception -> 0x00a2 }
            java.lang.Object r3 = r8.get(r3)     // Catch:{ Exception -> 0x00a2 }
            androidx.appcompat.widget.AppCompatDrawableManager$InflateDelegate r3 = (androidx.appcompat.widget.AppCompatDrawableManager.InflateDelegate) r3     // Catch:{ Exception -> 0x00a2 }
    ...
    private Drawable tintDrawable(@NonNull Context context, @DrawableRes int i, boolean z, @NonNull Drawable drawable) {
        ...
        if (i == C0035R.C0036drawable.abc_seekbar_track_material) {
            layerDrawable = (LayerDrawable) drawable;
            setPorterDuffColorFilter(layerDrawable.findDrawableByLayerId(16908288), ThemeUtils.getThemeAttrColor(context, C0035R.attr.colorControlNormal), DEFAULT_MODE);
            findDrawableByLayerId = layerDrawable.findDrawableByLayerId(16908303);
            i2 = C0035R.attr.colorControlNormal;
        } else if (i == C0035R.C0036drawable.abc_ratingbar_material || i == C0035R.C0036drawable.abc_ratingbar_indicator_material || i == C0035R.C0036drawable.abc_ratingbar_small_material) {
            layerDrawable = (LayerDrawable) drawable;
            setPorterDuffColorFilter(layerDrawable.findDrawableByLayerId(16908288), ThemeUtils.getDisabledThemeAttrColor(context, C0035R.attr.colorControlNormal), DEFAULT_MODE);
            findDrawableByLayerId = layerDrawable.findDrawableByLayerId(16908303);
            i2 = C0035R.attr.colorControlActivated;
        ...
        setPorterDuffColorFilter(layerDrawable.findDrawableByLayerId(16908301), ThemeUtils.getThemeAttrColor(context, C0035R.attr.colorControlActivated), DEFAULT_MODE);
        return drawable;
    }
    ...
    static boolean tintDrawableUsingColorFilter(@androidx.annotation.NonNull android.content.Context r6, @androidx.annotation.DrawableRes int r7, @androidx.annotation.NonNull android.graphics.drawable.Drawable r8) {
        /*
            ...
            int r2 = androidx.appcompat.C0035R.attr.colorControlNormal
        L_0x0012:
            r7 = -1
        L_0x0013:
            r1 = 1
        ...
        L_0x0015:
            ...
            int r2 = androidx.appcompat.C0035R.attr.colorControlActivated
            goto L_0x0012
        L_0x0020:
            ...
            goto L_0x0012
        L_0x002b:
            int r1 = androidx.appcompat.C0035R.C0036drawable.abc_list_divider_mtrl_alpha
            ...
            goto L_0x0013
        L_0x003a:
            int r1 = androidx.appcompat.C0035R.C0036drawable.abc_dialog_material_background
    ...
    public synchronized android.content.res.ColorStateList getTintList(@androidx.annotation.NonNull android.content.Context r3, @androidx.annotation.DrawableRes int r4) {
        /*
            r2 = this;
            monitor-enter(r2)
            android.content.res.ColorStateList r0 = r2.getTintListFromCache(r3, r4)     // Catch:{ all -> 0x007d }
            if (r0 != 0) goto L_0x007b
            int r1 = androidx.appcompat.C0035R.C0036drawable.abc_edit_text_material     // Catch:{ all -> 0x007d }
            if (r4 != r1) goto L_0x0013
            int r0 = androidx.appcompat.C0035R.color.abc_tint_edittext     // Catch:{ all -> 0x007d }
        L_0x000d:
            android.content.res.ColorStateList r0 = androidx.appcompat.content.res.AppCompatResources.getColorStateList(r3, r0)     // Catch:{ all -> 0x007d }
            goto L_0x0076
        L_0x0013:
            int r1 = androidx.appcompat.C0035R.C0036drawable.abc_switch_track_mtrl_alpha     // Catch:{ all -> 0x007d }
            if (r4 != r1) goto L_0x001a
            int r0 = androidx.appcompat.C0035R.color.abc_tint_switch_track     // Catch:{ all -> 0x007d }
            goto L_0x000d
        L_0x001a:
            int r1 = androidx.appcompat.C0035R.C0036drawable.abc_switch_thumb_material     // Catch:{ all -> 0x007d }
            if (r4 != r1) goto L_0x0023
            android.content.res.ColorStateList r0 = r2.createSwitchThumbColorStateList(r3)     // Catch:{ all -> 0x007d }
            goto L_0x0076
        L_0x0023:
            int r1 = androidx.appcompat.C0035R.C0036drawable.abc_btn_default_mtrl_shape     // Catch:{ all -> 0x007d }
            if (r4 != r1) goto L_0x002c
            android.content.res.ColorStateList r0 = r2.createDefaultButtonColorStateList(r3)     // Catch:{ all -> 0x007d }
            goto L_0x0076
        L_0x002c:
            int r1 = androidx.appcompat.C0035R.C0036drawable.abc_btn_borderless_material     // Catch:{ all -> 0x007d }
            if (r4 != r1) goto L_0x0035
            android.content.res.ColorStateList r0 = r2.createBorderlessButtonColorStateList(r3)     // Catch:{ all -> 0x007d }
            goto L_0x0076
        L_0x0035:
            int r1 = androidx.appcompat.C0035R.C0036drawable.abc_btn_colored_material     // Catch:{ all -> 0x007d }
            if (r4 != r1) goto L_0x003e
            android.content.res.ColorStateList r0 = r2.createColoredButtonColorStateList(r3)     // Catch:{ all -> 0x007d }
            goto L_0x0076
        L_0x003e:
            int r1 = androidx.appcompat.C0035R.C0036drawable.abc_spinner_mtrl_am_alpha     // Catch:{ all -> 0x007d }
            if (r4 == r1) goto L_0x0073
            int r1 = androidx.appcompat.C0035R.C0036drawable.abc_spinner_textfield_background_material     // Catch:{ all -> 0x007d }
            if (r4 != r1) goto L_0x0047
            goto L_0x0073
        L_0x0047:
            int[] r1 = TINT_COLOR_CONTROL_NORMAL     // Catch:{ all -> 0x007d }
            boolean r1 = arrayContains(r1, r4)     // Catch:{ all -> 0x007d }
            if (r1 == 0) goto L_0x0056
            int r0 = androidx.appcompat.C0035R.attr.colorControlNormal     // Catch:{ all -> 0x007d }
            android.content.res.ColorStateList r0 = androidx.appcompat.widget.ThemeUtils.getThemeAttrColorStateList(r3, r0)     // Catch:{ all -> 0x007d }
            goto L_0x0076
        L_0x0056:
            int[] r1 = TINT_COLOR_CONTROL_STATE_LIST     // Catch:{ all -> 0x007d }
            boolean r1 = arrayContains(r1, r4)     // Catch:{ all -> 0x007d }
            if (r1 == 0) goto L_0x0061
            int r0 = androidx.appcompat.C0035R.color.abc_tint_default     // Catch:{ all -> 0x007d }
            goto L_0x000d
        L_0x0061:
            int[] r1 = TINT_CHECKABLE_BUTTON_LIST     // Catch:{ all -> 0x007d }
            boolean r1 = arrayContains(r1, r4)     // Catch:{ all -> 0x007d }
            if (r1 == 0) goto L_0x006c
            int r0 = androidx.appcompat.C0035R.color.abc_tint_btn_checkable     // Catch:{ all -> 0x007d }
            goto L_0x000d
        L_0x006c:
            int r1 = androidx.appcompat.C0035R.C0036drawable.abc_seekbar_thumb_material     // Catch:{ all -> 0x007d }
            if (r4 != r1) goto L_0x0076
            int r0 = androidx.appcompat.C0035R.color.abc_tint_seek_thumb     // Catch:{ all -> 0x007d }
            goto L_0x000d
        L_0x0073:
            int r0 = androidx.appcompat.C0035R.color.abc_tint_spinner     // Catch:{ all -> 0x007d }
            goto L_0x000d
        L_0x0076:
            if (r0 == 0) goto L_0x007b
            r2.addTintListToCache(r3, r4, r0)     // Catch:{ all -> 0x007d }
        L_0x007b:
            monitor-exit(r2)
            return r0
        L_0x007d:
