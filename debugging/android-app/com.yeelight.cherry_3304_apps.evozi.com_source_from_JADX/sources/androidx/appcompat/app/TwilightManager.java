...
class TwilightManager {
    ...
    private void updateState(@NonNull Location location) {
        ...
        twilightCalculator.calculateTwilight(currentTimeMillis - MiStatInterface.MAX_UPLOAD_INTERVAL, location.getLatitude(), location.getLongitude());
        ...
        long j6 = j3;
        boolean z2 = z;
        instance.calculateTwilight(MiStatInterface.MAX_UPLOAD_INTERVAL + currentTimeMillis, location.getLatitude(), location.getLongitude());
        long j7 = instance.sunrise;
        if (j6 == -1 || j5 == -1) {
            j = 43200000 + currentTimeMillis;
        } else {
            j = (currentTimeMillis > j5 ? 0 + j7 : currentTimeMillis > j6 ? 0 + j5 : 0 + j6) + MiStatInterface.MIN_UPLOAD_INTERVAL;
        }
