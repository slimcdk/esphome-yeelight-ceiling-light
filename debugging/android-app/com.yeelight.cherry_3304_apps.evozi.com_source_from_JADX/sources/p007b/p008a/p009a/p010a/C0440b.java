...
class C0440b {
    ...
    /* renamed from: a */
    public void mo8322a(int i, int i2, double[] dArr, double[] dArr2, double[] dArr3, int i3) {
        int i4 = i;
        int i5 = i2;
    ...
    /* access modifiers changed from: package-private */
    /* renamed from: b */
    public void mo8323b(int i, int i2, double[] dArr, double[] dArr2, double[] dArr3, int i3) {
        int i4 = i;
        int i5 = i2;
        int i6 = i3 + i4;
    ...
    /* access modifiers changed from: package-private */
    /* renamed from: c */
    public void mo8324c(int i, int i2, double[] dArr, double[] dArr2, double[] dArr3, int i3) {
        int i4 = i;
        int i5 = i2;
        int i6 = i3 + i4;
        int i7 = i6 + i4;
    ...
    /* access modifiers changed from: package-private */
    /* renamed from: d */
    public void mo8325d(int i, int i2, double[] dArr, double[] dArr2, double[] dArr3, int i3) {
        int i4 = i;
        int i5 = i2;
        int i6 = i3 + i4;
        int i7 = i6 + i4;
    ...
    /* access modifiers changed from: package-private */
    /* renamed from: e */
    public void mo8326e(int i, int i2, int i3, int i4, double[] dArr, double[] dArr2, double[] dArr3, double[] dArr4, double[] dArr5, double[] dArr6, int i5) {
        int i6 = i;
        int i7 = i2;
        int i8 = i3;
        int i9 = i4;
    ...
    /* access modifiers changed from: package-private */
    /* renamed from: f */
    public void mo8327f(int i, double[] dArr, double[] dArr2) {
        if (i != 1) {
            mo8328g(i, dArr, dArr2, 0);
        }
    }

    /* access modifiers changed from: package-private */
    /* renamed from: g */
    public void mo8328g(int i, double[] dArr, double[] dArr2, int i2) {
        int i3;
        int i4;
        int i5 = i;
        double[] dArr3 = dArr2;
        ...
        while (i13 <= i8) {
            ...
            if (i14 == 4) {
                ...
                int i21 = i15;
                if (i19 == 0) {
                    mo8324c(i20, i21, dArr, dArr4, dArr2, i18);
                } else {
                    mo8324c(i20, i21, dArr4, dArr, dArr2, i18);
                }
            } else if (i14 == 2) {
                int i22 = i16;
                int i23 = i15;
                if (i19 == 0) {
                    mo8322a(i22, i23, dArr, dArr4, dArr2, i18);
                } else {
                    mo8322a(i22, i23, dArr4, dArr, dArr2, i18);
                }
            } else if (i14 == 3) {
                int i24 = i16;
                int i25 = i15;
                if (i19 == 0) {
                    mo8323b(i24, i25, dArr, dArr4, dArr2, i18);
                } else {
                    mo8323b(i24, i25, dArr4, dArr, dArr2, i18);
                }
            } else if (i14 == 5) {
                int i26 = i16;
                int i27 = i15;
                if (i19 == 0) {
                    mo8325d(i26, i27, dArr, dArr4, dArr2, i18);
                } else {
                    mo8325d(i26, i27, dArr4, dArr, dArr2, i18);
                }
            } else {
                if (i16 == i10) {
                    i19 = 1 - i19;
                ...
                if (i19 == 0) {
                    i4 = i13;
                    i3 = i8;
                    mo8326e(i16, i14, i15, i17, dArr, dArr, dArr, dArr4, dArr4, dArr2, i18);
                    i12 = 1;
                } else {
                    i4 = i13;
                    i3 = i8;
                    mo8326e(i16, i14, i15, i17, dArr4, dArr4, dArr4, dArr, dArr, dArr2, i18);
                    i12 = 0;
                }
                i13 = i4 + 1;
                dArr3 = dArr2;
    ...
    /* access modifiers changed from: package-private */
    /* renamed from: h */
    public void mo8329h(int i, double[] dArr) {
        if (i != 1) {
            mo8330i(i, dArr, 0);
        }
    }
    ...
    /* access modifiers changed from: package-private */
    /* renamed from: i */
    public void mo8330i(int i, double[] dArr, int i2) {
        int i3;
        int i4;
        int i5 = i;
        int[] iArr = {4, 2, 3, 5};
