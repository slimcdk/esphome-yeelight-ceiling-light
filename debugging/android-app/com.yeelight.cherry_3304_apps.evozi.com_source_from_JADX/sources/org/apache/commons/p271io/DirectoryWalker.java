...
public abstract class DirectoryWalker<T> {
    ...
    protected DirectoryWalker(IOFileFilter iOFileFilter, IOFileFilter iOFileFilter2, int i) {
        ...
        if (iOFileFilter == null && iOFileFilter2 == null) {
            ...
            or = FileFilterUtils.m30463or(FileFilterUtils.makeDirectoryOnly(iOFileFilter == null ? TrueFileFilter.TRUE : iOFileFilter), FileFilterUtils.makeFileOnly(iOFileFilter2 == null ? TrueFileFilter.TRUE : iOFileFilter2));
        }
        this.filter = or;
        this.depthLimit = i;
    }
