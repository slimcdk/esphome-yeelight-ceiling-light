...
public class Table {
    public static final ThreadLocal<Charset> UTF8_CHARSET = new C3321a();

    /* renamed from: bb */
    protected ByteBuffer f6424bb;
    ...
    public int __indirect(int i) {
        return i + this.f6424bb.getInt(i);
    }

    /* access modifiers changed from: protected */
    public int __offset(int i) {
        if (i < this.vtable_size) {
            return this.f6424bb.getShort(this.vtable_start + i);
        }
        return 0;
    }
    ...
    public String __string(int i) {
        int i2 = i + this.f6424bb.getInt(i);
        return this.utf8.decodeUtf8(this.f6424bb, i2 + 4, this.f6424bb.getInt(i2));
    }

    /* access modifiers changed from: protected */
    public Table __union(Table table, int i) {
        int i2 = i + this.bb_pos;
        int i3 = i2 + this.f6424bb.getInt(i2);
        table.bb_pos = i3;
        table.f6424bb = this.f6424bb;
        int i4 = i3 - this.f6424bb.getInt(i3);
        table.vtable_start = i4;
        table.vtable_size = this.f6424bb.getShort(i4);
        return table;
    }
    ...
    public int __vector(int i) {
        int i2 = i + this.bb_pos;
        return i2 + this.f6424bb.getInt(i2) + 4;
    }
    ...
    public ByteBuffer __vector_as_bytebuffer(int i, int i2) {
        ...
        ByteBuffer order = this.f6424bb.duplicate().order(ByteOrder.LITTLE_ENDIAN);
    ...
    public int __vector_len(int i) {
        int i2 = i + this.bb_pos;
        return this.f6424bb.getInt(i2 + this.f6424bb.getInt(i2));
    }
    ...
    public void sortTables(int[] iArr, ByteBuffer byteBuffer) {
        ...
        Arrays.sort(numArr, new C3322b(this, byteBuffer));
