...
public final class Utf8Safe extends Utf8 {
    ...
    static class C3320a extends IllegalArgumentException {
        /* JADX WARNING: Illegal instructions before constructor call */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        C3320a(int r3, int r4) {
            /*
                r2 = this;
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.flatbuffers.Utf8Safe.C3320a.<init>(int, int):void");
        }
    }
    ...
    private static String decodeUtf8Array(byte[] bArr, int i, int i2) {
        if ((i | i2 | ((bArr.length - i) - i2)) >= 0) {
            ...
            while (r12 < i3) {
                int i6 = r12 + 1;
                byte b2 = bArr[r12];
                if (Utf8.C3319a.m10318d(b2)) {
                    int i7 = i5 + 1;
                    cArr[i5] = (char) b2;
                    while (i6 < i3) {
                        byte b3 = bArr[i6];
                        if (!Utf8.C3319a.m10318d(b3)) {
                            break;
                        }
                        i6++;
                        cArr[i7] = (char) b3;
                    ...
                    r12 = i6;
                    i5 = i7;
                } else if (Utf8.C3319a.m10319e(b2)) {
                    if (i6 < i3) {
                        Utf8.C3319a.m10317c(b2, bArr[i6], cArr, i5);
                        r12 = i6 + 1;
                        i5++;
                    } else {
                        throw new IllegalArgumentException("Invalid UTF-8");
                    }
                } else if (Utf8.C3319a.m10320f(b2)) {
                    if (i6 < i3 - 1) {
                        int i8 = i6 + 1;
                        Utf8.C3319a.m10316b(b2, bArr[i6], bArr[i8], cArr, i5);
                        r12 = i8 + 1;
                        i5++;
                    } else {
                        throw new IllegalArgumentException("Invalid UTF-8");
                    ...
                    byte b4 = bArr[i6];
                    int i10 = i9 + 1;
                    Utf8.C3319a.m10315a(b2, b4, bArr[i9], bArr[i10], cArr, i5);
                    r12 = i10 + 1;
                    i5 = i5 + 1 + 1;
                } else {
                    throw new IllegalArgumentException("Invalid UTF-8");
        ...
        if ((i | i2 | ((byteBuffer.limit() - i) - i2)) >= 0) {
            ...
            while (r12 < i3) {
                ...
                if (Utf8.C3319a.m10318d(b2)) {
                    ...
                    if (i6 < i3) {
                        Utf8.C3319a.m10317c(b2, byteBuffer.get(i6), cArr, i5);
                        r12 = i6 + 1;
                        i5++;
                    } else {
                        throw new IllegalArgumentException("Invalid UTF-8");
                    ...
                    if (i6 < i3 - 1) {
                        int i8 = i6 + 1;
                        Utf8.C3319a.m10316b(b2, byteBuffer.get(i6), byteBuffer.get(i8), cArr, i5);
                        r12 = i8 + 1;
                        i5++;
                    } else {
                        throw new IllegalArgumentException("Invalid UTF-8");
                    ...
                    int i10 = i9 + 1;
                    Utf8.C3319a.m10315a(b2, b4, byteBuffer.get(i9), byteBuffer.get(i10), cArr, i5);
                    r12 = i10 + 1;
                    i5 = i5 + 1 + 1;
                } else {
                    throw new IllegalArgumentException("Invalid UTF-8");
