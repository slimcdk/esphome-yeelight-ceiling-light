...
public class C2478m2 {
    ...
    @VisibleForTesting
    /* renamed from: b */
    private static boolean m8009b(PackageInfo packageInfo, boolean z) {
        ...
        if (z) {
            return m8010c(packageInfo, f4905c, f4906d);
        }
        return m8010c(packageInfo, f4905c);
    }

    /* renamed from: c */
    private static boolean m8010c(PackageInfo packageInfo, byte[]... bArr) {
        Signature[] signatureArr = packageInfo.signatures;
    ...
    /* renamed from: d */
    private static byte[] m8011d(String str) {
        try {
    ...
    /* renamed from: f */
    private final PackageInfo m8012f(String str) {
        try {
            return C1620c.m4502a(this.f4907a).mo11303e(str, 64);
    ...
    /* renamed from: e */
    public final boolean mo13348e(String str) {
        PackageInfo f = m8012f(str);
        if (f == null) {
            return false;
        }
        if (C1533g.m4153f(this.f4907a)) {
            return m8009b(f, true);
        }
        boolean b = m8009b(f, false);
        if (!b) {
            boolean b2 = m8009b(f, true);
        }
        return b;
    }
}
