...
public class SnackbarContentLayout extends LinearLayout implements ContentViewCallback {
    ...
    public SnackbarContentLayout(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2535R.styleable.SnackbarLayout);
        this.maxWidth = obtainStyledAttributes.getDimensionPixelSize(C2535R.styleable.SnackbarLayout_android_maxWidth, -1);
        this.maxInlineActionWidth = obtainStyledAttributes.getDimensionPixelSize(C2535R.styleable.SnackbarLayout_maxActionInlineWidth, -1);
    ...
    public void onFinishInflate() {
        ...
        this.messageView = (TextView) findViewById(C2535R.C2537id.snackbar_text);
        this.actionView = (Button) findViewById(C2535R.C2537id.snackbar_action);
    }
    ...
    public void onMeasure(int r8, int r9) {
        ...
        L_0x0018:
            ...
            int r1 = com.google.android.material.C2535R.dimen.design_snackbar_padding_vertical_2lines
            int r0 = r0.getDimensionPixelSize(r1)
            android.content.res.Resources r1 = r7.getResources()
            int r2 = com.google.android.material.C2535R.dimen.design_snackbar_padding_vertical
