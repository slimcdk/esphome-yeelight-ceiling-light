...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate {
        ...
        public void onPopulateNodeForVirtualView(int i, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
            ...
            if (Chip.this.hasCloseIcon()) {
                ...
                if (closeIconContentDescription == null) {
                    ...
                    int i2 = C2535R.string.mtrl_chip_close_icon_content_description;
    ...
    public Chip(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C2535R.attr.chipStyle);
    }
    ...
    public Chip(Context context, AttributeSet attributeSet, int i) {
        ...
        ChipDrawable createFromAttributes = ChipDrawable.createFromAttributes(context, attributeSet, i, C2535R.style.Widget_MaterialComponents_Chip_Action);
    ...
    private void validateAttributes(@Nullable AttributeSet attributeSet) {
        if (attributeSet != null) {
            if (attributeSet.getAttributeValue(NAMESPACE_ANDROID, "background") != null) {
                ...
                int attributeIntValue = attributeSet.getAttributeIntValue(NAMESPACE_ANDROID, "gravity", 8388627);
            } else {
