...
public class AppBarLayout extends LinearLayout {
    ...
    protected static class BaseBehavior<T extends AppBarLayout> extends HeaderBehavior<T> {
        ...
        public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, T t, int i) {
            ...
            if (i2 >= 0 && (pendingAction & 8) == 0) {
                View childAt = t.getChildAt(i2);
                setHeaderTopBottomOffset(coordinatorLayout, t, (-childAt.getBottom()) + (this.offsetToChildIndexOnLayoutIsMinHeight ? ViewCompat.getMinimumHeight(childAt) + t.getTopInset() : Math.round(((float) childAt.getHeight()) * this.offsetToChildIndexOnLayoutPerc)));
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2535R.styleable.AppBarLayout_Layout);
            this.scrollFlags = obtainStyledAttributes.getInt(C2535R.styleable.AppBarLayout_Layout_layout_scrollFlags, 0);
            if (obtainStyledAttributes.hasValue(C2535R.styleable.AppBarLayout_Layout_layout_scrollInterpolator)) {
                this.scrollInterpolator = android.view.animation.AnimationUtils.loadInterpolator(context, obtainStyledAttributes.getResourceId(C2535R.styleable.AppBarLayout_Layout_layout_scrollInterpolator, 0));
            }
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        public ScrollingViewBehavior(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2535R.styleable.ScrollingViewBehavior_Layout);
            setOverlayTop(obtainStyledAttributes.getDimensionPixelSize(C2535R.styleable.ScrollingViewBehavior_Layout_behavior_overlapTop, 0));
            obtainStyledAttributes.recycle();
        }
    ...
    public AppBarLayout(Context context, AttributeSet attributeSet) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            ViewUtilsLollipop.setStateListAnimatorFromAttrs(this, attributeSet, 0, C2535R.style.Widget_Design_AppBarLayout);
        }
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C2535R.styleable.AppBarLayout, 0, C2535R.style.Widget_Design_AppBarLayout, new int[0]);
        ViewCompat.setBackground(this, obtainStyledAttributes.getDrawable(C2535R.styleable.AppBarLayout_android_background));
        if (obtainStyledAttributes.hasValue(C2535R.styleable.AppBarLayout_expanded)) {
            setExpanded(obtainStyledAttributes.getBoolean(C2535R.styleable.AppBarLayout_expanded, false), false, false);
        }
        if (Build.VERSION.SDK_INT >= 21 && obtainStyledAttributes.hasValue(C2535R.styleable.AppBarLayout_elevation)) {
            ViewUtilsLollipop.setDefaultAppBarLayoutStateListAnimator(this, (float) obtainStyledAttributes.getDimensionPixelSize(C2535R.styleable.AppBarLayout_elevation, 0));
        }
        if (Build.VERSION.SDK_INT >= 26) {
            if (obtainStyledAttributes.hasValue(C2535R.styleable.AppBarLayout_android_keyboardNavigationCluster)) {
                setKeyboardNavigationCluster(obtainStyledAttributes.getBoolean(C2535R.styleable.AppBarLayout_android_keyboardNavigationCluster, false));
            }
            if (obtainStyledAttributes.hasValue(C2535R.styleable.AppBarLayout_android_touchscreenBlocksFocus)) {
                setTouchscreenBlocksFocus(obtainStyledAttributes.getBoolean(C2535R.styleable.AppBarLayout_android_touchscreenBlocksFocus, false));
            }
        }
        this.liftOnScroll = obtainStyledAttributes.getBoolean(C2535R.styleable.AppBarLayout_liftOnScroll, false);
        obtainStyledAttributes.recycle();
        ...
        for (int childCount = getChildCount() - 1; childCount >= 0; childCount--) {
            ...
            if ((i3 & 5) == 5) {
                ...
                if ((i3 & 8) != 0) {
                    ...
                    i2 = i4 + (measuredHeight - ((i3 & 2) != 0 ? ViewCompat.getMinimumHeight(childAt) : getTopInset()));
                }
            } else if (i2 > 0) {
                break;
            }
    ...
    public int[] onCreateDrawableState(int i) {
        ...
        iArr[0] = this.liftable ? C2535R.attr.state_liftable : -C2535R.attr.state_liftable;
        iArr[1] = (!this.liftable || !this.lifted) ? -C2535R.attr.state_lifted : C2535R.attr.state_lifted;
        iArr[2] = this.liftable ? C2535R.attr.state_collapsible : -C2535R.attr.state_collapsible;
        iArr[3] = (!this.liftable || !this.lifted) ? -C2535R.attr.state_collapsed : C2535R.attr.state_collapsed;
