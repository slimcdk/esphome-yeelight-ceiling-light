...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    private ViewGroup calculateChildContentContainer(View view) {
        View findViewById = view.findViewById(C2535R.C2537id.mtrl_child_content_container);
    ...
    private void createTranslationAnimation(View view, View view2, boolean z, boolean z2, FabTransformationSpec fabTransformationSpec, List<Animator> list, List<Animator.AnimatorListener> list2, RectF rectF) {
        ...
        if (calculateTranslationX == 0.0f || calculateTranslationY == 0.0f) {
            motionTiming = fabTransformationSpec2.timings.getTiming("translationXLinear");
            motionSpec = fabTransformationSpec2.timings;
            str = "translationYLinear";
        } else if ((!z || calculateTranslationY >= 0.0f) && (z || calculateTranslationY <= 0.0f)) {
            motionTiming = fabTransformationSpec2.timings.getTiming("translationXCurveDownwards");
            motionSpec = fabTransformationSpec2.timings;
            str = "translationYCurveDownwards";
        } else {
            motionTiming = fabTransformationSpec2.timings.getTiming("translationXCurveUpwards");
            motionSpec = fabTransformationSpec2.timings;
            str = "translationYCurveUpwards";
        }
        MotionTiming motionTiming2 = motionTiming;
        MotionTiming timing = motionSpec.getTiming(str);
        if (z) {
            if (!z2) {
            ...
            calculateChildVisibleBoundsAtEndOfExpansion(view2, fabTransformationSpec, motionTiming2, timing, -calculateTranslationX, -calculateTranslationY, 0.0f, 0.0f, rectF);
        } else {
