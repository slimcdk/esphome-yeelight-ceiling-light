...
public class IndirectLight {
    ...
    public static class Builder {
        ...
        @NonNull
        public Builder irradiance(@IntRange(from = 1, mo617to = 3) int i, @NonNull float[] fArr) {
            if (i != 1) {
                if (i != 2) {
                    if (i != 3) {
        ...
        @NonNull
        public Builder radiance(@IntRange(from = 1, mo617to = 3) int i, @NonNull float[] fArr) {
            if (i != 1) {
                if (i != 2) {
                    if (i != 3) {
                        throw new IllegalArgumentException("bands must be 1, 2 or 3");
