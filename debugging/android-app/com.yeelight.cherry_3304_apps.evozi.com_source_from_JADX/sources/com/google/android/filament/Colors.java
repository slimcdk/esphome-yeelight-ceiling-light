...
public class Colors {
    ...
    static /* synthetic */ class C13601 {
        ...
        static {
            ...
            L_0x004e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.android.filament.Colors.C13601.<clinit>():void");
        }
    }
    ...
    public static float[] toLinear(@NonNull Conversion conversion, @Size(min = 3) @NonNull float[] fArr) {
        int i = C13601.$SwitchMap$com$google$android$filament$Colors$Conversion[conversion.ordinal()];
        int i2 = 0;
        if (i == 1) {
            while (i2 < 3) {
    ...
    public static float[] toLinear(@NonNull RgbaType rgbaType, @Size(min = 4) @NonNull float[] fArr) {
        int i = C13601.$SwitchMap$com$google$android$filament$Colors$RgbaType[rgbaType.ordinal()];
        if (i == 1) {
