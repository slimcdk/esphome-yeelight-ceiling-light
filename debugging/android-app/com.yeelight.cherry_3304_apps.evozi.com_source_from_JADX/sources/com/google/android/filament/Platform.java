...
abstract class Platform {
    ...
    static Platform get() {
        if (mCurrentPlatform == null) {
            try {
                mCurrentPlatform = isAndroid() ? (Platform) Class.forName("com.google.android.filament.AndroidPlatform").newInstance() : (Platform) Class.forName("com.google.android.filament.DesktopPlatform").newInstance();
