...
public final class TextureHelper {
    ...
    static /* synthetic */ class C13711 {
        ...
        static {
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.android.filament.android.TextureHelper.C13711.<clinit>():void");
        }
    }
    ...
    private static int toNativeFormat(Bitmap.Config config) {
        int i = C13711.$SwitchMap$android$graphics$Bitmap$Config[config.ordinal()];
        if (i == 1) {
            return 0;
        }
        if (i == 2) {
