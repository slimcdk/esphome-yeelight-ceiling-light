...
public class ExternalTexture {
    ...
    private static final class C2697a implements Runnable {
        @Nullable

        /* renamed from: a */
        private final Texture f5214a;
        @Nullable

        /* renamed from: b */
        private final Stream f5215b;

        C2697a(Texture texture, Stream stream) {
            this.f5214a = texture;
            this.f5215b = stream;
        }
        ...
        public void run() {
            ...
            if (engine != null && engine.isValid()) {
                Texture texture = this.f5214a;
                if (texture != null) {
                    engine.destroyTexture(texture);
                }
                Stream stream = this.f5215b;
                if (stream != null) {
    ...
    private void initialize(Stream stream) {
        if (this.filamentTexture == null) {
            ...
            ResourceManager.getInstance().getExternalTextureCleanupRegistry().register(this, new C2697a(this.filamentTexture, stream));
            return;
        }
