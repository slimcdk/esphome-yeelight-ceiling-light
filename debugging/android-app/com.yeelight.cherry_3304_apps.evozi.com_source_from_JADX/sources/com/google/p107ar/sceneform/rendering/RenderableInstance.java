...
public class RenderableInstance {
    ...
    private static final class C2726a implements Runnable {
    ...
    public RenderableInstance(TransformProvider transformProvider2, Renderable renderable2) {
        ...
        ResourceManager.getInstance().getRenderableInstanceCleanupRegistry().register(this, new C2726a(this.entity, this.childEntity));
    }
    ...
    public Matrix getRelativeTransform() {
        ...
        float a = renderableData.mo15905a();
        Vector3 c = renderableData.mo15907c();
    ...
    public void prepareForDraw() {
        ...
        if (id.checkChanged(this.renderableId)) {
            this.renderable.getRenderableData().mo15927w(this.renderable, getSkeletonRig(), getRenderedEntity());
