...
import com.google.p107ar.sceneform.rendering.CameraProvider;
...
public class Camera extends Node implements CameraProvider {
    ...
    Camera(Scene scene) {
        ...
        this.isArCamera = z;
        if (!z) {
            scene.getView().addOnLayoutChangeListener(new C2685g(this));
        }
    }
    ...
    private boolean unproject(float f, float f2, float f3, Vector3 vector3) {
        ...
        vector3.f5202x = (fArr[0] * f4) + (fArr[4] * f5) + (fArr[8] * f6) + (fArr[12] * 1.0f);
        vector3.f5203y = (fArr[1] * f4) + (fArr[5] * f5) + (fArr[9] * f6) + (fArr[13] * 1.0f);
        vector3.f5204z = (fArr[2] * f4) + (fArr[6] * f5) + (fArr[10] * f6) + (fArr[14] * 1.0f);
    ...
    public void updateTrackedPose(com.google.p107ar.core.Camera camera) {
        ...
        Vector3 b = C2677a.m8220b(displayOrientedPose);
        Quaternion e = C2677a.m8223e(displayOrientedPose);
    ...
    public Vector3 worldToScreenPoint(Vector3 vector3) {
        ...
        vector32.f5203y = f8;
        vector32.f5202x = f7 * ((float) viewWidth);
        float f9 = (float) viewHeight;
        float f10 = f8 * f9;
        vector32.f5203y = f10;
        vector32.f5203y = f9 - f10;
        return vector32;
    }
}
