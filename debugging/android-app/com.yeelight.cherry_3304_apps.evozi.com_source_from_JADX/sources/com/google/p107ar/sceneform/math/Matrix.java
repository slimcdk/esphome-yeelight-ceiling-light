...
public class Matrix {
    ...
    public void decomposeRotation(Vector3 vector3, Matrix matrix) {
        if (vector3.f5202x != 0.0f) {
            for (int i = 0; i < 3; i++) {
                matrix.data[i] = this.data[i] / vector3.f5202x;
            }
        }
        matrix.data[3] = 0.0f;
        if (vector3.f5203y != 0.0f) {
            for (int i2 = 4; i2 < 7; i2++) {
                matrix.data[i2] = this.data[i2] / vector3.f5203y;
            }
        }
        matrix.data[7] = 0.0f;
        if (vector3.f5204z != 0.0f) {
            for (int i3 = 8; i3 < 11; i3++) {
                matrix.data[i3] = this.data[i3] / vector3.f5204z;
            }
        }
    ...
    public void decomposeScale(Vector3 vector3) {
        ...
        vector3.f5202x = vector32.length();
        float[] fArr2 = this.data;
        vector32.set(fArr2[4], fArr2[5], fArr2[6]);
        vector3.f5203y = vector32.length();
        float[] fArr3 = this.data;
        vector32.set(fArr3[8], fArr3[9], fArr3[10]);
        vector3.f5204z = vector32.length();
    }

    public void decomposeTranslation(Vector3 vector3) {
        float[] fArr = this.data;
        vector3.f5202x = fArr[12];
        vector3.f5203y = fArr[13];
        vector3.f5204z = fArr[14];
    }
    ...
    public void extractQuaternion(Quaternion quaternion) {
        ...
        if (f5 > 0.0f) {
            ...
            quaternion2.f5198w = 0.25f * f3;
            float[] fArr2 = this.data;
            quaternion2.f5199x = (fArr2[6] - fArr2[9]) / f3;
            quaternion2.f5200y = (fArr2[8] - fArr2[2]) / f3;
            f4 = fArr2[1] - fArr2[4];
        } else {
            if (fArr[0] <= fArr[5] || fArr[0] <= fArr[10]) {
                float[] fArr3 = this.data;
                if (fArr3[5] > fArr3[10]) {
                    f3 = ((float) Math.sqrt((double) (((fArr3[5] + 1.0f) - fArr3[0]) - fArr3[10]))) * 2.0f;
                    float[] fArr4 = this.data;
                    quaternion2.f5198w = (fArr4[8] - fArr4[2]) / f3;
                    quaternion2.f5199x = (fArr4[4] + fArr4[1]) / f3;
                    quaternion2.f5200y = 0.25f * f3;
                    f = fArr4[9];
                    f2 = fArr4[6];
                } else {
                    float sqrt = ((float) Math.sqrt((double) (((fArr3[10] + 1.0f) - fArr3[0]) - fArr3[5]))) * 2.0f;
                    float[] fArr5 = this.data;
                    quaternion2.f5198w = (fArr5[1] - fArr5[4]) / sqrt;
                    quaternion2.f5199x = (fArr5[8] + fArr5[2]) / sqrt;
                    quaternion2.f5200y = (fArr5[9] + fArr5[6]) / sqrt;
                    quaternion2.f5201z = sqrt * 0.25f;
                    quaternion.normalize();
                }
            } else {
                f3 = ((float) Math.sqrt((double) (((fArr[0] + 1.0f) - fArr[5]) - fArr[10]))) * 2.0f;
                float[] fArr6 = this.data;
                quaternion2.f5198w = (fArr6[6] - fArr6[9]) / f3;
                quaternion2.f5199x = 0.25f * f3;
                quaternion2.f5200y = (fArr6[4] + fArr6[1]) / f3;
                f = fArr6[8];
                f2 = fArr6[2];
            }
            f4 = f + f2;
        }
        quaternion2.f5201z = f4 / f3;
        quaternion.normalize();
    }
    ...
    public void makeRotation(Quaternion quaternion) {
        ...
        float f2 = f * f;
        float f3 = quaternion.f5200y;
        float f4 = f * f3;
        float f5 = quaternion.f5201z;
        float f6 = f * f5;
        float f7 = quaternion.f5198w;
        float f8 = f * f7;
        float f9 = f3 * f3;
        float f10 = f3 * f5;
        float f11 = f3 * f7;
    ...
    public void makeScale(Vector3 vector3) {
        ...
        set(IDENTITY_DATA);
        float[] fArr = this.data;
        fArr[0] = vector3.f5202x;
        fArr[5] = vector3.f5203y;
    ...
    public void makeTrs(Vector3 vector3, Quaternion quaternion, Vector3 vector32) {
        ...
        float f = quaternion2.f5199x;
        float f2 = 1.0f - ((f * 2.0f) * f);
        float f3 = quaternion2.f5200y;
        float f4 = f3 * f3;
        float f5 = quaternion2.f5201z;
        float f6 = f5 * 2.0f * f5;
        float f7 = f * 2.0f * f5;
        ...
        float[] fArr = this.data;
        float f14 = f4 * 2.0f;
        float f15 = vector34.f5202x;
        fArr[0] = ((1.0f - f14) - f6) * f15;
        float f16 = vector34.f5203y;
        fArr[4] = (f10 - f11) * f16;
        float f17 = vector34.f5204z;
        fArr[8] = (f7 + f9) * f17;
        fArr[1] = (f10 + f11) * f15;
        fArr[5] = (f2 - f6) * f16;
        fArr[9] = (f13 - f12) * f17;
        ...
        fArr[6] = (f13 + f12) * f16;
        fArr[10] = (f2 - f14) * f17;
        fArr[12] = vector33.f5202x;
        fArr[13] = vector33.f5203y;
        fArr[14] = vector33.f5204z;
        fArr[15] = 1.0f;
    }
    ...
    public void setTranslation(Vector3 vector3) {
        float[] fArr = this.data;
        fArr[12] = vector3.f5202x;
        fArr[13] = vector3.f5203y;
        fArr[14] = vector3.f5204z;
    }
    ...
    public Vector3 transformDirection(Vector3 vector3) {
        ...
        vector32.f5202x = f5;
        vector32.f5202x = f5 + (fArr[8] * f3);
        float f6 = fArr[1] * f;
        vector32.f5203y = f6;
        float f7 = f6 + (fArr[5] * f2);
        vector32.f5203y = f7;
        vector32.f5203y = f7 + (fArr[9] * f3);
        float f8 = fArr[2] * f;
        vector32.f5204z = f8;
        float f9 = f8 + (fArr[6] * f2);
        vector32.f5204z = f9;
        vector32.f5204z = f9 + (fArr[10] * f3);
        return vector32;
    }
