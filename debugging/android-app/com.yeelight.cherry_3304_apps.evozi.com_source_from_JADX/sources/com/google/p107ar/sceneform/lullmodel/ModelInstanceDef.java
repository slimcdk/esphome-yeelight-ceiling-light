...
public final class ModelInstanceDef extends Table {
    ...
    public final SubmeshAabb aabbs(SubmeshAabb submeshAabb, int i) {
        ...
        if (__offset != 0) {
            return submeshAabb.__assign(__indirect(__vector(__offset) + (i << 2)), this.f6424bb);
        }
        return null;
    }
    ...
    public final VertexAttribute blendAttributes(VertexAttribute vertexAttribute, int i) {
        ...
        if (__offset != 0) {
            return vertexAttribute.__assign(__vector(__offset) + (i << 3), this.f6424bb);
        }
        return null;
    }
    ...
    public final BlendShape blendShapes(BlendShape blendShape, int i) {
        ...
        if (__offset != 0) {
            return blendShape.__assign(__indirect(__vector(__offset) + (i << 2)), this.f6424bb);
        }
        return null;
    }
    ...
    public final int indices16(int i) {
        ...
        if (__offset != 0) {
            return this.f6424bb.getShort(__vector(__offset) + (i << 1)) & 65535;
        }
        return 0;
    }
    ...
    public final long indices32(int i) {
        ...
        if (__offset != 0) {
            return ((long) this.f6424bb.getInt(__vector(__offset) + (i << 2))) & 4294967295L;
        }
        return 0;
    }
    ...
    public final ModelIndexRange ranges(ModelIndexRange modelIndexRange, int i) {
        ...
        if (__offset != 0) {
            return modelIndexRange.__assign(__vector(__offset) + (i << 3), this.f6424bb);
        }
        return null;
    }
