...
public final class ShapeFactory {
    ...
    public static ModelRenderable makeCube(Vector3 vector3, Vector3 vector32, Material material) {
        ...
        Vector3 add = Vector3.add(vector33, new Vector3(-scaled.f5202x, -scaled.f5203y, scaled.f5204z));
        Vector3 add2 = Vector3.add(vector33, new Vector3(scaled.f5202x, -scaled.f5203y, scaled.f5204z));
        Vector3 add3 = Vector3.add(vector33, new Vector3(scaled.f5202x, -scaled.f5203y, -scaled.f5204z));
        Vector3 add4 = Vector3.add(vector33, new Vector3(-scaled.f5202x, -scaled.f5203y, -scaled.f5204z));
        Vector3 add5 = Vector3.add(vector33, new Vector3(-scaled.f5202x, scaled.f5203y, scaled.f5204z));
        Vector3 add6 = Vector3.add(vector33, new Vector3(scaled.f5202x, scaled.f5203y, scaled.f5204z));
        Vector3 add7 = Vector3.add(vector33, new Vector3(scaled.f5202x, scaled.f5203y, -scaled.f5204z));
        Vector3 add8 = Vector3.add(vector33, new Vector3(-scaled.f5202x, scaled.f5203y, -scaled.f5204z));
    ...
    public static ModelRenderable makeCylinder(float f, float f2, Vector3 vector3, Material material) {
        ...
        while (i <= 24) {
            ...
            String str2 = str;
            float f8 = f5;
            Vector3 normalized = new Vector3(vector33.f5202x, f4, vector33.f5204z).normalized();
            ...
            Vector3 normalized2 = new Vector3(vector34.f5202x, 0.0f, vector34.f5204z).normalized();
            ...
            arrayList3.add(Vertex.builder().setPosition(add2).setNormal(Vector3.m8263up()).setUvCoordinate(new Vertex.UvCoordinate(f10, f11)).build());
            f5 = f8 + 0.2617994f;
            i++;
            str = str2;
            f4 = 0.0f;
        ...
        arrayList.add(Vertex.builder().setPosition(Vector3.add(vector32, new Vector3(0.0f, f3, 0.0f))).setNormal(Vector3.m8263up()).setUvCoordinate(new Vertex.UvCoordinate(0.5f, 0.5f)).build());
