...
import com.google.p107ar.sceneform.collision.Plane;
import com.google.p107ar.sceneform.collision.Ray;
import com.google.p107ar.sceneform.collision.RayHit;
import com.google.p107ar.sceneform.math.Quaternion;
import com.google.p107ar.sceneform.math.Vector3;
import com.google.p107ar.sceneform.rendering.ViewRenderable;
import com.google.p107ar.sceneform.utilities.Preconditions;

/* renamed from: com.google.ar.sceneform.a */
class C2677a {
    /* renamed from: a */
    private static float m8219a(ViewRenderable viewRenderable) {
        int width = viewRenderable.getView().getWidth();
        float f = viewRenderable.getSizer().getSize(viewRenderable.getView()).f5202x;
        if (f == 0.0f) {
            return 0.0f;
        }
    ...
    /* renamed from: b */
    static Vector3 m8220b(Pose pose) {
        return new Vector3(pose.mo15124tx(), pose.mo15125ty(), pose.mo15126tz());
    }
    ...
    static com.google.p107ar.sceneform.math.Vector3 m8221c(com.google.p107ar.sceneform.Node r7, com.google.p107ar.sceneform.math.Vector3 r8, com.google.p107ar.sceneform.rendering.ViewRenderable r9) {
        /*
            java.lang.String r0 = "Parameter \"node\" was null."
            com.google.p107ar.sceneform.utilities.Preconditions.checkNotNull(r7, r0)
            java.lang.String r0 = "Parameter \"worldPos\" was null."
            com.google.p107ar.sceneform.utilities.Preconditions.checkNotNull(r8, r0)
            java.lang.String r0 = "Parameter \"viewRenderable\" was null."
            com.google.p107ar.sceneform.utilities.Preconditions.checkNotNull(r9, r0)
        ...
        L_0x0057:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.p107ar.sceneform.C2677a.m8221c(com.google.ar.sceneform.Node, com.google.ar.sceneform.math.Vector3, com.google.ar.sceneform.rendering.ViewRenderable):com.google.ar.sceneform.math.Vector3");
    }

    /* renamed from: d */
    static boolean m8222d(Node node, MotionEvent motionEvent) {
        Scene scene;
        ...
        for (int i = 0; i < pointerCount; i++) {
            ...
            if (plane.rayIntersection(screenPointToRay, rayHit)) {
                c = m8221c(node2, rayHit.getPoint(), viewRenderable);
                width = c.f5202x;
            } else if (plane2.rayIntersection(screenPointToRay, rayHit)) {
                c = m8221c(node2, rayHit.getPoint(), viewRenderable);
                width = ((float) viewRenderable.getView().getWidth()) - c.f5202x;
            } else {
                pointerCoords.clear();
    ...
    /* renamed from: e */
    static Quaternion m8223e(Pose pose) {
        return new Quaternion(pose.mo15115qx(), pose.mo15116qy(), pose.mo15117qz(), pose.mo15114qw());
    }
}
