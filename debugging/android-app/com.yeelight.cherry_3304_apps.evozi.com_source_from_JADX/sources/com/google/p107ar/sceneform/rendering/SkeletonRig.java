...
public class SkeletonRig {
    ...
    protected static void initializeMatrix(float[] fArr, Mat4x3 mat4x3) {
        Vec4 vec4 = new Vec4();
        initializeRow(fArr, 0, mat4x3.mo16557c0(vec4));
        initializeRow(fArr, 1, mat4x3.mo16559c1(vec4));
        initializeRow(fArr, 2, mat4x3.mo16561c2(vec4));
        fArr[15] = 1.0f;
    }

    protected static void initializeRow(float[] fArr, int i, Vec4 vec4) {
        fArr[i + 0] = vec4.mo16789x();
        fArr[i + 4] = vec4.mo16790y();
        fArr[i + 8] = vec4.mo16791z();
        fArr[i + 12] = vec4.mo16788w();
    }
