...
public class Texture {
    ...
    static /* synthetic */ class C27311 {
        ...
        static {
            /*
                com.google.ar.sceneform.rendering.Texture$Usage[] r0 = com.google.p107ar.sceneform.rendering.Texture.Usage.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                f5269a = r0
                com.google.ar.sceneform.rendering.Texture$Usage r1 = com.google.p107ar.sceneform.rendering.Texture.Usage.COLOR     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                int[] r0 = f5269a     // Catch:{ NoSuchFieldError -> 0x001d }
                com.google.ar.sceneform.rendering.Texture$Usage r1 = com.google.p107ar.sceneform.rendering.Texture.Usage.NORMAL     // Catch:{ NoSuchFieldError -> 0x001d }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x001d }
                r2 = 2
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x001d }
            L_0x001d:
                int[] r0 = f5269a     // Catch:{ NoSuchFieldError -> 0x0028 }
                com.google.ar.sceneform.rendering.Texture$Usage r1 = com.google.p107ar.sceneform.rendering.Texture.Usage.DATA     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.p107ar.sceneform.rendering.Texture.C27311.<clinit>():void");
        }
    }
    ...
    public static final class Builder {
        ...
        static /* synthetic */ android.graphics.Bitmap m8354b(boolean r2, java.util.concurrent.Callable r3) {
            /*
            ...
            L_0x0043:
                ...
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.p107ar.sceneform.rendering.Texture.Builder.m8354b(boolean, java.util.concurrent.Callable):android.graphics.Bitmap");
        }

        private static CompletableFuture<Bitmap> makeBitmap(Callable<InputStream> callable, boolean z) {
            return CompletableFuture.supplyAsync(new C2747f0(z, callable), ThreadPools.getThreadPoolExecutor());
        }
        ...
        /* renamed from: a */
        public /* synthetic */ Texture mo16204a(Bitmap bitmap2) {
            return new Texture(makeTextureData(bitmap2, this.sampler, this.usage, 255), (C27311) null);
        }
        ...
        public CompletableFuture<Texture> build() {
            ...
            if (this.textureInternalData == null || obj == null) {
                if (this.textureInternalData != null) {
                    completableFuture = CompletableFuture.completedFuture(new Texture(this.textureInternalData, (C27311) null));
                } else {
                    ...
                    completableFuture = completableFuture2.thenApplyAsync(new C2745e0(this), ThreadPools.getMainExecutor());
                }
                if (obj != null) {
                ...
                sb.append(valueOf);
                sb.append("'");
                C2759l0.m8369b(access$200, completableFuture, sb.toString());
    ...
    public static class Sampler {
        ...
        public static class Builder {
            ...
            public Sampler build() {
                return new Sampler(this, (C27311) null);
            }
        ...
        /* synthetic */ Sampler(Builder builder, C27311 r2) {
            this(builder);
        }
    ...
    private static final class C2732a implements Runnable {

        /* renamed from: a */
        private final TextureInternalData f5270a;

        C2732a(TextureInternalData textureInternalData) {
            this.f5270a = textureInternalData;
        }

        public void run() {
            AndroidPreconditions.checkUiThread();
            TextureInternalData textureInternalData = this.f5270a;
    ...
    private Texture(TextureInternalData textureInternalData) {
        ...
        ResourceManager.getInstance().getTextureCleanupRegistry().register(this, new C2732a(textureInternalData));
    }

    /* synthetic */ Texture(TextureInternalData textureInternalData, C27311 r2) {
        this(textureInternalData);
    }

    public static Builder builder() {
        AndroidPreconditions.checkMinAndroidApiLevel();
        return new Builder((C27311) null);
    }

    /* access modifiers changed from: private */
    public static Texture.InternalFormat getInternalFormatForUsage(Usage usage) {
        return C27311.f5269a[usage.ordinal()] != 1 ? Texture.InternalFormat.RGBA8 : Texture.InternalFormat.SRGB8_A8;
    }
