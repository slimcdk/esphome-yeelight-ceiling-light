...
/* renamed from: com.google.ar.sceneform.lullmodel.MaterialDef */
public final class MaterialDef extends Table {
    ...
    public final VariantMapDef properties(VariantMapDef variantMapDef) {
        ...
        if (__offset != 0) {
            return variantMapDef.__assign(__indirect(__offset + this.bb_pos), this.f6424bb);
        }
        return null;
    }
    ...
    public final MaterialTextureDef textures(MaterialTextureDef materialTextureDef, int i) {
        ...
        if (__offset != 0) {
            return materialTextureDef.__assign(__indirect(__vector(__offset) + (i << 2)), this.f6424bb);
        }
        return null;
    }
