...
public class HeadlessEngineWrapper implements IEngine {
    ...
    static {
        ...
        try {
            swapChainInit = cls2.getDeclaredConstructor(new Class[]{Long.TYPE, Object.class});
            getNativeEngineMethod = cls.getDeclaredMethod("getNativeObject", new Class[0]);
            engineInit = cls.getDeclaredConstructor(new Class[]{Long.TYPE});
