...
import com.google.p107ar.schemas.sceneform.LightingCubeDef;
import com.google.p107ar.schemas.sceneform.LightingCubeFaceDef;
...
public class LightProbe {
    ...
    public static final class Builder {
        ...
        public CompletableFuture<LightProbe> build() {
            if (this.inputStreamCreator != null) {
                ...
                CompletableFuture<LightProbe> thenApplyAsync = lightProbe.loadInBackground(this.inputStreamCreator).thenApplyAsync(new C2744e(lightProbe), ThreadPools.getMainExecutor());
                if (thenApplyAsync != null) {
                    ...
                    sb.append(str);
                    sb.append("'");
                    C2759l0.m8369b(access$600, thenApplyAsync, sb.toString());
            ...
            if (loadReflectCubemapFromLightingDef != null) {
                ...
                if (shCoefficientsLength >= 9) {
                    ...
                    for (int i2 = 0; i2 < shCoefficientsLength; i2++) {
                        ...
                        int i3 = i2 * 3;
                        this.irradianceData[i3 + 0] = shCoefficients.mo16783x() / 3.1415927f;
                        this.irradianceData[i3 + 1] = shCoefficients.mo16784y() / 3.1415927f;
                        this.irradianceData[i3 + 2] = shCoefficients.mo16785z() / 3.1415927f;
                    }
    ...
    public CompletableFuture<LightingDef> loadInBackground(Callable<InputStream> callable) {
        return CompletableFuture.supplyAsync(new C2748g(this, callable), ThreadPools.getThreadPoolExecutor());
    }
    ...
    public /* synthetic */ com.google.p107ar.schemas.sceneform.LightingDef mo15964b(java.util.concurrent.Callable r6) {
        /*
            r5 = this;
            ...
            java.nio.ByteBuffer r0 = com.google.p107ar.sceneform.utilities.SceneformBufferUtils.readStream(r6)     // Catch:{ all -> 0x0095 }
        ...
        L_0x0011:
            ...
            com.google.ar.schemas.sceneform.SceneformBundleDef r0 = com.google.p107ar.sceneform.rendering.SceneformBundle.tryLoadSceneformBundle(r0)     // Catch:{ a -> 0x0088 }
        ...
        L_0x00b3:
            goto L_0x00b2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.p107ar.sceneform.rendering.LightProbe.mo15964b(java.util.concurrent.Callable):com.google.ar.schemas.sceneform.LightingDef");
    }
    ...
    public IndirectLight buildIndirectLight() {
        ...
        if (this.reflectCubemap != null) {
            float[] fArr = this.irradianceData;
            Color color = this.ambientColor;
            float f = color.f5213r;
            Color color2 = this.colorCorrection;
            fArr[0] = f * color2.f5213r;
            fArr[1] = color.f5212g * color2.f5212g;
            fArr[2] = color.f5211b * color2.f5211b;
    ...
    public void finalize() {
        try {
            ThreadPools.getMainExecutor().execute(new C2746f(this));
