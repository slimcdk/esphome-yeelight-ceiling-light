...
/* renamed from: com.google.ar.schemas.lull.ModelPipelineRenderableDef */
public final class ModelPipelineRenderableDef extends Table {
    ...
    public final ModelPipelineMaterialDef materials(ModelPipelineMaterialDef modelPipelineMaterialDef, int i) {
        ...
        if (__offset != 0) {
            return modelPipelineMaterialDef.__assign(__indirect(__vector(__offset) + (i << 2)), this.f6424bb);
        }
        return null;
    }
