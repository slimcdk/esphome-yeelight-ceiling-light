...
/* renamed from: com.google.ar.schemas.lull.ModelDef */
public final class ModelDef extends Table {
    ...
    public final AabbDef boundingBox(AabbDef aabbDef) {
        ...
        if (__offset != 0) {
            return aabbDef.__assign(__offset + this.bb_pos, this.f6424bb);
        }
        return null;
    }
    ...
    public final ModelInstanceDef lods(ModelInstanceDef modelInstanceDef, int i) {
        ...
        if (__offset != 0) {
            return modelInstanceDef.__assign(__indirect(__vector(__offset) + (i << 2)), this.f6424bb);
        }
        return null;
    }
    ...
    public final SkeletonDef skeleton(SkeletonDef skeletonDef) {
        ...
        if (__offset != 0) {
            return skeletonDef.__assign(__indirect(__offset + this.bb_pos), this.f6424bb);
        }
        return null;
    }
