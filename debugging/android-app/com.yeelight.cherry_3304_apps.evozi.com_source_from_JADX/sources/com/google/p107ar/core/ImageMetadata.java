...
public class ImageMetadata {
    ...
    private final C2620a sketchEntry;
    ...
    ImageMetadata(long j, Session session2) {
        ...
        this.nativeHandle = j;
        this.sketchEntry = new C2620a();
    }

    private void getMetdataEntry(int i, C2620a aVar) {
        long nativeGetMetadataEntry = nativeGetMetadataEntry(this.session.nativeWrapperHandle, this.nativeHandle, i);
        aVar.f5036a = nativeGetMetadataEntry;
        if (nativeGetMetadataEntry != 0) {
            aVar.f5037b = nativeGetMetadataEntryValueType(this.session.nativeWrapperHandle, nativeGetMetadataEntry);
            aVar.f5038c = nativeGetMetadataEntryValueCount(this.session.nativeWrapperHandle, aVar.f5036a);
            return;
        }
    ...
    public byte getByte(int i) {
        ...
        C2620a aVar = this.sketchEntry;
        if (aVar.f5037b == 0 && aVar.f5038c == 1) {
            byte nativeGetByteFromMetadataEntry = nativeGetByteFromMetadataEntry(this.session.nativeWrapperHandle, aVar.f5036a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f5036a);
    ...
    public byte[] getByteArray(int i) {
        ...
        C2620a aVar = this.sketchEntry;
        if (aVar.f5037b == 0) {
            byte[] nativeGetByteArrayFromMetadataEntry = nativeGetByteArrayFromMetadataEntry(this.session.nativeWrapperHandle, aVar.f5036a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f5036a);
    ...
    public double getDouble(int i) {
        getMetdataEntry(i, this.sketchEntry);
        C2620a aVar = this.sketchEntry;
        if (aVar.f5037b == 4 && aVar.f5038c == 1) {
            double nativeGetDoubleFromMetadataEntry = nativeGetDoubleFromMetadataEntry(this.session.nativeWrapperHandle, aVar.f5036a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f5036a);
    ...
    public double[] getDoubleArray(int i) {
        ...
        C2620a aVar = this.sketchEntry;
        if (aVar.f5037b == 4) {
            double[] nativeGetDoubleArrayFromMetadataEntry = nativeGetDoubleArrayFromMetadataEntry(this.session.nativeWrapperHandle, aVar.f5036a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f5036a);
    ...
    public float getFloat(int i) {
        getMetdataEntry(i, this.sketchEntry);
        C2620a aVar = this.sketchEntry;
        if (aVar.f5037b == 2 && aVar.f5038c == 1) {
            float nativeGetFloatFromMetadataEntry = nativeGetFloatFromMetadataEntry(this.session.nativeWrapperHandle, aVar.f5036a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f5036a);
    ...
    public float[] getFloatArray(int i) {
        ...
        C2620a aVar = this.sketchEntry;
        if (aVar.f5037b == 2) {
            float[] nativeGetFloatArrayFromMetadataEntry = nativeGetFloatArrayFromMetadataEntry(this.session.nativeWrapperHandle, aVar.f5036a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f5036a);
    ...
    public int getInt(int i) {
        getMetdataEntry(i, this.sketchEntry);
        C2620a aVar = this.sketchEntry;
        if (aVar.f5037b == 1 && aVar.f5038c == 1) {
            int nativeGetIntFromMetadataEntry = nativeGetIntFromMetadataEntry(this.session.nativeWrapperHandle, aVar.f5036a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f5036a);
    ...
    public int[] getIntArray(int i) {
        ...
        C2620a aVar = this.sketchEntry;
        if (aVar.f5037b == 1) {
            int[] nativeGetIntArrayFromMetadataEntry = nativeGetIntArrayFromMetadataEntry(this.session.nativeWrapperHandle, aVar.f5036a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f5036a);
    ...
    public long getLong(int i) {
        getMetdataEntry(i, this.sketchEntry);
        C2620a aVar = this.sketchEntry;
        if (aVar.f5037b == 3 && aVar.f5038c == 1) {
            long nativeGetLongFromMetadataEntry = nativeGetLongFromMetadataEntry(this.session.nativeWrapperHandle, aVar.f5036a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f5036a);
            return nativeGetLongFromMetadataEntry;
        }
        throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d, type: %2$d, count: %3$d.", new Object[]{Integer.valueOf(i), Integer.valueOf(this.sketchEntry.f5037b), Integer.valueOf(this.sketchEntry.f5038c)}));
    }
    ...
    public long[] getLongArray(int i) {
        ...
        C2620a aVar = this.sketchEntry;
        if (aVar.f5037b == 3) {
            long[] nativeGetLongArrayFromMetadataEntry = nativeGetLongArrayFromMetadataEntry(this.session.nativeWrapperHandle, aVar.f5036a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f5036a);
    ...
    public Rational getRational(int i) {
        getMetdataEntry(i, this.sketchEntry);
        C2620a aVar = this.sketchEntry;
        if (aVar.f5037b == 5 && aVar.f5038c == 1) {
            Rational nativeGetRationalFromMetadataEntry = nativeGetRationalFromMetadataEntry(this.session.nativeWrapperHandle, aVar.f5036a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f5036a);
    ...
    public Rational[] getRationalArray(int i) {
        ...
        C2620a aVar = this.sketchEntry;
        if (aVar.f5037b == 5) {
            Rational[] nativeGetRationalArrayFromMetadataEntry = nativeGetRationalArrayFromMetadataEntry(this.session.nativeWrapperHandle, aVar.f5036a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f5036a);
