...
public class Frame {
    ...
    public <T extends Trackable> Collection<T> getUpdatedTrackables(Class<T> cls) {
        Session.C2625c a = Session.C2625c.m8156a(cls);
        if (a == Session.C2625c.UNKNOWN_TO_JAVA) {
            return Collections.emptyList();
        }
        return this.session.convertNativeTrackablesToCollection(cls, nativeAcquireUpdatedTrackables(this.session.nativeWrapperHandle, this.nativeHandle, a.f5084a));
    }
