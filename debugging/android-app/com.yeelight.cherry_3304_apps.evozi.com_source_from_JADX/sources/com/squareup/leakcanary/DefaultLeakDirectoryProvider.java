...
public final class DefaultLeakDirectoryProvider implements LeakDirectoryProvider {
    ...
    public void requestWritePermission() {
        if (!hasStoragePermission()) {
            ...
            String string = this.context.getString(C3940R.string.leak_canary_permission_notification_title);
            String packageName = this.context.getPackageName();
            LeakCanaryInternals.showNotification(this.context, string, this.context.getString(C3940R.string.leak_canary_permission_notification_text, new Object[]{packageName}), createPendingIntent);
        }
    }
}
