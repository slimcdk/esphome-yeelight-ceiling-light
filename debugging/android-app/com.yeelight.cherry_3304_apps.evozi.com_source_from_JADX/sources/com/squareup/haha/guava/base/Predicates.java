...
public final class Predicates {
    ...
    static class CompositionPredicate<A, B> implements Predicate<A>, Serializable {
        ...
        /* renamed from: f */
        private Function<A, ? extends B> f6715f;

        /* renamed from: p */
        private Predicate<B> f6716p;

        private CompositionPredicate(Predicate<B> predicate, Function<A, ? extends B> function) {
            this.f6716p = (Predicate) Ascii.checkNotNull(predicate);
            this.f6715f = (Function) Ascii.checkNotNull(function);
        }
        ...
        public final boolean apply(@Nullable A a) {
            return this.f6716p.apply(this.f6715f.apply(a));
        }

        public final boolean equals(@Nullable Object obj) {
            if (obj instanceof CompositionPredicate) {
                CompositionPredicate compositionPredicate = (CompositionPredicate) obj;
                return this.f6715f.equals(compositionPredicate.f6715f) && this.f6716p.equals(compositionPredicate.f6716p);
            }
        }

        public final int hashCode() {
            return this.f6715f.hashCode() ^ this.f6716p.hashCode();
        }

        public final String toString() {
            return this.f6716p.toString() + "(" + this.f6715f.toString() + ")";
        }
    }
    ...
    /* renamed from: in */
    public static <T> Predicate<T> m10634in(Collection<? extends T> collection) {
