...
abstract class AbstractIterator<T> implements Iterator<T> {
    ...
    static /* synthetic */ class C38251 {
        ...
        static {
            ...
            L_0x0015:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.squareup.haha.guava.base.AbstractIterator.C38251.<clinit>():void");
        }
    }
    ...
    public final boolean hasNext() {
        ...
        int i = C38251.$SwitchMap$com$google$common$base$AbstractIterator$State[this.state$74e26051 - 1];
        if (i == 1) {
            return false;
        }
        if (i == 2) {
