...
public class YeelightColor2Device extends AbstractDevice {
    public static final Parcelable.Creator<YeelightColor2Device> CREATOR = new C9684a();
    ...
    static class C9684a implements Parcelable.Creator<YeelightColor2Device> {
        C9684a() {
        }

        /* renamed from: a */
        public YeelightColor2Device createFromParcel(Parcel parcel) {
            return new YeelightColor2Device(parcel, (C9684a) null);
        }
    ...
    /* synthetic */ YeelightColor2Device(Parcel parcel, C9684a aVar) {
        this(parcel);
    }
