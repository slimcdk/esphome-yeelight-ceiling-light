...
public class YeelightCeiling2Device extends AbstractDevice {
    public static final Parcelable.Creator<YeelightCeiling2Device> CREATOR = new C9677a();
    ...
    static class C9677a implements Parcelable.Creator<YeelightCeiling2Device> {
        C9677a() {
        }

        /* renamed from: a */
        public YeelightCeiling2Device createFromParcel(Parcel parcel) {
            return new YeelightCeiling2Device(parcel, (C9677a) null);
        }
    ...
    /* synthetic */ YeelightCeiling2Device(Parcel parcel, C9677a aVar) {
        this(parcel);
    }
