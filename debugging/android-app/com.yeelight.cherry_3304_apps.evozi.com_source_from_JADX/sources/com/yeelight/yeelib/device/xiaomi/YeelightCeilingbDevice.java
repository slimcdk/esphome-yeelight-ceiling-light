...
public class YeelightCeilingbDevice extends AbstractDevice {
    public static final Parcelable.Creator<YeelightCeilingbDevice> CREATOR = new C9683a();
    ...
    static class C9683a implements Parcelable.Creator<YeelightCeilingbDevice> {
        C9683a() {
        }

        /* renamed from: a */
        public YeelightCeilingbDevice createFromParcel(Parcel parcel) {
            return new YeelightCeilingbDevice(parcel, (C9683a) null);
        }
    ...
    /* synthetic */ YeelightCeilingbDevice(Parcel parcel, C9683a aVar) {
        this(parcel);
    }
