...
public class YeelightLamp7Device extends AbstractDevice {
    public static final Parcelable.Creator<YeelightLamp7Device> CREATOR = new C9695a();
    ...
    static class C9695a implements Parcelable.Creator<YeelightLamp7Device> {
        C9695a() {
        }

        /* renamed from: a */
        public YeelightLamp7Device createFromParcel(Parcel parcel) {
            return new YeelightLamp7Device(parcel, (C9695a) null);
        }
    ...
    /* synthetic */ YeelightLamp7Device(Parcel parcel, C9695a aVar) {
        this(parcel);
    }
