...
public class YeelightWifiSpeaker extends AbstractDevice {
    public static final Parcelable.Creator<YeelightWifiSpeaker> CREATOR = new C9709a();
    ...
    static class C9709a implements Parcelable.Creator<YeelightWifiSpeaker> {
        C9709a() {
        }

        /* renamed from: a */
        public YeelightWifiSpeaker createFromParcel(Parcel parcel) {
            return new YeelightWifiSpeaker(parcel, (C9709a) null);
        }
    ...
    /* synthetic */ YeelightWifiSpeaker(Parcel parcel, C9709a aVar) {
        this(parcel);
    }
