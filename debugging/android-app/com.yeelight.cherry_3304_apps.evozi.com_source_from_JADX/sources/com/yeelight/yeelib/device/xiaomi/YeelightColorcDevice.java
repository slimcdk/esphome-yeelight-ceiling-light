...
public class YeelightColorcDevice extends AbstractDevice {
    public static final Parcelable.Creator<YeelightColorcDevice> CREATOR = new C9688a();
    ...
    static class C9688a implements Parcelable.Creator<YeelightColorcDevice> {
        C9688a() {
        }

        /* renamed from: a */
        public YeelightColorcDevice createFromParcel(Parcel parcel) {
            return new YeelightColorcDevice(parcel, (C9688a) null);
        }
    ...
    /* synthetic */ YeelightColorcDevice(Parcel parcel, C9688a aVar) {
        this(parcel);
    }
