...
public class YeelightColor4Device extends AbstractDevice {
    public static final Parcelable.Creator<YeelightColor4Device> CREATOR = new C9686a();
    ...
    static class C9686a implements Parcelable.Creator<YeelightColor4Device> {
        C9686a() {
        }

        /* renamed from: a */
        public YeelightColor4Device createFromParcel(Parcel parcel) {
            return new YeelightColor4Device(parcel, (C9686a) null);
        }
    ...
    /* synthetic */ YeelightColor4Device(Parcel parcel, C9686a aVar) {
        this(parcel);
    }
