...
public class YeelightColorDevice extends AbstractDevice {
    public static final Parcelable.Creator<YeelightColorDevice> CREATOR = new C9687a();
    ...
    static class C9687a implements Parcelable.Creator<YeelightColorDevice> {
        C9687a() {
        }

        /* renamed from: a */
        public YeelightColorDevice createFromParcel(Parcel parcel) {
            return new YeelightColorDevice(parcel, (C9687a) null);
        }
    ...
    /* synthetic */ YeelightColorDevice(Parcel parcel, C9687a aVar) {
        this(parcel);
    }
