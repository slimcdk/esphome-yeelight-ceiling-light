...
public class YeelightCeiling19Device extends AbstractDevice {
    public static final Parcelable.Creator<YeelightCeiling19Device> CREATOR = new C9675a();
    ...
    static class C9675a implements Parcelable.Creator<YeelightCeiling19Device> {
        C9675a() {
        }

        /* renamed from: a */
        public YeelightCeiling19Device createFromParcel(Parcel parcel) {
            return new YeelightCeiling19Device(parcel, (C9675a) null);
        }
    ...
    /* synthetic */ YeelightCeiling19Device(Parcel parcel, C9675a aVar) {
        this(parcel);
    }
