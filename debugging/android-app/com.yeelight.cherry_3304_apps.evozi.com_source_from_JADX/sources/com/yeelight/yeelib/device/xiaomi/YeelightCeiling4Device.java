...
public class YeelightCeiling4Device extends AbstractDevice {
    public static final Parcelable.Creator<YeelightCeiling4Device> CREATOR = new C9678a();
    ...
    static class C9678a implements Parcelable.Creator<YeelightCeiling4Device> {
        C9678a() {
        }

        /* renamed from: a */
        public YeelightCeiling4Device createFromParcel(Parcel parcel) {
            return new YeelightCeiling4Device(parcel, (C9678a) null);
        }
    ...
    /* synthetic */ YeelightCeiling4Device(Parcel parcel, C9678a aVar) {
        this(parcel);
    }
