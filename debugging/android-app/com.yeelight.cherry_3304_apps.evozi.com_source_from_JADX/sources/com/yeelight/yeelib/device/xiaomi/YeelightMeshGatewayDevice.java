...
public class YeelightMeshGatewayDevice extends AbstractDevice {
    public static final Parcelable.Creator<YeelightMeshGatewayDevice> CREATOR = new C9698a();
    ...
    static class C9698a implements Parcelable.Creator<YeelightMeshGatewayDevice> {
        C9698a() {
        }

        /* renamed from: a */
        public YeelightMeshGatewayDevice createFromParcel(Parcel parcel) {
            return new YeelightMeshGatewayDevice(parcel, (C9698a) null);
        }
    ...
    /* synthetic */ YeelightMeshGatewayDevice(Parcel parcel, C9698a aVar) {
        this(parcel);
    }
