...
public class YeelightMono4Device extends AbstractDevice {
    public static final Parcelable.Creator<YeelightMono4Device> CREATOR = new C9699a();
    ...
    static class C9699a implements Parcelable.Creator<YeelightMono4Device> {
        C9699a() {
        }

        /* renamed from: a */
        public YeelightMono4Device createFromParcel(Parcel parcel) {
            return new YeelightMono4Device(parcel, (C9699a) null);
        }
    ...
    /* synthetic */ YeelightMono4Device(Parcel parcel, C9699a aVar) {
        this(parcel);
    }
