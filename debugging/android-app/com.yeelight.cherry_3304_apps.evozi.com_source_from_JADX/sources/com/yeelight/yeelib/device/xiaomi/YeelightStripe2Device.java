...
public class YeelightStripe2Device extends AbstractDevice {
    public static final Parcelable.Creator<YeelightStripe2Device> CREATOR = new C9705a();
    ...
    static class C9705a implements Parcelable.Creator<YeelightStripe2Device> {
        C9705a() {
        }

        /* renamed from: a */
        public YeelightStripe2Device createFromParcel(Parcel parcel) {
            return new YeelightStripe2Device(parcel, (C9705a) null);
        }
    ...
    /* synthetic */ YeelightStripe2Device(Parcel parcel, C9705a aVar) {
        this(parcel);
    }
