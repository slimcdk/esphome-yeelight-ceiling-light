...
public class YeelightQuickSettingTurnOnService extends TileService {
    ...
    public void onClick() {
        C9775d.m23684t().mo31613k(new C9840j("type_group", (String) null, C7563a.TURN_ON_ALL, (String) null), new C9775d.C9783h() {
            public void tokenOauthFailed() {
                ...
                BaseActivity.m24384U(YeelightQuickSettingTurnOnService.this);
            }
        });
    }
