...
/* renamed from: com.yeelight.yeelib.c.m.k0 */
public class C6979k0 extends C6039j {
    public C6979k0(String str) {
        super((String) null, "yeelink.light.meshbulb1", "", 996, "");
        mo23381L0(str);
        mo23374H0(str);
    }

    public C6979k0(String str, String str2, String str3, String str4) {
        super(str, str2, str3, 996, str4);
    ...
    /* renamed from: F */
    public int mo23303F() {
        return R$drawable.icon_yeelight_device_badge_meshbulb1_small;
    }

    /* renamed from: H */
    public int mo23306H() {
        return R$drawable.icon_yeelight_device_badge_meshbulb1_big;
    }
    ...
    public List<Property> mo27826I1() {
        ...
        List<Property> J12 = mo27827J1(3, new int[]{3, 5});
        if (J12 != null) {
    ...
    public C7638m0[] mo27830N1(C9856y yVar) {
        ...
        if (yVar.mo31893y()) {
            ...
            return new C7638m0[]{new C7638m0(mo27788M1(), 2, 3, Integer.valueOf(yVar.mo31876h()), mo27828K1(yVar))};
        }
    }
