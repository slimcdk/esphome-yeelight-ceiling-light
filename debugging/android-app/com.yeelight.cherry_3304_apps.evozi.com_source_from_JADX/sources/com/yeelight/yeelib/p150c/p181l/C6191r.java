...
import com.yeelight.yeelib.p194ui.activity.BleCfgSettingActivity;
import com.yeelight.yeelib.p194ui.view.RedSpotTipTextView;

/* renamed from: com.yeelight.yeelib.c.l.r */
public class C6191r extends C6038h {
    public C6191r(int i, String str, int i2, String str2) {
        super(i, str, i2, str2);
    }
    ...
    public View mo27771a(Activity activity, C4198d dVar) {
        ...
        relativeLayout.setOnClickListener(new C6111a(this, activity, dVar));
        return inflate;
    }
    ...
    /* renamed from: q */
    public /* synthetic */ void mo28058q(Activity activity, C4198d dVar, View view) {
