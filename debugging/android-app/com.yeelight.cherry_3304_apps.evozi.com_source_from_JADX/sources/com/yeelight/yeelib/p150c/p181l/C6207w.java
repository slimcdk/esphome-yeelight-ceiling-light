...
/* renamed from: com.yeelight.yeelib.c.l.w */
public class C6207w extends C6038h {
    public C6207w(int i, String str, int i2, String str2) {
        super(i, str, i2, str2);
    }
    ...
    public View mo27771a(Activity activity, C4198d dVar) {
        ...
        relativeLayout.setOnClickListener(new C6138f(this, activity, dVar));
        return inflate;
    }
    ...
    public Class mo27778h() {
        try {
            return Class.forName("com.yeelight.cherry.ui.activity.CurtainModeActivity");
    ...
    /* renamed from: q */
    public /* synthetic */ void mo28071q(Activity activity, C4198d dVar, View view) {
