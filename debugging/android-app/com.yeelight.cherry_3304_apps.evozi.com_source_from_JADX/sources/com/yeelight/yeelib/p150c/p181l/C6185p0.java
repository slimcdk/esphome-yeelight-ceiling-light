...
import com.yeelight.yeelib.p194ui.activity.KidLockActivity;
import com.yeelight.yeelib.p194ui.view.RedSpotTipTextView;

/* renamed from: com.yeelight.yeelib.c.l.p0 */
public class C6185p0 extends C6038h {

    /* renamed from: h */
    private TextView f13132h;

    /* renamed from: com.yeelight.yeelib.c.l.p0$a */
    class C6186a implements View.OnClickListener {

        /* renamed from: a */
        final /* synthetic */ Activity f13133a;

        /* renamed from: b */
        final /* synthetic */ C4198d f13134b;

        C6186a(Activity activity, C4198d dVar) {
            this.f13133a = activity;
            this.f13134b = dVar;
        }

        public void onClick(View view) {
            C6185p0.this.mo27785o(this.f13133a, this.f13134b.mo23372G());
        }
    }

    public C6185p0(int i, String str, int i2, String str2, boolean z) {
        super(i, str, i2, str2, z);
    }

    /* renamed from: q */
    private void m18642q() {
    }
    ...
    public View mo27771a(Activity activity, C4198d dVar) {
        ...
        relativeLayout.setOnClickListener(new C6186a(activity, dVar));
        m18642q();
    ...
    public void mo27772b() {
        TextView textView = this.f13132h;
        if (textView != null) {
