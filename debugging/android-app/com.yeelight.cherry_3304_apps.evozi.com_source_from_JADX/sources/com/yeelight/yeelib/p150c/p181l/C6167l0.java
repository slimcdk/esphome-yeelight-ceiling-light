...
import com.yeelight.yeelib.p194ui.activity.GoogleHomeLinkingActivity;
import com.yeelight.yeelib.p194ui.view.RedSpotTipTextView;

/* renamed from: com.yeelight.yeelib.c.l.l0 */
public class C6167l0 extends C6038h {
    public C6167l0(int i, String str, int i2, String str2) {
        super(i, str, i2, str2);
    }
    ...
    public View mo27771a(Activity activity, C4198d dVar) {
        ...
        ((RelativeLayout) inflate.findViewById(R$id.feature_item_root)).setOnClickListener(new C6163k(this, activity, dVar));
        return inflate;
    }
    ...
    /* renamed from: q */
    public /* synthetic */ void mo28039q(Activity activity, C4198d dVar, View view) {
