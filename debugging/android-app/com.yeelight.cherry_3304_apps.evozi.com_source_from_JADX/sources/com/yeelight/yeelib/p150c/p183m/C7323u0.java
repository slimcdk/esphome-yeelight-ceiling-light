...
/* renamed from: com.yeelight.yeelib.c.m.u0 */
public class C7323u0 extends C6039j {

    /* renamed from: com.yeelight.yeelib.c.m.u0$a */
    class C7324a implements CompletedHandler {
        ...
        public void onFailed(IotError iotError) {
            String str = C7323u0.this.f7260v;
        }

        public void onSucceed() {
            String str = C7323u0.this.f7260v;
            "setOnFromPower onSucceed: " + this.f14883a;
            C7323u0.this.mo23408d0().mo27644I0(this.f14883a);
            boolean unused = C7323u0.this.f12867y = true;
        }
    }

    /* renamed from: com.yeelight.yeelib.c.m.u0$b */
    class C7325b implements CompletedHandler {
        ...
        public void onSucceed() {
            String str = C7323u0.this.f7260v;
            "setSaveState onSucceed: " + this.f14885a;
            C7323u0.this.mo23408d0().mo27652M0(this.f14885a);
            boolean unused = C7323u0.this.f12867y = true;
        }
    }

    /* renamed from: com.yeelight.yeelib.c.m.u0$c */
    class C7326c implements CompletedHandler {
        C7326c() {
        }
    ...
    public C7323u0(String str) {
        super((String) null, "yeelink.light.ml2", "", 2342, "");
        mo23381L0(str);
        mo23374H0(str);
    }

    public C7323u0(String str, String str2, String str3, String str4) {
        super(str, str2, str3, 2342, str4);
    }
    ...
    /* renamed from: F */
    public int mo23303F() {
        return R$drawable.icon_yeelight_device_badge_ml2_small;
    }

    /* renamed from: H */
    public int mo23306H() {
        return R$drawable.icon_yeelight_device_badge_ml2_big;
    }
    ...
    public boolean mo27840Y1(int i) {
        mo27843b2(3, 11, Integer.valueOf(C10555s.m25792c((byte) i, mo23408d0().mo27683d0() ? (byte) 1 : 0, (byte) 0)), new C7324a(i));
        return true;
    }
    ...
    public boolean mo27844c2(boolean z) {
        mo27843b2(3, 11, Integer.valueOf(C10555s.m25792c((byte) mo23408d0().mo27641H(), z ? (byte) 1 : 0, (byte) 0)), new C7325b(z));
        return true;
    }
    ...
    public boolean mo23346t1() {
        mo27843b2(3, 11, Integer.valueOf(C10555s.m25792c((byte) mo23408d0().mo27641H(), mo23408d0().mo27683d0() ? (byte) 1 : 0, (byte) 1)), new C7326c());
        return true;
    }
