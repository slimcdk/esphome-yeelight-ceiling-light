...
public class BluetoothClient implements IBluetoothClient {
    ...
    public void connect(String str, BleConnectOptions bleConnectOptions, BleConnectResponse bleConnectResponse) {
        BluetoothLog.m10338v(String.format("connect %s", new Object[]{str}));
    ...
    public void disconnect(String str) {
        BluetoothLog.m10338v(String.format("disconnect %s", new Object[]{str}));
    ...
    public void indicate(String str, UUID uuid, UUID uuid2, BleNotifyResponse bleNotifyResponse) {
        BluetoothLog.m10338v(String.format("indicate %s: service = %s, character = %s", new Object[]{str, uuid, uuid2}));
    ...
    public void notify(String str, UUID uuid, UUID uuid2, BleNotifyResponse bleNotifyResponse) {
        BluetoothLog.m10338v(String.format("notify %s: service = %s, character = %s", new Object[]{str, uuid, uuid2}));
    ...
    public void read(String str, UUID uuid, UUID uuid2, BleReadResponse bleReadResponse) {
        BluetoothLog.m10338v(String.format("read character for %s: service = %s, character = %s", new Object[]{str, uuid, uuid2}));
    ...
    public void readDescriptor(String str, UUID uuid, UUID uuid2, UUID uuid3, BleReadResponse bleReadResponse) {
        BluetoothLog.m10338v(String.format("readDescriptor for %s: service = %s, character = %s", new Object[]{str, uuid, uuid2}));
    ...
    public void readRssi(String str, BleReadRssiResponse bleReadRssiResponse) {
        BluetoothLog.m10338v(String.format("readRssi %s", new Object[]{str}));
    ...
    public void search(SearchRequest searchRequest, SearchResponse searchResponse) {
        BluetoothLog.m10338v(String.format("search %s", new Object[]{searchRequest}));
        this.mClient.search(searchRequest, (SearchResponse) ProxyUtils.getUIProxy(searchResponse));
    }

    public void stopSearch() {
        BluetoothLog.m10338v(String.format("stopSearch", new Object[0]));
    ...
    public void unnotify(String str, UUID uuid, UUID uuid2, BleUnnotifyResponse bleUnnotifyResponse) {
        BluetoothLog.m10338v(String.format("unnotify %s: service = %s, character = %s", new Object[]{str, uuid, uuid2}));
    ...
    public void write(String str, UUID uuid, UUID uuid2, byte[] bArr, BleWriteResponse bleWriteResponse) {
        BluetoothLog.m10338v(String.format("write character for %s: service = %s, character = %s, value = %s", new Object[]{str, uuid, uuid2, ByteUtils.byteToString(bArr)}));
    ...
    public void writeDescriptor(String str, UUID uuid, UUID uuid2, UUID uuid3, byte[] bArr, BleWriteResponse bleWriteResponse) {
        BluetoothLog.m10338v(String.format("writeDescriptor for %s: service = %s, character = %s", new Object[]{str, uuid, uuid2}));
    ...
    public void writeNoRsp(String str, UUID uuid, UUID uuid2, byte[] bArr, BleWriteResponse bleWriteResponse) {
        BluetoothLog.m10338v(String.format("writeNoRsp %s: service = %s, character = %s, value = %s", new Object[]{str, uuid, uuid2, ByteUtils.byteToString(bArr)}));
    ...
    public void writeNoRspFast(String str, UUID uuid, UUID uuid2, byte[] bArr, BleWriteResponse bleWriteResponse) {
        BluetoothLog.m10338v(String.format("writeNoRspFast %s: service = %s, character = %s, value = %s", new Object[]{str, uuid, uuid2, ByteUtils.byteToString(bArr)}));
