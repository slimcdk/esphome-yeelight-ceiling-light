...
public class BluetoothSearchRequest implements Handler.Callback {
    ...
    private class BluetoothSearchTaskResponse implements BluetoothSearchResponse {
        ...
        public void onDeviceFounded(SearchResult searchResult) {
            BluetoothLog.m10338v(String.format("onDeviceFounded %s", new Object[]{searchResult}));
            BluetoothSearchRequest.this.notifyDeviceFounded(searchResult);
        }

        public void onSearchCanceled() {
            BluetoothLog.m10338v(String.format("%s onSearchCanceled", new Object[]{this.task}));
        }

        public void onSearchStarted() {
            BluetoothLog.m10338v(String.format("%s onSearchStarted", new Object[]{this.task}));
        }

        public void onSearchStopped() {
            BluetoothLog.m10338v(String.format("%s onSearchStopped", new Object[]{this.task}));
