...
public class BleConnectWorker implements Handler.Callback, IBleConnectWorker, IBluetoothGattResponse, ProxyInterceptor, RuntimeChecker {
        ...
        if (bluetoothGatt != null) {
            try {
                ...
                if (method != null) {
                    ...
                    BluetoothLog.m10338v(String.format("refreshDeviceCache return %b", new Object[]{Boolean.valueOf(z)}));
                    return z;
                }
            } catch (Exception e) {
    ...
    private void refreshServiceProfile() {
        BluetoothLog.m10338v(String.format("refreshServiceProfile for %s", new Object[]{this.mBluetoothDevice.getAddress()}));
    ...
    private void setConnectStatus(int i) {
        BluetoothLog.m10338v(String.format("setConnectStatus status = %s", new Object[]{Constants.getStatusText(i)}));
    ...
    public void closeGatt() {
        checkRuntime();
        BluetoothLog.m10338v(String.format("closeGatt for %s", new Object[]{getAddress()}));
    ...
    public boolean discoverService() {
        String format;
        checkRuntime();
        BluetoothLog.m10338v(String.format("discoverService for %s", new Object[]{getAddress()}));
        BluetoothGatt bluetoothGatt = this.mBluetoothGatt;
        if (bluetoothGatt == null) {
    ...
    public void onCharacteristicChanged(BluetoothGattCharacteristic bluetoothGattCharacteristic, byte[] bArr) {
        checkRuntime();
        BluetoothLog.m10338v(String.format("onCharacteristicChanged for %s: value = %s, service = 0x%s, character = 0x%s", new Object[]{this.mBluetoothDevice.getAddress(), ByteUtils.byteToString(bArr), bluetoothGattCharacteristic.getService().getUuid(), bluetoothGattCharacteristic.getUuid()}));
    ...
    public void onCharacteristicRead(BluetoothGattCharacteristic bluetoothGattCharacteristic, int i, byte[] bArr) {
        checkRuntime();
        BluetoothLog.m10338v(String.format("onCharacteristicRead for %s: status = %d, service = 0x%s, character = 0x%s, value = %s", new Object[]{this.mBluetoothDevice.getAddress(), Integer.valueOf(i), bluetoothGattCharacteristic.getService().getUuid(), bluetoothGattCharacteristic.getUuid(), ByteUtils.byteToString(bArr)}));
        GattResponseListener gattResponseListener = this.mGattResponseListener;
    ...
    public void onCharacteristicWrite(BluetoothGattCharacteristic bluetoothGattCharacteristic, int i, byte[] bArr) {
        checkRuntime();
        BluetoothLog.m10338v(String.format("onCharacteristicWrite for %s: status = %d, service = 0x%s, character = 0x%s, value = %s", new Object[]{this.mBluetoothDevice.getAddress(), Integer.valueOf(i), bluetoothGattCharacteristic.getService().getUuid(), bluetoothGattCharacteristic.getUuid(), ByteUtils.byteToString(bArr)}));
        GattResponseListener gattResponseListener = this.mGattResponseListener;
    ...
    public void onConnectionStateChange(int i, int i2) {
        checkRuntime();
        BluetoothLog.m10338v(String.format("onConnectionStateChange for %s: status = %d, newState = %d", new Object[]{this.mBluetoothDevice.getAddress(), Integer.valueOf(i), Integer.valueOf(i2)}));
        if (i == 0 && i2 == 2) {
            setConnectStatus(2);
            GattResponseListener gattResponseListener = this.mGattResponseListener;
            if (gattResponseListener != null) {
    ...
    public void onDescriptorWrite(BluetoothGattDescriptor bluetoothGattDescriptor, int i) {
        checkRuntime();
        BluetoothLog.m10338v(String.format("onDescriptorWrite for %s: status = %d, service = 0x%s, character = 0x%s, descriptor = 0x%s", new Object[]{this.mBluetoothDevice.getAddress(), Integer.valueOf(i), bluetoothGattDescriptor.getCharacteristic().getService().getUuid(), bluetoothGattDescriptor.getCharacteristic().getUuid(), bluetoothGattDescriptor.getUuid()}));
        GattResponseListener gattResponseListener = this.mGattResponseListener;
    ...
    public void onReadRemoteRssi(int i, int i2) {
        checkRuntime();
        BluetoothLog.m10338v(String.format("onReadRemoteRssi for %s, rssi = %d, status = %d", new Object[]{this.mBluetoothDevice.getAddress(), Integer.valueOf(i), Integer.valueOf(i2)}));
        GattResponseListener gattResponseListener = this.mGattResponseListener;
    ...
    public void onServicesDiscovered(int i) {
        checkRuntime();
        BluetoothLog.m10338v(String.format("onServicesDiscovered for %s: status = %d", new Object[]{this.mBluetoothDevice.getAddress(), Integer.valueOf(i)}));
        if (i == 0) {
            setConnectStatus(19);
    ...
    public boolean openGatt() {
        checkRuntime();
        BluetoothLog.m10338v(String.format("openGatt for %s", new Object[]{getAddress()}));
        if (this.mBluetoothGatt != null) {
            BluetoothLog.m10335e(String.format("Previous gatt not closed", new Object[0]));
            return true;
        }
        ...
        BluetoothLog.m10335e(String.format("openGatt failed: connectGatt return null!", new Object[0]));
        return false;
    }

    public boolean readCharacteristic(UUID uuid, UUID uuid2) {
        String format;
        BluetoothLog.m10338v(String.format("readCharacteristic for %s: service = 0x%s, character = 0x%s", new Object[]{this.mBluetoothDevice.getAddress(), uuid, uuid2}));
        checkRuntime();
    ...
    public boolean readDescriptor(UUID uuid, UUID uuid2, UUID uuid3) {
        String format;
        BluetoothLog.m10338v(String.format("readDescriptor for %s: service = 0x%s, character = 0x%s, descriptor = 0x%s", new Object[]{this.mBluetoothDevice.getAddress(), uuid, uuid2, uuid3}));
        checkRuntime();
        BluetoothGattCharacteristic character = getCharacter(uuid, uuid2);
        if (character == null) {
            format = String.format("characteristic not exist!", new Object[0]);
    ...
    public boolean readRemoteRssi() {
        String format;
        checkRuntime();
        BluetoothLog.m10338v(String.format("readRemoteRssi for %s", new Object[]{getAddress()}));
        BluetoothGatt bluetoothGatt = this.mBluetoothGatt;
        if (bluetoothGatt == null) {
            format = String.format("ble gatt null", new Object[0]);
    ...
    public boolean refreshDeviceCache() {
        String format;
        BluetoothLog.m10338v(String.format("refreshDeviceCache for %s", new Object[]{getAddress()}));
        checkRuntime();
        BluetoothGatt bluetoothGatt = this.mBluetoothGatt;
        if (bluetoothGatt == null) {
            format = String.format("ble gatt null", new Object[0]);
    ...
    public boolean setCharacteristicIndication(UUID uuid, UUID uuid2, boolean z) {
        String format;
        checkRuntime();
        BluetoothLog.m10338v(String.format("setCharacteristicIndication for %s, service = %s, character = %s, enable = %b", new Object[]{getAddress(), uuid, uuid2, Boolean.valueOf(z)}));
        BluetoothGattCharacteristic character = getCharacter(uuid, uuid2);
        if (character == null) {
            format = String.format("characteristic not exist!", new Object[0]);
    ...
    public boolean setCharacteristicNotification(UUID uuid, UUID uuid2, boolean z) {
        String format;
        checkRuntime();
        BluetoothLog.m10338v(String.format("setCharacteristicNotification for %s, service = %s, character = %s, enable = %b", new Object[]{getAddress(), uuid, uuid2, Boolean.valueOf(z)}));
        BluetoothGattCharacteristic character = getCharacter(uuid, uuid2);
        if (character == null) {
            format = String.format("characteristic not exist!", new Object[0]);
    ...
    public boolean writeCharacteristic(UUID uuid, UUID uuid2, byte[] bArr) {
        String format;
        BluetoothLog.m10338v(String.format("writeCharacteristic for %s: service = 0x%s, character = 0x%s, value = 0x%s", new Object[]{this.mBluetoothDevice.getAddress(), uuid, uuid2, ByteUtils.byteToString(bArr)}));
        checkRuntime();
        BluetoothGattCharacteristic character = getCharacter(uuid, uuid2);
        if (character == null) {
            format = String.format("characteristic not exist!", new Object[0]);
    ...
    public boolean writeCharacteristicWithNoRsp(UUID uuid, UUID uuid2, byte[] bArr) {
        String format;
        BluetoothLog.m10338v(String.format("writeCharacteristicWithNoRsp for %s: service = 0x%s, character = 0x%s, value = 0x%s", new Object[]{this.mBluetoothDevice.getAddress(), uuid, uuid2, ByteUtils.byteToString(bArr)}));
        checkRuntime();
        BluetoothGattCharacteristic character = getCharacter(uuid, uuid2);
        if (character == null) {
            format = String.format("characteristic not exist!", new Object[0]);
    ...
    public boolean writeDescriptor(UUID uuid, UUID uuid2, UUID uuid3, byte[] bArr) {
        String format;
        BluetoothLog.m10338v(String.format("writeDescriptor for %s: service = 0x%s, character = 0x%s, descriptor = 0x%s, value = 0x%s", new Object[]{this.mBluetoothDevice.getAddress(), uuid, uuid2, uuid3, ByteUtils.byteToString(bArr)}));
        checkRuntime();
        BluetoothGattCharacteristic character = getCharacter(uuid, uuid2);
        if (character == null) {
            format = String.format("characteristic not exist!", new Object[0]);
