package com.p146mi.iot.service.push.subscribe;
...
import com.p146mi.iot.common.util.SpecUtil;
...
public class SpecNotificationManager {
    ...
    public void addSubscription(SubscriptionInfo subscriptionInfo) {
        ...
        "addSubscription did = " + tag + ", sub props size = " + subscriptionInfo.getProperties().size();
        try {
