    ...
    private void initHandler() {
        ...
        this.mPollHandler = new Handler(this.mHandlerThread.getLooper()) {
            public void handleMessage(Message message) {
                ...
                int code;
                String str;
                Logger.m10629d(VoiceInvokeTask.TAG, "handleMessage");
                int i = message.what;
                JSONObject jSONObject = (JSONObject) message.obj;
                if (i >= 3) {
                    try {
                        access$000 = VoiceInvokeTask.this.mHandler;
                        code = MiotError.REQUEST_TIMEOUT.getCode();
                        str = MiotError.REQUEST_TIMEOUT.getMessage();
                    ...
                    if (pollResult == null) {
                        VoiceInvokeTask.this.mHandler.onFailed(MiotError.REQUEST_INVALID.getCode(), MiotError.REQUEST_INVALID.getMessage());
                        return;
    ...
    public void deliveryResult(MiotError miotError, Void voidR) {
        try {
            if (miotError.equals(MiotError.f6706OK)) {
                ...
                Logger.m10629d(TAG, "sendMessage before");
                this.mPollHandler.sendMessage(obtain);
                Logger.m10629d(TAG, "sendMessage after");
                return;
            }
