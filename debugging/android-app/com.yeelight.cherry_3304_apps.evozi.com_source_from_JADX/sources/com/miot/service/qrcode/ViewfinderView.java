...
public final class ViewfinderView extends View {
    ...
    private List<C0829p> lastPossibleResultPoints;
    private final Paint mTextPaint = new Paint(1);
    private final int maskColor;
    private final Paint paint = new Paint(1);
    private List<C0829p> possibleResultPoints;
    ...
    public ViewfinderView(Context context, AttributeSet attributeSet) {
        ...
        this.resultColor = resources.getColor(C3602R.color.result_view);
        this.laserColor = Color.parseColor("#FF0099FF");
        this.resultPointColor = resources.getColor(C3602R.color.possible_result_points);
        this.mTextPaint.setColor(resources.getColor(C3602R.color.white));
        this.mTextPaint.setTextSize((float) DisplayUtils.dp2px(context, 14.7f));
        this.scannerAlpha = 0;
        this.possibleResultPoints = new ArrayList(5);
        this.lastPossibleResultPoints = null;
    }

    public void addPossibleResultPoint(C0829p pVar) {
        List<C0829p> list = this.possibleResultPoints;
        synchronized (list) {
            list.add(pVar);
            int size = list.size();
            if (size > 20) {
