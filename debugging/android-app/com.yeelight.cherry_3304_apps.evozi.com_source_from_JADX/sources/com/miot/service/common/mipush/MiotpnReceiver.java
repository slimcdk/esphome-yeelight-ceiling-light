...
public class MiotpnReceiver extends PushMessageReceiver {
    ...
    private void processCommand(Context context, MiPushCommandMessage miPushCommandMessage) {
        ...
        if (((command.hashCode() == -690213213 && command.equals(MiPushClient.COMMAND_REGISTER)) ? (char) 0 : 65535) == 0) {
            "processCommand: " + miPushCommandMessage.getCommand() + ", context: " + context;
    ...
    private void processMessage(Context context, MiPushMessage miPushMessage) {
        "process push message: " + miPushMessage.getContent();
        try {
            ...
            Logger.m10630e(TAG, e.getMessage());
    ...
    public void onNotificationMessageArrived(Context context, MiPushMessage miPushMessage) {
        "onNotificationMessageArrived: " + miPushMessage;
        processMessage(context, miPushMessage);
    }

    public void onNotificationMessageClicked(Context context, MiPushMessage miPushMessage) {
        "onNotificationMessageClicked: " + miPushMessage;
    ...
    public void onReceivePassThroughMessage(Context context, MiPushMessage miPushMessage) {
        "onReceivePassThroughMessage: " + miPushMessage;
        processMessage(context, miPushMessage);
    }
}
