...
public class MiotCloudApi {
            ...
            public void onResponse(int i, byte[] bArr) {
                ...
                if (i != 0 || ByteUtils.isEmpty(bArr)) {
                    ...
                    if (i3 == 0) {
                        ...
                        MiotCloudApi.blemeshReportDevInfo(people, str2, new String(bArr2), "", "", "", "", responseHandler);
                        return;
                    }
                }
    ...
    public static HttpResponse editScene(People people, SceneBean sceneBean) {
        ...
        try {
            jSONObject = new JSONObject(new C0664f().mo8712r(sceneBean));
        } catch (JSONException e) {
            e.printStackTrace();
            jSONObject = null;
        }
    ...
    public static HttpResponse getDeviceLog(People people, DeviceLogQueryParams deviceLogQueryParams) {
        JSONObject jSONObject;
        try {
            jSONObject = new JSONObject(new C0664f().mo8712r(deviceLogQueryParams));
        } catch (JSONException e) {
            e.printStackTrace();
            jSONObject = null;
        }
