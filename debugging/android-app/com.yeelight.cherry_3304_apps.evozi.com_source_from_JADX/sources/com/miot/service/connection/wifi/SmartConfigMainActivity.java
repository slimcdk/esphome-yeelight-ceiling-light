...
public class SmartConfigMainActivity extends Activity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(C3602R.layout.smart_config_main_layout);
        this.mContainer = (FrameLayout) findViewById(C3602R.C3604id.main_container);
        prepareConfigData();
        registerListener();
        startFirstPage();
    }
    ...
    public void startFirstPage() {
        ...
        if (i == 7) {
            ...
            prepareStage = ((Boolean) SmartConfigDataProvider.getInstance().get(SmartConfigDataProvider.KEY_USE_QR_CODE, Boolean.FALSE)).booleanValue() ? SmartConfigStep.Step.STEP_DEVICE_INFO : ((Boolean) SmartConfigDataProvider.getInstance().get(SmartConfigDataProvider.KEY_IS_MI_WIFI_IN_DEVICE_LIST, Boolean.FALSE)).booleanValue() ? SmartConfigStep.Step.STEP_GET_ROUTER_INFO : SmartConfigStep.Step.STEP_CHOOSE_WIFI;
