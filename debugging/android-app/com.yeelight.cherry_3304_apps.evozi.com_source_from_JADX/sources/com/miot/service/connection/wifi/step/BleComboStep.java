...
public class BleComboStep extends ConfigStep implements ComboConnectResponse {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent != null) {
                ...
                if (TextUtils.equals(stringExtra, BleComboStep.this.mComboAddress)) {
                    BluetoothLog.m10338v("BleComboStep bluetooth connect status = " + intExtra);
                }
                if ("action.connect_status_changed".equalsIgnoreCase(action) && TextUtils.equals(stringExtra, BleComboStep.this.mComboAddress) && intExtra == 32) {
                    BluetoothLog.m10338v("BleComboStep disconnect mac = " + BleComboStep.this.mComboAddress);
    ...
    private ConfigStep.DeviceFinderCallback mCallback = new ConfigStep.DeviceFinderCallback() {
        public void onDeviceConnectionBind(MiotWanDevice miotWanDevice) {
            BluetoothLog.m10339w("BleComboStep DeviceFinderCallback.onDeviceConnectionBind");
        ...
        public void onDeviceConnectionFailure() {
            BluetoothLog.m10339w("BleComboStep DeviceFinderCallback.onDeviceConnectionFailure");
        }

        public void onDeviceConnectionSuccess(MiotWanDevice miotWanDevice) {
            BluetoothLog.m10339w("BleComboStep DeviceFinderCallback.onDeviceConnectionSuccess");
            int unused = BleComboStep.this.mCurrentIndex = 2;
            BleComboStep.this.onCurrentIndexSuccess(2);
        }
    };
    ...
    static /* synthetic */ class C370510 {
    ...
    private void retryComboConnect() {
        BluetoothLog.m10338v("BleComboStep.retryComboConnect");
    ...
    public ArrayList<ConfigStep.ConfigTime> getAllConfigStages() {
        ...
        configTime3.index = 2;
        configTime3.time = MiStatInterface.MIN_UPLOAD_INTERVAL;
    ...
    public int getCurrentStageIndex() {
        ...
        if (i != 0) {
            if (i == 1) {
                BluetoothLog.m10339w("BleComboStep.getCurrentStageIndex mCurrentIndex = SEND_SSID_AND_PASSWD_INDEX, mUseBleConfig = " + this.mUseBleConfig);
        ...
        BluetoothLog.m10339w("BleComboStep.getCurrentStageIndex mCurrentIndex = CONNECT_INDEX, mUseBleConfig = " + this.mUseBleConfig);
        if (this.mUseBleConfig) {
            return 0;
        }
    ...
    public void handleMessage(Message message) {
        int i = message.what;
        if (i == 101) {
            BluetoothLog.m10339w("BleComboStep.handleMessage NETWORK_STATE_CHANGED + use ble:" + this.mUseBleConfig);
            if (!this.mUseBleConfig) {
            ...
            if (i == 123) {
                BluetoothLog.m10339w("BleComboStep.handleMessage MSG_RECONNECT_DEVICE_AP");
                this.mUseBleConfig = false;
            } else if (i == 125) {
                BluetoothLog.m10339w("BleComboStep.handleMessage MSG_CONNECT_BLE_TIME_OUT");
                this.mUseBleConfig = false;
                ...
                BluetoothLog.m10339w("BleComboStep.handleMessage MSG_BLE_NOTIFY_TIME_OUT, current notifyStatus = " + this.mNotifyStatus);
                getHandler().removeMessages(SmartConfigStep.MSG_BLE_NOTIFY_TIME_OUT);
                ...
                BluetoothLog.m10339w("BleComboStep.handleMessage MSG_SEND_DEVICE_MSG");
                startConnectionAsso();
                return;
            } else if (i != 115) {
                ...
                BluetoothLog.m10339w("BleComboStep.handleMessage MSG_DISCONNECT_TIME_OUT");
                onStopConnection();
                return;
            }
            startConnectToDeviceAp();
        } else {
            BluetoothLog.m10339w("BleComboStep.handleMessage MSG_UPDATE_DEVICE_STATE");
            if (getHandler() != null) {
                ...
                public void run() {
                    if (BleComboStep.this.mCurrentIndex == 0) {
                        ...
                        if (bleComboStep.isDeviceApConnected(bleComboStep.mScanResult)) {
                            ...
                            BleComboStep.this.getHandler().removeMessages(SmartConfigStep.MSG_RECONNECT_DEVICE_AP);
    ...
    public void onFinishStep() {
        ...
        this.mDummyHandler.removeCallbacksAndMessages((Object) null);
        MiotBleClient.getInstance().stopSearch();
        ...
        BluetoothLog.m10338v(String.format("wifi restore ? -> %b", new Object[]{Boolean.valueOf(booleanValue)}));
        if (booleanValue) {
    ...
    public void onNotifyStatus(int i) {
        ...
        BluetoothLog.m10338v("onNotifyStatus " + getNotifyStatusString(i));
    ...
    public void onSearchComboAddress(String str) {
        BluetoothLog.m10339w(String.format("BleComboStep.onSearchComboAddress, mac = %s", new Object[]{str}));
    ...
    public void onSendSSIDAndPassWd(int i) {
        BluetoothLog.m10339w("BleComboStep.onSendSSIDAndPassWd " + i);
        if (i != 0) {
    ...
    public SmartConfigStep.Step onStageTimeOut(int i) {
        ...
        if (i != 0) {
            if (i == 1) {
                BluetoothLog.m10339w("BleComboStep.onStageTimeOut SEND_SSID_AND_PASSWD_INDEX, mUseBleConfig = " + this.mUseBleConfig);
                if (!this.mUseBleConfig) {
                ...
                if (i2 == 1) {
                    BluetoothLog.m10339w(">>> current notifyStatus == NOTIFY_CONNECTING_ROUTER");
                    return SmartConfigStep.Step.STEP_BLE_ERROR;
                } else if (i2 == 2) {
                    BluetoothLog.m10339w(">>> current notifyStatus == NOTIFY_CONNECTING_ROUTER");
                    return SmartConfigStep.Step.STEP_BLE_ERROR;
                } else if (i2 == 5) {
                    BluetoothLog.m10339w(">>> current notifyStatus == NOTIFY_AUTHENTICATION_ERROR");
                    return SmartConfigStep.Step.STEP_BLE_PWD_ERROR;
                } else if (i2 == 4) {
                    BluetoothLog.m10339w(">>> current notifyStatus == NOTIFY_UNKNONW_ERROR");
                    return SmartConfigStep.Step.STEP_BLE_ERROR;
                } else if (i2 == 3) {
                    return SmartConfigStep.Step.STEP_BLE_ERROR;
                } else {
                    BluetoothLog.m10339w(String.format(">>> Unknown notifyStatus = %d", new Object[]{Integer.valueOf(i2)}));
                }
            } else if (i == 2) {
        ...
        BluetoothLog.m10339w("BleComboStep.onStageTimeOut CONNECT_INDEX, mUseBleConfig = " + this.mUseBleConfig);
        if (this.mUseBleConfig) {
    ...
    public void onStopConnection() {
        QConnectCallback qConnectCallback;
        ConnectivityManager.NetworkCallback networkCallback;
        BluetoothLog.m10339w("BleComboStep.onStopConnection");
        getHandler().removeMessages(112);
        getHandler().removeMessages(114);
    ...
    public JSONObject parseRpcResponse(String str) {
        ...
        try {
            ...
            if (C370510.$SwitchMap$com$miot$service$connection$wifi$ErrorCode[ErrorCode.valueof(jSONObject.optInt("code")).ordinal()] != 1) {
                return null;
            }
    ...
    public void setMiioRouter(String str, String str2, Class cls) {
        ...
        if (people == null) {
            BluetoothLog.m10335e(String.format("setMiioRouter people == null", new Object[0]));
        ...
        if (!TextUtils.isEmpty(gatewayAddr)) {
            MiioLocalAPI.async_get_token(gatewayAddr, new MiioLocalRpcResponse() {
                public void onResponse(final String str) {
                    BluetoothLog.m10339w("RPC response: " + str);
                    if (BleComboStep.this.getHandler() != null) {
                                    ...
                                    if (!TextUtils.isEmpty(gatewayAddr)) {
                                        MiioLocalAPI.async_rpc(gatewayAddr, jSONObject.toString(), BleComboStep.this.mDid, BleComboStep.this.mToken, new MiioLocalRpcResponse() {
                                            public void onResponse(String str) {
                                                BluetoothLog.m10339w("BleComboStep. setMiioRouter result: " + str);
    ...
    public void startConnectToBle() {
        BluetoothLog.m10339w("BleComboStep.startConnectToBle");
        this.mCurrentIndex = 0;
    ...
    public void startConnectToDeviceAp() {
        BluetoothLog.m10339w("BleComboStep.startConnectToDeviceAp");
        WifiInfo connectionInfo = this.mWifiManager.getConnectionInfo();
        if (TextUtils.isEmpty(connectionInfo.getSSID()) || !ConnectionUtils.isEqualWifi(connectionInfo.getSSID(), this.mScanResult.SSID) || connectionInfo.getSupplicantState() != SupplicantState.COMPLETED) {
            ...
            if (qConnectCallback == null || qConnectCallback.callback == null) {
                C37137 r8 = new QConnectCallback() {
                    public void onAvailable(Network network) {
                        super.onAvailable(network);
                        BluetoothLog.m10339w("connectToAP ok: " + BleComboStep.this.mScanResult.SSID);
                    }

                    public void onLost(Network network) {
                        super.onLost(network);
                        BluetoothLog.m10339w("connecttoAp onLost ");
                        if (BleComboStep.this.mCurrentIndex == 0) {
                            BleComboStep.this.getHandler().post(new Runnable() {
                                public void run() {
                    ...
                    public void onUnavailable() {
                        super.onUnavailable();
                        BluetoothLog.m10339w("connectToAP onUnavailable!");
                        if (BleComboStep.this.mCurrentIndex == 0) {
                            BleComboStep.this.getHandler().post(new Runnable() {
                                public void run() {
                                    BleComboStep.this.triggerTimeoutNow();
    ...
    public void startConnection(int i) {
        ...
        if (i == 0) {
            ...
            BluetoothLog.m10339w("BleComboStep.startConnection CONNECT_INDEX, mUseBleConfig = " + this.mUseBleConfig);
        } else if (i != 1) {
            if (i == 2) {
                BluetoothLog.m10339w("BleComboStep.startConnection GET_NEW_DEVICE_INDEX");
                BluetoothLog.m10338v(">>> current mNotifyStatus = " + getNotifyStatusString(this.mNotifyStatus));
                onStopConnection();
                startSearchNewDevice();
                return;
            }
        ...
        BluetoothLog.m10339w("BleComboStep.startConnection SEND_SSID_AND_PASSWD_INDEX, mUseBleConfig = " + this.mUseBleConfig);
        if (this.mUseBleConfig) {
            BluetoothLog.m10338v(">>> current mNotifyStatus = " + getNotifyStatusString(this.mNotifyStatus));
            int i2 = this.mNotifyStatus;
            if (i2 == 0) {
    ...
    public void startConnectionAsso() {
        Network network;
        BluetoothLog.m10339w("BleComboStep.startConnectionAsso");
    ...
    public void startSearchNewDevice() {
        BluetoothLog.m10339w("BleComboStep.startSearchNewDevice mDid = " + this.mDid);
