...
public class ConnectSelectApFailedStep extends SmartConfigStep {
    ...
    public void onCreateStep(Context context) {
        ...
        this.mIcon.setImageResource(C3602R.C3603drawable.kuailian_failed_icon);
        this.mMainTitle.setText(C3602R.string.smart_config_connect_ap_error_title);
        this.mSubMainTitle.setText(C3602R.string.smart_config_connect_ap_error_sub_title);
