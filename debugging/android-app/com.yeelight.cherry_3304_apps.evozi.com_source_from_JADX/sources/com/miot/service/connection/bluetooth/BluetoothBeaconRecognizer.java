...
public class BluetoothBeaconRecognizer implements IBluetoothRecognizer {
    ...
    public String recognize(SearchResult searchResult) {
        ...
        BluetoothLog.m10338v(String.format("BluetoothBeaconRecognizer.recognize for %s", new Object[]{searchResult.getAddress()}));
        ...
        BluetoothLog.m10334d("addCombo    " + parseMiotBleAdvPacket.comboKey + "  device.getAddress()    " + searchResult.getAddress());
