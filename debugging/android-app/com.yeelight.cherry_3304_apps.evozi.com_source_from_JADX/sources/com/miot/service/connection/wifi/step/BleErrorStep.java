...
public class BleErrorStep extends SmartConfigStep {
    ...
    public boolean onBackPressed() {
        BluetoothLog.m10338v(String.format("%s.onBackPressed", new Object[]{BleErrorStep.class.getSimpleName()}));
    ...
    public void onCreateStep(Context context) {
        ...
        this.mMainTitle.setText(C3602R.string.ble_combo_error);
    ...
    public void onFinishStep() {
        BluetoothLog.m10338v(String.format("%s.onFinishStep", new Object[]{BleErrorStep.class.getSimpleName()}));
    }

    public void onPauseStep() {
        BluetoothLog.m10338v(String.format("%s.onPauseStep", new Object[]{BleErrorStep.class.getSimpleName()}));
    }

    public void onResumeStep() {
        BluetoothLog.m10338v(String.format("%s.onResumeStep", new Object[]{BleErrorStep.class.getSimpleName()}));
    }
}
