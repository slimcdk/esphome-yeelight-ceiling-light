...
public class ComboDeviceManager {
    ...
    private static boolean checkFuture(Future<String> future) {
        BluetoothLog.m10338v(String.format("checkFuture %s", new Object[]{future}));
        if (future != null) {
            BluetoothLog.m10338v(String.format(">>> isCanceled = %b", new Object[]{Boolean.valueOf(future.isCancelled())}));
            BluetoothLog.m10338v(String.format(">>> isDone = %b", new Object[]{Boolean.valueOf(future.isDone())}));
        }
        if (future != null && !future.isCancelled()) {
            try {
                ...
                BluetoothLog.m10338v(String.format(">>> result = %s", new Object[]{future.get()}));
    ...
    private static void findComboMac(final String str, final IFindComboResponse iFindComboResponse) {
        BluetoothLog.m10339w(String.format("BluetoothApi.findComboMac subMac = %s", new Object[]{str}));
        if (str != null && str.length() == 4) {
            String address = ComboCollector.getAddress(str);
            final Bundle bundle = new Bundle();
            if (!TextUtils.isEmpty(address)) {
                BluetoothLog.m10339w("findComboMac by BluetoothDeviceSearch");
    ...
    public static String searchComboDeviceSync(ScanResult scanResult) {
        ...
        BluetoothLog.m10339w("kuailian device uid is " + deviceUid);
        final Bundle bundle = new Bundle();
        ...
        findComboMac(deviceUid, new IFindComboResponse() {
            public void onResponse(int i, Bundle bundle) {
                ...
                BluetoothLog.m10338v(String.format("ComboDeviceManager.searchComboDeviceSync onResponse %s, mac = (%s)", new Object[]{Code.toString(i), str}));
                if (i == 0 && bundle != null) {
