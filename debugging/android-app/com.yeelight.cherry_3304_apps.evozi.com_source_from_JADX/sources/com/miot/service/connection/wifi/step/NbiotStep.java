...
public class NbiotStep extends ConfigStep {
    ...
    private void getDeviceInfo(String str) {
        BluetoothLog.m10338v(String.format("getDeviceInfo did = %s", new Object[]{str}));
    }
    ...
    private void requestBindKey(QrCodeParser qrCodeParser2) {
        "response requestBindKey:" + qrCodeParser2;
    }
    ...
    public int getCurrentStageIndex() {
        BluetoothLog.m10338v(String.format("getCurrentStageIndex return 0", new Object[0]));
        return 0;
    }
    ...
    public void onCreateStep(Context context) {
        BluetoothLog.m10338v("NbiotStep is onCreateStep");
    ...
    public void onFinishStep() {
        BluetoothLog.m10338v(String.format("onFinishStep QRCodeStep", new Object[0]));
        getHandler().removeMessages(SmartConfigStep.MSG_GET_DEVICE_MODEL);
        super.onFinishStep();
    }

    public SmartConfigStep.Step onStageTimeOut(int i) {
        BluetoothLog.m10338v(String.format("onStageTimeOut index = %d", new Object[]{Integer.valueOf(i)}));
        return null;
    }
