...
public class DeviceFinder {
    ...
    public static JSONObject parse(String str) {
        ...
        try {
            ...
            if (C36745.$SwitchMap$com$miot$service$connection$wifi$ErrorCode[ErrorCode.valueof(jSONObject.optInt("code")).ordinal()] != 1) {
                return null;
            }
            ...
            checkStatusHandlerTask2.setCheckStatusRunnable(new CheckStatusHandlerTask.MyRunnable() {
                public void run(Handler handler) {
                    ...
                    if (TextUtils.isEmpty(selectedSSID) || TextUtils.isEmpty(selectedBSSID)) {
                        Logger.m10630e(DeviceFinder.TAG, "wifi bssid is null!");
