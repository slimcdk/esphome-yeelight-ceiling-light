...
public class RegisterPeopleTask extends MiotTask<Void> {
    ...
    static /* synthetic */ class C38031 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.miot.service.people.RegisterPeopleTask.C38031.<clinit>():void");
        }
    }
    ...
    public HttpResponse executeRequest() {
        int i = C38031.$SwitchMap$com$miot$service$people$RegisterPeopleTask$Type[this.mType.ordinal()];
        if (i == 1) {
            return doRegister();
        }
        if (i != 2) {
