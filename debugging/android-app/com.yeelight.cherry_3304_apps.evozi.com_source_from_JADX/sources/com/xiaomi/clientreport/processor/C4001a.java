...
import com.xiaomi.push.C4492ac;
...
public class C4001a implements IEventProcessor {

    /* renamed from: a */
    protected Context f6820a;

    /* renamed from: a */
    private HashMap<String, ArrayList<C3990a>> f6821a;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:10:?, code lost:
        com.xiaomi.channel.commonutils.logger.C3989b.m10681d("eventData read from cache file failed because magicNumber error");
     */
    /* JADX WARNING: Code restructure failed: missing block: B:19:0x003a, code lost:
        com.xiaomi.channel.commonutils.logger.C3989b.m10681d(r9);
     */
    ...
    private java.util.List<java.lang.String> m10712a(java.lang.String r9) {
        /*
            r8 = this;
        ...
        L_0x0021:
            com.xiaomi.channel.commonutils.logger.C3989b.m10681d(r6)     // Catch:{ Exception -> 0x006d, all -> 0x006a }
            goto L_0x0066
        L_0x0025:
            int r9 = com.xiaomi.push.C4492ac.m13260a((byte[]) r2)     // Catch:{ Exception -> 0x006d, all -> 0x006a }
        ...
        L_0x003a:
            com.xiaomi.channel.commonutils.logger.C3989b.m10681d(r9)     // Catch:{ Exception -> 0x006d, all -> 0x006a }
            goto L_0x0066
        L_0x003e:
            int r9 = com.xiaomi.push.C4492ac.m13260a((byte[]) r3)     // Catch:{ Exception -> 0x006d, all -> 0x006a }
            r4 = 1
        ...
        L_0x0072:
            r9 = move-exception
        L_0x0073:
            com.xiaomi.channel.commonutils.logger.C3989b.m10678a((java.lang.Throwable) r9)     // Catch:{ all -> 0x0070 }
        ...
        L_0x007f:
            goto L_0x007e
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xiaomi.clientreport.processor.C4001a.m10712a(java.lang.String):java.util.List");
    }

    /* renamed from: a */
    private void m10713a(RandomAccessFile randomAccessFile, FileLock fileLock) {
    ...
    /* renamed from: a */
    private void m10714a(String str, String str2) {
        C3992a a = C3992a.m10684a(this.f6820a);
        EventClientReport a2 = a.mo22724a(5001, "24:" + str + Constants.ACCEPT_TIME_SEPARATOR_SP + str2);
        ArrayList arrayList = new ArrayList();
        arrayList.add(a2.toJsonString());
        mo22748a((List<String>) arrayList);
    }

    /* renamed from: a */
    private C3990a[] mo22749a(C3990a[] aVarArr) {
        RandomAccessFile randomAccessFile;
        FileLock fileLock;
        BufferedOutputStream bufferedOutputStream;
        String b = m10716b(aVarArr[0]);
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        C3989b.m10677a("event data write to cache file failed cause exception", (Throwable) e);
                        C4942y.m15884a((Closeable) bufferedOutputStream);
                        m10713a(randomAccessFile, fileLock);
                        return null;
                    } catch (Throwable th) {
                        th = th;
                        bufferedOutputStream2 = bufferedOutputStream;
                        C4942y.m15884a((Closeable) bufferedOutputStream2);
                        m10713a(randomAccessFile, fileLock);
                        throw th;
                    }
                } catch (Throwable th2) {
                    ...
                    if (aVar != null) {
                        ...
                        if (stringToBytes != null && stringToBytes.length >= 1) {
                            if (stringToBytes.length <= 4096) {
                                if (!C4536bj.m13451a(this.f6820a, b)) {
                                    int length = aVarArr.length - i;
                                    C3990a[] aVarArr2 = new C3990a[length];
                                    System.arraycopy(aVarArr, i, aVarArr2, 0, length);
                                    C4942y.m15884a((Closeable) bufferedOutputStream);
                                    m10713a(randomAccessFile, fileLock);
                                    return aVarArr2;
                                }
                                bufferedOutputStream.write(C4492ac.m13261a(-573785174));
                                bufferedOutputStream.write(C4492ac.m13261a(stringToBytes.length));
                                bufferedOutputStream.write(stringToBytes);
                                bufferedOutputStream.flush();
                                i++;
                            }
                        }
                        C3989b.m10681d("event data throw a invalid item ");
                    }
                }
            } catch (Exception e3) {
                e = e3;
    ...
    /* renamed from: b */
    private String m10716b(C3990a aVar) {
        File externalFilesDir = this.f6820a.getExternalFilesDir("event");
        String a = mo22747a(aVar);
        ...
        for (int i = 0; i < 100; i++) {
            String str2 = str + i;
            if (C4536bj.m13451a(this.f6820a, str2)) {
                return str2;
            }
        }
        return null;
    ...
    public void mo22745a() {
        /*
            r12 = this;
            android.content.Context r0 = r12.f6820a
            java.lang.String r1 = "event"
            java.lang.String r2 = "eventUploading"
            com.xiaomi.push.C4536bj.m13452a(r0, r1, r2)
            android.content.Context r0 = r12.f6820a
            java.io.File[] r0 = com.xiaomi.push.C4536bj.m13451a((android.content.Context) r0, (java.lang.String) r2)
        ...
        L_0x003b:
            ...
            com.xiaomi.channel.commonutils.logger.C3989b.m10681d(r7)     // Catch:{ Exception -> 0x00f1 }
            java.lang.String r7 = r6.getName()     // Catch:{ Exception -> 0x00f1 }
            android.content.Context r8 = r12.f6820a     // Catch:{ Exception -> 0x00f1 }
            ...
            r12.m10714a((java.lang.String) r7, (java.lang.String) r8)     // Catch:{ Exception -> 0x00f1 }
        ...
        L_0x0094:
            ...
            com.xiaomi.push.C4942y.m15883a((java.io.File) r8)     // Catch:{ Exception -> 0x00ec, all -> 0x00e9 }
            ...
            java.util.List r4 = r12.m10712a((java.lang.String) r7)     // Catch:{ Exception -> 0x00e6, all -> 0x00e3 }
            r12.mo22748a((java.util.List<java.lang.String>) r4)     // Catch:{ Exception -> 0x00e6, all -> 0x00e3 }
        ...
        L_0x00f1:
            r6 = move-exception
        L_0x00f2:
            com.xiaomi.channel.commonutils.logger.C3989b.m10678a((java.lang.Throwable) r6)     // Catch:{ all -> 0x00ef }
        ...
        L_0x0129:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xiaomi.clientreport.processor.C4001a.mo22745a():void");
    }

    /* renamed from: a */
    public void mo22746a(Context context) {
        this.f6820a = context;
    }

    /* renamed from: a */
    public void m10719a(C3990a aVar) {
        if ((aVar instanceof EventClientReport) && this.f6821a != null) {
            EventClientReport eventClientReport = (EventClientReport) aVar;
            String a = mo22747a((C3990a) eventClientReport);
            ArrayList arrayList = this.f6821a.get(a);
            if (arrayList == null) {
                arrayList = new ArrayList();
            }
            arrayList.add(eventClientReport);
            this.f6821a.put(a, arrayList);
        }
    }

    /* renamed from: a */
    public void mo22748a(List<String> list) {
        C4536bj.m13453a(this.f6820a, list);
    }

    /* renamed from: a */
    public void m10721a(C3990a[] aVarArr) {
        if (aVarArr == null || aVarArr.length == 0 || aVarArr[0] == null) {
            C3989b.m10669a("event data write to cache file failed because data null");
            return;
        }
        do {
            aVarArr = mo22749a(aVarArr);
            if (aVarArr == null || aVarArr.length <= 0 || aVarArr[0] == null) {
            }
            aVarArr = mo22749a(aVarArr);
            return;
    ...
    public void mo22750b() {
        HashMap<String, ArrayList<C3990a>> hashMap = this.f6821a;
        if (hashMap != null) {
            if (hashMap.size() > 0) {
                for (String str : this.f6821a.keySet()) {
                    ArrayList arrayList = this.f6821a.get(str);
                    if (arrayList != null && arrayList.size() > 0) {
                        C3990a[] aVarArr = new C3990a[arrayList.size()];
    ...
    public String bytesToString(byte[] bArr) {
        ...
        if (bArr != null && bArr.length >= 1) {
            if (!C3992a.m10684a(this.f6820a).mo22723a().isEventEncrypted()) {
                return C4532bf.m13435a(bArr);
            }
            String a2 = C4536bj.m13450a(this.f6820a);
            if (!TextUtils.isEmpty(a2) && (a = C4536bj.m13456a(a2)) != null && a.length > 0) {
                try {
                    return C4532bf.m13435a(Base64.decode(C4722h.m14492a(a, bArr), 2));
    ...
    public void setEventMap(HashMap<String, ArrayList<C3990a>> hashMap) {
        this.f6821a = hashMap;
    }
    ...
    public byte[] stringToBytes(String str) {
        ...
        if (!C3992a.m10684a(this.f6820a).mo22723a().isEventEncrypted()) {
            return C4532bf.m13431a(str);
        }
        String a2 = C4536bj.m13450a(this.f6820a);
        byte[] a3 = C4532bf.m13431a(str);
        if (!TextUtils.isEmpty(a2) && a3 != null && a3.length > 1 && (a = C4536bj.m13456a(a2)) != null) {
            try {
                if (a.length > 1) {
                    return C4722h.m14493b(a, Base64.encode(a3, 2));
                }
            } catch (Exception e) {
                C3989b.m10678a((Throwable) e);
            }
