...
public class C4005e {
    /* renamed from: a */
    private static PerfClientReport m10734a(PerfClientReport perfClientReport, String str) {
        long[] a;
        if (perfClientReport == null || (a = m10735a(str)) == null) {
            return null;
        }
    ...
    /* renamed from: a */
    private static PerfClientReport m10735a(String str) {
        try {
            String[] a = m10735a(str);
            ...
            C3989b.m10680c("parse per key error");
            return null;
        }
    }

    /* renamed from: a */
    public static String m10736a(PerfClientReport perfClientReport) {
        return perfClientReport.production + "#" + perfClientReport.clientInterfaceId + "#" + perfClientReport.reportType + "#" + perfClientReport.code;
    }

    /* renamed from: a */
    private static HashMap<String, String> m10737a(String str) {
        ...
        try {
            ...
            C4942y.m15884a((Closeable) bufferedReader2);
        } catch (Exception e2) {
            e = e2;
            C3989b.m10678a((Throwable) e);
            C4942y.m15884a((Closeable) bufferedReader);
    ...
    public static java.util.List<java.lang.String> m10738a(android.content.Context r7, java.lang.String r8) {
        /*
        ...
        L_0x0018:
            ...
            com.xiaomi.push.C4942y.m15883a((java.io.File) r1)     // Catch:{ Exception -> 0x00b0, all -> 0x00ad }
        ...
        L_0x004b:
            ...
            com.xiaomi.clientreport.data.PerfClientReport r0 = m10735a((java.lang.String) r0)     // Catch:{ Exception -> 0x009d, all -> 0x009b }
            r8 = r8[r5]     // Catch:{ Exception -> 0x009d, all -> 0x009b }
            com.xiaomi.clientreport.data.PerfClientReport r8 = m10734a((com.xiaomi.clientreport.data.PerfClientReport) r0, (java.lang.String) r8)     // Catch:{ Exception -> 0x009d, all -> 0x009b }
        ...
        L_0x0090:
            r8 = move-exception
            com.xiaomi.channel.commonutils.logger.C3989b.m10678a((java.lang.Throwable) r8)
        L_0x0094:
        ...
        L_0x00bb:
            r4 = r2
        L_0x00bc:
            com.xiaomi.channel.commonutils.logger.C3989b.m10678a((java.lang.Throwable) r8)     // Catch:{ all -> 0x00db }
        ...
        L_0x00f8:
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xiaomi.clientreport.processor.C4005e.m10738a(android.content.Context, java.lang.String):java.util.List");
    }

    /* renamed from: a */
    private static void m10739a(String str, HashMap<String, String> hashMap) {
        ...
        if (!TextUtils.isEmpty(str) && hashMap != null && hashMap.size() != 0) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        C3989b.m10678a((Throwable) e);
                        C4942y.m15884a((Closeable) bufferedWriter);
                    } catch (Throwable th) {
                        th = th;
                        C4942y.m15884a((Closeable) bufferedWriter);
                        throw th;
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static void m10740a(java.lang.String r13, com.xiaomi.clientreport.data.C3990a[] r14) {
        /*
        ...
        L_0x000d:
            ...
            com.xiaomi.push.C4942y.m15883a((java.io.File) r1)     // Catch:{ all -> 0x007c }
            ...
            java.util.HashMap r1 = m10735a((java.lang.String) r13)     // Catch:{ all -> 0x007d }
        ...
        L_0x003d:
            ...
            java.lang.String r4 = m10736a((com.xiaomi.clientreport.data.PerfClientReport) r4)     // Catch:{ all -> 0x007d }
            r5 = r3
        ...
        L_0x0064:
            r3 = r1
            m10741a(r3, r4, r5, r7)     // Catch:{ all -> 0x007d }
        L_0x0068:
            int r10 = r10 + 1
            goto L_0x003d
        L_0x006b:
            m10739a((java.lang.String) r13, (java.util.HashMap<java.lang.String, java.lang.String>) r1)     // Catch:{ all -> 0x007d }
        ...
        L_0x007d:
            ...
            com.xiaomi.channel.commonutils.logger.C3989b.m10680c(r13)     // Catch:{ all -> 0x0096 }
            if (r0 == 0) goto L_0x0092
            boolean r13 = r0.isValid()
            if (r13 == 0) goto L_0x0092
        ...
        L_0x008e:
            r13 = move-exception
        L_0x008f:
            com.xiaomi.channel.commonutils.logger.C3989b.m10678a((java.lang.Throwable) r13)
        L_0x0092:
            com.xiaomi.push.C4942y.m15884a((java.io.Closeable) r2)
            return
        L_0x0096:
        ...
        L_0x00a3:
            r14 = move-exception
            com.xiaomi.channel.commonutils.logger.C3989b.m10678a((java.lang.Throwable) r14)
        L_0x00a7:
            com.xiaomi.push.C4942y.m15884a((java.io.Closeable) r2)
            throw r13
        L_0x00ab:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xiaomi.clientreport.processor.C4005e.m10740a(java.lang.String, com.xiaomi.clientreport.data.a[]):void");
    }

    /* renamed from: a */
    private static void m10741a(HashMap<String, String> hashMap, String str, long j, long j2) {
        StringBuilder sb;
    ...
    /* renamed from: a */
    protected static long[] m10742a(String str) {
    ...
    /* renamed from: a */
    private static String[] m10743a(String str) {
