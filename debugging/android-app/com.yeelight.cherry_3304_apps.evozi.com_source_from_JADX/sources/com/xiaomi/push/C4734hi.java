...
public class C4734hi {

    /* renamed from: a */
    private static boolean f8964a = false;

    /* renamed from: com.xiaomi.push.hi$a */
    static class C4735a implements Runnable {

        /* renamed from: a */
        private Context f8965a;

        /* renamed from: a */
        private C4738hl f8966a;

        public C4735a(Context context, C4738hl hlVar) {
            this.f8966a = hlVar;
            this.f8965a = context;
        }

        public void run() {
            C4734hi.m14544c(this.f8965a, this.f8966a);
        }
    }

    /* renamed from: a */
    private static void m14539a(Context context) {
    ...
    /* renamed from: a */
    public static void m14540a(Context context, C4738hl hlVar) {
        C4498ai.m13271a(context).mo24725a((Runnable) new C4735a(context, hlVar));
    }

    /* renamed from: a */
    private static void m14541a(Context context, C4738hl hlVar, File file, byte[] bArr) {
        String str;
        int a;
        ...
        try {
                    ...
                    try {
                        ...
                        if (read == -1) {
                            ...
                            if (a < 1) {
                                ...
                                byte[] a2 = C4722h.m14492a(bArr, bArr3);
                                if (a2 != null) {
                                    if (a2.length != 0) {
                                        C4743hq hqVar = new C4743hq();
                                        C4776iw.m15224a(hqVar, a2);
                                        arrayList.add(hqVar);
                                        i++;
                                        i2 += a2.length;
                                        if (i >= 8 || i2 >= 10240) {
                                            C4736hj.m14547a(context, hlVar, (List<C4743hq>) arrayList);
                                            arrayList = new ArrayList();
                                        }
                                    }
                                }
                                C3989b.m10681d("TinyData read from cache file failed cause decrypt fail");
                            }
                        }
                    } catch (Exception e) {
                        e = e;
                        ...
                        try {
                            ...
                            C4942y.m15884a((Closeable) bufferedInputStream);
                        } catch (Throwable th) {
                            th = th;
                            C4942y.m15884a((Closeable) bufferedInputStream);
                            throw th;
            ...
            if (file != null && file.exists() && !file.delete()) {
                C3989b.m10669a("TinyData delete reading temp file failed");
            }
            C4942y.m15884a((Closeable) bufferedInputStream2);
        } catch (Exception e2) {
            e = e2;
            C3989b.m10678a((Throwable) e);
            C4942y.m15884a((Closeable) bufferedInputStream);
    ...
    /* renamed from: b */
    private static void m14542b(Context context) {
    ...
    public static void m14544c(android.content.Context r11, com.xiaomi.push.C4738hl r12) {
        /*
            java.lang.String r0 = "/"
        ...
        L_0x0022:
            m14539a(r11)
            byte[] r3 = com.xiaomi.push.service.C4891bj.m15708a((android.content.Context) r11)
            r6 = 0
            ...
            com.xiaomi.push.C4942y.m15883a((java.io.File) r7)     // Catch:{ Exception -> 0x007b, all -> 0x0078 }
        ...
        L_0x007b:
            ...
            r8 = r6
        L_0x007d:
            com.xiaomi.channel.commonutils.logger.C3989b.m10678a((java.lang.Throwable) r2)     // Catch:{ all -> 0x00c8 }
            if (r6 == 0) goto L_0x0090
            boolean r2 = r6.isValid()
            if (r2 == 0) goto L_0x0090
        ...
        L_0x0090:
            ...
            return
        L_0x00bb:
            m14541a(r11, r12, r2, r3)
            r12 = 0
            com.xiaomi.push.C4733hh.m14535a((boolean) r12)
            m14542b(r11)
            f8964a = r12
            return
        L_0x00c8:
        ...
        L_0x00dd:
            ...
            com.xiaomi.channel.commonutils.logger.C3989b.m10669a((java.lang.String) r11)
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xiaomi.push.C4734hi.m14544c(android.content.Context, com.xiaomi.push.hl):void");
    }
}
