...
public final class C4687fy {

    /* renamed from: a */
    private static int f8780a = 5000;

    /* renamed from: a */
    private static Vector<String> f8781a = new Vector<>();

    /* renamed from: b */
    private static int f8782b = 330000;

    /* renamed from: c */
    private static int f8783c = 600000;

    /* renamed from: d */
    private static int f8784d = 330000;
    ...
    static {
        /*
            ...
            r0.<init>()
            f8781a = r0
            java.lang.ClassLoader[] r0 = m14326a()     // Catch:{ Exception -> 0x00ab }
        ...
        L_0x003f:
            ...
            m14329a(r4)     // Catch:{ Exception -> 0x009e }
            goto L_0x0091
        L_0x0052:
            java.lang.String r6 = r4.getName()     // Catch:{ Exception -> 0x009e }
            ...
            int r6 = f8780a     // Catch:{ Exception -> 0x009e }
            int r6 = m14327a(r4, r6)     // Catch:{ Exception -> 0x009e }
            f8780a = r6     // Catch:{ Exception -> 0x009e }
            goto L_0x0091
        L_0x0067:
            java.lang.String r6 = r4.getName()     // Catch:{ Exception -> 0x009e }
            ...
            int r6 = f8782b     // Catch:{ Exception -> 0x009e }
            int r6 = m14327a(r4, r6)     // Catch:{ Exception -> 0x009e }
            f8782b = r6     // Catch:{ Exception -> 0x009e }
            goto L_0x0091
        L_0x007c:
            java.lang.String r6 = r4.getName()     // Catch:{ Exception -> 0x009e }
            ...
            java.util.Vector<java.lang.String> r6 = f8781a     // Catch:{ Exception -> 0x009e }
        ...
        L_0x00af:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xiaomi.push.C4687fy.<clinit>():void");
    }
    ...
    /* renamed from: a */
    public static int m14326a() {
        return f8782b;
    }

    /* renamed from: a */
    private static int m14327a(XmlPullParser xmlPullParser, int i) {
        try {
    ...
    /* renamed from: a */
    public static String m14328a() {
        return "3.1.0";
    }

    /* renamed from: a */
    private static void m14329a(XmlPullParser xmlPullParser) {
    ...
    /* renamed from: a */
    private static ClassLoader[] m14330a() {
        ClassLoader[] classLoaderArr = {C4687fy.class.getClassLoader(), Thread.currentThread().getContextClassLoader()};
