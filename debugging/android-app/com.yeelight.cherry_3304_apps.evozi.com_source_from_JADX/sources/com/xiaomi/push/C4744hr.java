...
public enum C4744hr {
    ...
    StatDataUploadNum(SmartConfigStep.MSG_GEN_REFRES_UI),
    StatDataProcessFrequency(SmartConfigStep.MSG_UPDATE_CHECKOUT),
    StatDataSwitch(SmartConfigStep.MSG_RECONNECT_DEVICE_AP),
    StatDataUploadWay(SmartConfigStep.MSG_GET_DEVICE_MODEL),
    StatDataDeleteFrequency(SmartConfigStep.MSG_CONNECT_BLE_TIME_OUT),
