...
/* renamed from: d.a.g.s.e.b */
public class C10693b extends C10694c {
    static {
        Logger.getLogger(C10693b.class.getName());
    }

    public C10693b(C10656l lVar) {
        super(lVar, 0);
        mo33875u(C10683g.CANCELING_1);
        mo33870j(C10683g.CANCELING_1);
    }
    ...
    /* renamed from: v */
    public void mo33868v(Timer timer) {
