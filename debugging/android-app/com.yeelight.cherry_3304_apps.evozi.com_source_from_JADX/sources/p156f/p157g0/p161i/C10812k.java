...
class C10812k {
    ...
    private static final class C10813a {
        ...
        C10813a() {
            this.f20855a = new C10813a[256];
            this.f20856b = 0;
            this.f20857c = 0;
        }

        C10813a(int i, int i2) {
            this.f20855a = null;
            this.f20856b = i;
            int i3 = i2 & 7;
            this.f20857c = i3 == 0 ? 8 : i3;
        }
    }
    ...
    /* renamed from: a */
    private void m26896a(int i, int i2, byte b) {
        C10813a aVar = new C10813a(i, b);
        C10813a aVar2 = this.f20854a;
        while (b > 8) {
            b = (byte) (b - 8);
            int i3 = (i2 >>> b) & 255;
            C10813a[] aVarArr = aVar2.f20855a;
            if (aVarArr != null) {
                if (aVarArr[i3] == null) {
                    aVarArr[i3] = new C10813a();
                }
                aVar2 = aVar2.f20855a[i3];
            } else {
        ...
        for (int i7 = i5; i7 < i5 + i6; i7++) {
            aVar2.f20855a[i7] = aVar;
        }
    }

    /* renamed from: b */
    private void m26897b() {
        int i = 0;
        while (true) {
            byte[] bArr = f20852c;
            if (i < bArr.length) {
                m26896a(i, f20851b[i], bArr[i]);
                i++;
            } else {
                return;
            }
    ...
    /* renamed from: f */
    public static C10812k m26898f() {
        return f20853d;
    }

    /* access modifiers changed from: package-private */
    /* renamed from: c */
    public byte[] mo34114c(byte[] bArr) {
        ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
        C10813a aVar = this.f20854a;
        byte b = 0;
        int i = 0;
        for (byte b2 : bArr) {
            b = (b << 8) | (b2 & 255);
            i += 8;
            while (i >= 8) {
                aVar = aVar.f20855a[(b >>> (i - 8)) & 255];
                if (aVar.f20855a == null) {
                    byteArrayOutputStream.write(aVar.f20856b);
                    i -= aVar.f20857c;
                    aVar = this.f20854a;
                } else {
                    i -= 8;
        ...
        while (i > 0) {
            C10813a aVar2 = aVar.f20855a[(b << (8 - i)) & 255];
            if (aVar2.f20855a != null || aVar2.f20857c > i) {
                break;
            }
            byteArrayOutputStream.write(aVar2.f20856b);
            i -= aVar2.f20857c;
            aVar = this.f20854a;
        }
    ...
    public void mo34115d(p163g.C4411f r8, p163g.C4409d r9) {
        /*
            r7 = this;
            r0 = 0
            r1 = 0
        ...
        L_0x003b:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: p156f.p157g0.p161i.C10812k.mo34115d(g.f, g.d):void");
    }

    /* access modifiers changed from: package-private */
    /* renamed from: e */
    public int mo34116e(C4411f fVar) {
        long j = 0;
        for (int i = 0; i < fVar.mo24297q(); i++) {
            j += (long) f20852c[fVar.mo24290i(i) & 255];
        }
        return (int) ((j + 7) >> 3);
    }
}
