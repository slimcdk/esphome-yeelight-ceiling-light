...
final class C0874a {
    ...
    public byte[] mo9147a() {
        ...
        int j = this.f907a.mo9064j();
        int m = this.f907a.mo9067m();
        for (int i = 0; i < j; i++) {
            int[] iArr = f906b[i];
            for (int i2 = 0; i2 < m; i2++) {
                int i3 = iArr[i2];
                if (i3 >= 0 && this.f907a.mo9059d(i2, i)) {
                    int i4 = i3 / 6;
