...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public Object getPlaybackState() {
        ...
        if (this.mStateObj == null && Build.VERSION.SDK_INT >= 21) {
            ...
            if (i >= 22) {
                obj = PlaybackStateCompatApi22.newInstance(i2, j, j2, f, j3, charSequence, j4, arrayList2, this.mActiveItemId, this.mExtras);
            } else {
                obj = PlaybackStateCompatApi21.newInstance(i2, j, j2, f, j3, charSequence, j4, arrayList2, this.mActiveItemId);
            }
            this.mStateObj = obj;
        }
